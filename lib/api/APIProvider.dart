...
*/
    cj = PersistCookieJar(
        storage: FileStorage('$appDoc/.cookies/'), ignoreExpires: true);
    BaseOptions dioOptions =
        BaseOptions() //(contentType: ContentType.json, responseType: ResponseType.plain)
  ...
  Future<String> getCookies(String url) async {
    ...
    await dio!.get(url);
    var ck = await cj.loadForRequest(Uri.parse(url));
    return CookieManager.getCookies(ck);
  }
...
//Home
  ...
  Future sendDataWithIDHome(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
    dio!.options.headers = {
      'content-type': 'application/x-www-form-urlencoded',
  ...
  Future sendDataWithIDTestimonial(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
    dio!.options.headers = {
  ...
  Future sendDataWithIDCeritaSukses(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
    dio!.options.headers = {
  ...
  Future sendDataWithIDBrowseProjects(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
    dio!.options.headers = {
  ...
  Future sendDataWithIDPastProjects(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
    dio!.options.headers = {
  ...
  Future sendDataWithIDExistingUser(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
    dio!.options.headers = {
  ...
  Future sendDataWithIDBrowseServices(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
    dio!.options.headers = {
  ...
  Future sendDataWithIDBrowseUsers(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
    dio!.options.headers = {
  ...
  Future sendDataWithIDBrowseProducts(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
    dio!.options.headers = {
  ...
  Future sendDataWithIDMyProjects(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
    dio!.options.headers = {
  ...
  Future sendDataWithIDMyProducts(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
    dio!.options.headers = {
  ...
  Future sendDataWithIDMyServices(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
    dio!.options.headers = {
  ...
  Future sendDataWithIDMyPurchases(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
    dio!.options.headers = {
  ...
  Future sendDataWithIDMyReferals(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
    dio!.options.headers = {
  ...
  Future sendDataWithIDMyFinance(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
    dio!.options.headers = {
  ...
  Future sendDataWithIDMyProfile(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
    dio!.options.headers = {
  ...
  Future sendDataWithIDKelurahan(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
    dio!.options.headers = {
  ...
  Future sendDataWithIDMyPortofolio(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
    dio!.options.headers = {
  ...
  Future sendDataWithIDMyBookmarks(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
    dio!.options.headers = {
  ...
  Future sendDataWithIDMyBuddies(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
    dio!.options.headers = {
  ...
  Future getDataPlaceNewBidBrowseProjects(
      String url, String id, String title) async {
    dio!.options.connectTimeout = 15000;
  ...
  Future sendDataWithIDPlaceNewBidBrowseProjects(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future getDataAskOwnerBrowseProjects(
      String url, String id, String title) async {
    dio!.options.connectTimeout = 15000;
  ...
  Future sendDataWithIDAskOwnerBrowseProjects(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future getDataGuestCreateProjectBrowseProjects(
      String url, String id, String title) async {
    dio!.options.connectTimeout = 15000;
  ...
  Future sendDataGuestCreateProjectBrowseProjects(
      String url, var formdata) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future sendDataWithIDGuestCreateProjectBrowseProjects(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future sendDataWithIDRegisterNewUser(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future sendDataWithIDVerifyNewUser(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future sendDataWithIDPromoProgram(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future getDataForgotPasswordExistingUser(
      String url, String id, String title) async {
    dio!.options.connectTimeout = 15000;
  ...
  Future sendDataWithIDForgotPasswordExistingUser(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future getDataResetPasswordExistingUser(
      String url, String id, String title) async {
    dio!.options.connectTimeout = 15000;
  ...
  Future sendDataWithIDResetPasswordExistingUser(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future sendDataWithIDContactFormSupport(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future getDataPlaceOrderBrowseServices(
      String url, String id, String title) async {
    dio!.options.connectTimeout = 15000;
  ...
  Future sendDataWithIDPlaceOrderBrowseServices(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future getDataInviteToBidBrowseUsers(
      String url, String id, String title) async {
    dio!.options.connectTimeout = 15000;
  ...
  Future sendDataWithIDInviteToBidBrowseUsers(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future sendDataWithIDHireMeBrowseUsers(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future getDataAddToCartBrowseProducts(
      String url, String id, String title) async {
    dio!.options.connectTimeout = 15000;
  ...
  Future sendDataWithIDAddToCartBrowseProducts(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future sendDataWithIDEmptyCartCart(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future sendDataWithIDApplyCouponCart(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future getDataPayWithAvailableBalanceCheckout(
      String url, String id, String title) async {
    dio!.options.connectTimeout = 15000;
  ...
  Future sendDataPayWithAvailableBalanceCheckout(
      String url, var formdata) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future sendDataWithIDPayWithAvailableBalanceCheckout(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future getDataPayViaBankTransferCheckout(
      String url, String id, String title) async {
    dio!.options.connectTimeout = 15000;
  ...
  Future sendDataWithIDPayViaBankTransferCheckout(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future getDataPayWithCreditCardCheckout(
      String url, String id, String title) async {
    dio!.options.connectTimeout = 15000;
  ...
  Future sendDataWithIDPayWithCreditCardCheckout(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future getDataPayWithCimbClicksCheckout(
      String url, String id, String title) async {
    dio!.options.connectTimeout = 15000;
  ...
  Future sendDataWithIDPayWithCimbClicksCheckout(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future getDataPayWithBcaKlikpayCheckout(
      String url, String id, String title) async {
    dio!.options.connectTimeout = 15000;
  ...
  Future sendDataWithIDPayWithBcaKlikpayCheckout(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future getDataPayWithMandiriClickpayCheckout(
      String url, String id, String title) async {
    dio!.options.connectTimeout = 15000;
  ...
  Future sendDataPayWithMandiriClickpayCheckout(
      String url, var formdata) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future sendDataWithIDPayWithMandiriClickpayCheckout(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future sendDataWithIDPayWithQrisCheckout(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future getDataPayWithPaypalCheckout(
      String url, String id, String title) async {
    dio!.options.connectTimeout = 15000;
  ...
  Future sendDataWithIDPayWithPaypalCheckout(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future sendDataWithIDBumpUpMyProjects(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future getDataBroadcastMessageMyProjects(
      String url, String id, String title) async {
    dio!.options.connectTimeout = 15000;
  ...
  Future sendDataWithIDBroadcastMessageMyProjects(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future getDataCreateProjectMyProjects(
      String url, String id, String title) async {
    dio!.options.connectTimeout = 15000;
  ...
  Future sendDataWithIDCreateProjectMyProjects(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future sendDataWithIDEditDraftMyProjects(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future getDataPublishProjectMyProjects(
      String url, String id, String title) async {
    dio!.options.connectTimeout = 15000;
  ...
  Future sendDataWithIDPublishProjectMyProjects(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future getDataCancelProjectMyProjects(
      String url, String id, String title) async {
    dio!.options.connectTimeout = 15000;
  ...
  Future sendDataWithIDCancelProjectMyProjects(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future getDataAcceptOrRejectWorkMyProjects(
      String url, String id, String title) async {
    dio!.options.connectTimeout = 15000;
  ...
  Future sendDataWithIDAcceptOrRejectWorkMyProjects(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future getDataRateWorkerMyProjects(
      String url, String id, String title) async {
    dio!.options.connectTimeout = 15000;
  ...
  Future sendDataWithIDRateWorkerMyProjects(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future getDataReportProgressMyProjects(
      String url, String id, String title) async {
    dio!.options.connectTimeout = 15000;
  ...
  Future sendDataWithIDReportProgressMyProjects(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future getDataWeeklyReportMyProjects(
      String url, String id, String title) async {
    dio!.options.connectTimeout = 15000;
  ...
  Future sendDataWithIDWeeklyReportMyProjects(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future getDataReportDoneMyProjects(
      String url, String id, String title) async {
    dio!.options.connectTimeout = 15000;
  ...
  Future sendDataWithIDReportDoneMyProjects(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future sendDataWithIDRateOwnerMyProjects(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future getDataFileArbitrationMyProjects(
      String url, String id, String title) async {
    dio!.options.connectTimeout = 15000;
  ...
  Future sendDataWithIDFileArbitrationMyProjects(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future sendDataWithIDNewOfferMyProjects(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future getDataAcceptOfferMyProjects(
      String url, String id, String title) async {
    dio!.options.connectTimeout = 15000;
  ...
  Future sendDataWithIDAcceptOfferMyProjects(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future getDataRespondArbitrationMyProjects(
      String url, String id, String title) async {
    dio!.options.connectTimeout = 15000;
  ...
  Future sendDataWithIDRespondArbitrationMyProjects(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future getDataCancelArbitrationMyProjects(
      String url, String id, String title) async {
    dio!.options.connectTimeout = 15000;
  ...
  Future sendDataWithIDCancelArbitrationMyProjects(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future sendDataWithIDCancelBidMyBids(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future getDataAddNewProductMyProducts(
      String url, String id, String title) async {
    dio!.options.connectTimeout = 15000;
  ...
  Future sendDataWithIDAddNewProductMyProducts(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future getDataPublishProductMyProducts(
      String url, String id, String title) async {
    dio!.options.connectTimeout = 15000;
  ...
  Future sendDataWithIDPublishProductMyProducts(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future getDataEditProductMyProducts(
      String url, String id, String title) async {
    dio!.options.connectTimeout = 15000;
  ...
  Future sendDataWithIDEditProductMyProducts(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future sendDataWithIDBumpUpMyProducts(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future sendDataWithIDUnlistMyProducts(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future getDataReactivateProductMyProducts(
      String url, String id, String title) async {
    dio!.options.connectTimeout = 15000;
  ...
  Future sendDataWithIDReactivateProductMyProducts(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future getDataAddNewServiceMyServices(
      String url, String id, String title) async {
    dio!.options.connectTimeout = 15000;
  ...
  Future sendDataWithIDAddNewServiceMyServices(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future getDataPublishServiceMyServices(
      String url, String id, String title) async {
    dio!.options.connectTimeout = 15000;
  ...
  Future sendDataWithIDPublishServiceMyServices(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future sendDataWithIDBumpUpMyServices(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future getDataEditServiceMyServices(
      String url, String id, String title) async {
    dio!.options.connectTimeout = 15000;
  ...
  Future sendDataWithIDEditServiceMyServices(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future sendDataWithIDUnlistMyServices(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future getDataReactivateServiceMyServices(
      String url, String id, String title) async {
    dio!.options.connectTimeout = 15000;
  ...
  Future sendDataWithIDReactivateServiceMyServices(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future getDataConfirmPaymentMyOrders(
      String url, String id, String title) async {
    dio!.options.connectTimeout = 15000;
  ...
  Future sendDataWithIDConfirmPaymentMyOrders(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future sendDataWithIDDownloadMyPurchases(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future getDataRateProductMyPurchases(
      String url, String id, String title) async {
    dio!.options.connectTimeout = 15000;
  ...
  Future sendDataWithIDRateProductMyPurchases(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future getDataChangePaymentSettingsMyFinance(
      String url, String id, String title) async {
    dio!.options.connectTimeout = 15000;
  ...
  Future sendDataChangePaymentSettingsMyFinance(
      String url, var formdata) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future sendDataWithIDChangePaymentSettingsMyFinance(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future getDataWithdrawPaymentMyFinance(
      String url, String id, String title) async {
    dio!.options.connectTimeout = 15000;
  ...
  Future sendDataWithIDWithdrawPaymentMyFinance(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future getDataDepositBalanceMyFinance(
      String url, String id, String title) async {
    dio!.options.connectTimeout = 15000;
  ...
  Future sendDataWithIDDepositBalanceMyFinance(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future getDataEditProfileMyProfile(
      String url, String id, String title) async {
    dio!.options.connectTimeout = 15000;
  ...
  Future sendDataWithIDEditProfileMyProfile(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future getDataChangePasswordMyProfile(
      String url, String id, String title) async {
    dio!.options.connectTimeout = 15000;
  ...
  Future sendDataWithIDChangePasswordMyProfile(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future getDataChangeEmailMyProfile(
      String url, String id, String title) async {
    dio!.options.connectTimeout = 15000;
  ...
  Future sendDataWithIDChangeEmailMyProfile(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future getDataChangeHandphoneMyProfile(
      String url, String id, String title) async {
    dio!.options.connectTimeout = 15000;
  ...
  Future sendDataWithIDChangeHandphoneMyProfile(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future getDataAddPortofolioMyPortofolio(
      String url, String id, String title) async {
    dio!.options.connectTimeout = 15000;
  ...
  Future sendDataWithIDAddPortofolioMyPortofolio(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future sendDataWithIDEditMyPortofolio(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
  ...
  Future sendDataWithIDRemoveMyBuddies(
      String url, var formdata, String id, String title) async {
    dio!.options.connectTimeout = 15000;
    FormData postData = FormData.fromMap(formdata);
...
//https://api.projects.co.id/user/my_purchases/download/1c1611/a-classmore-hrefhttpwwwprojectscoidpublicbrowseproductsview0a1611video-tutorialvideo-tutoriala
  Future downloadFile(String url, String fileName) async {
    ...
    File('${_downloadsDirectory!.path}/$fileName').renameSync(
        '${_downloadsDirectory!.path}/${res!.headers.value('content-disposition')?.replaceAll(new RegExp('"'), '').replaceAll('filename=', '')}');
    // print('resp === ${res.headers.value('content-disposition').replaceAll(new RegExp('"'),'').replaceAll('filename=', '')}');
  }

  Future<String> downloadFile1(
      String url, String fileName, ProgressCallback showProgress) async {
    dio!.options.connectTimeout = 15000;
    // await initDownloadsDirectoryState();
    Response? res;
    // '${_downloadsDirectory.path}/${widget.value}'
  ...
  Future userLogin(String username, String pwd) async {
    ...
    Response response = await dio!.post(url,
        data: 'LoginActivity[_trigger_]=1&LoginActivity[user_name]=' +
            username +
            '&LoginActivity[password]=' +
            pwd +
            '&LoginActivity[remember]=1');
    throwIfNoSuccess(response);
    return response.data;
  }
