...
class IntroSliderState extends State<IntroSlider>
  ...
  /// Default values
  static TextStyle defaultBtnNameTextStyle = const TextStyle(color: Colors.white);
  ...
  Widget buildAskHide(){
      return CheckboxListTile(
        title: Text("Do not show this Intro's again!"),
        value: isChecked,
  ...
  Widget renderTab(
      ...
      double? widthImage,
      double? heightImage,
      VoidCallback? onCenterItemPress,
