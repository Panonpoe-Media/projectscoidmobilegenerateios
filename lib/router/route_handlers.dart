...
var editMyPortofolioUser = Handler(
    handlerFunc: (BuildContext?context, Map<String, List<String?>?> params) {
      String? id = params["id"]?.first;
      String? title = params["title"]?.first;
      return UserMyPortofolioEdit( id : id,
                             title:  title );
    });
	
var addMyPortofolioUser = Handler(
    handlerFunc: (BuildContext?context, Map<String, List<String?>?> params) {
      return UserMyPortofolioAdd();
    });	

var viewMyPortofolioUser = Handler(
    handlerFunc: (BuildContext?context, Map<String, List<String?>?> params) {
		  String? id = params["id"]?.first;
          String? title = params["title"]?.first;
          return UserMyPortofolioView( id : id,
          title:  title );
    });

var listingMyPortofolioUser = Handler(
    handlerFunc: (BuildContext?context, Map<String, List<String?>?> params) {
	  String? id = params["id"]?.first;
      return  UserMyPortofolioListing(id : id);
    });
	
var AddPortofolioMyPortofolioHandler = Handler(
    handlerFunc: (BuildContext?context, Map<String, List<String?>?> params) {
	  String? id = '';
	  if(params["id"]?.first == ''){
	  id = '';
      ...
      return AddPortofolioMyPortofolio( id : id,
          title:  title );	 
    });


var EditMyPortofolioHandler = Handler(
    handlerFunc: (BuildContext?context, Map<String, List<String?>?> params) {
	  String? id = '';
	  if(params["id"]?.first == ''){
	  id = '';
