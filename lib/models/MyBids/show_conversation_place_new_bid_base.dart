...
part 'show_conversation_place_new_bid_base.g.dart';



@JsonSerializable()

class ModelActionPlaceNewBidShowConversation {
  int?    age;
  int?    cnt;
  int?    page;
  String? id;
...
String? post_id;
  ...
  bool?  read_by_worker;
	  ...
	  ModelActionPlaceNewBidShowConversation(
            this.id,
			this.post_id,
			this.user_id,
			this.user_str,
    ...
    factory ModelActionPlaceNewBidShowConversation.fromJson(Map<String, dynamic> json) => _$ModelActionPlaceNewBidShowConversationFromJson(json);

  Map<String, dynamic> toJson() => _$ModelActionPlaceNewBidShowConversationToJson(this);

}

@JsonSerializable()
class PlaceNewBidShowConversationSuperBase {

  String? id;
  Meta? meta;
  List<Button?>? buttons;
  ModelActionPlaceNewBidShowConversation? model;
  PlaceNewBidShowConversationSuperBase(
	  this.id,
	  this.buttons,
	  this.meta,
	  this.model,
  ...
  factory PlaceNewBidShowConversationSuperBase.fromJson(Map<String, dynamic> json) => _$PlaceNewBidShowConversationSuperBaseFromJson(json);

  Map<String, dynamic> toJson() => _$PlaceNewBidShowConversationSuperBaseToJson(this);
  
 
}

class PlaceNewBidShowConversationBase{
	var model;
	Map<String, dynamic> json;
            var attachmentslast ;   
	PlaceNewBidShowConversationBase(this.json){
		model = PlaceNewBidShowConversationSuperBase.fromJson(this.json);
 ...
 var postShowConversationResult, State state, String? sendPath, String? id,  String? title){
  ...
  var postPlaceNewBidResult, State state, String? sendPath, String? id,  String? title){
	...
	for(var i = 0; i < model.buttons.length; i++)
    {
      ...
      buttonChildren.add(RButtonActionShowConversationWidget(model.buttons[i], context,formKey, controller,show_conversation, postPlaceNewBidResult, state, sendPath, id,  title));
      }
    }
       return(
	        buttonChildren 
  ...
  var postPlaceNewBidResult, State state, String? sendPath, String? id,  String? title){
	...
	for(var i = 0; i < model.buttons.length; i++)
    {
      buttonChildren.add(ButtonActionShowConversationWidget(model.buttons[i], context,formKey, controller,show_conversation, postPlaceNewBidResult, state, sendPath, id,  title ));
    }
       return(
	        buttonChildren 
	   );
    ...
    return(
        ButtonBarTheme(
            ...
            child: ButtonBar(
                ...
                buttonMinWidth: 0.9 * width,
                children:
           RlistButton(context, formKey,controller,show_conversation, postPlaceNewBidResult, state, sendPath, id,  title )
  ...
  var postPlaceNewBidResult, State state, String? sendPath, String? id,  String? title ){
	 ...
	 SpeedDial(
				...
				elevation: 8.0,
				shape: CircleBorder(),
				children:listButton(context, formKey,controller,show_conversation, postPlaceNewBidResult, state, sendPath, id,  title )
	    )
	 );
   } 
