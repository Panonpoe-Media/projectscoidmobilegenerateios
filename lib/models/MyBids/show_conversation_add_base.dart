...
part 'show_conversation_add_base.g.dart';
...
class AddModelShowConversation {
   int?   age;
   int?   cnt;
   int?   page;
  String? id;
  ...
  bool? read_by_worker;
    ...
    factory AddModelShowConversation.fromJson(Map<String, dynamic> json) => _$AddModelShowConversationFromJson(json);

  Map<String, dynamic> toJson() => _$AddModelShowConversationToJson(this);
...
class ShowConversationSuperBase {
  ...
  Meta? meta;
  List<Button?>? buttons;
  AddModelShowConversation? model;
...
class ShowConversationAddBase{
	var model;
	Map<String, dynamic> json;
	ShowConversationAddBase(this.json){
