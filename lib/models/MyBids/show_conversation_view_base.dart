...
part 'show_conversation_view_base.g.dart';
...
@JsonSerializable()
class ViewModelShowConversation {
  int?    age;
  int?    cnt;
  int?    page;
  String? id;
  ...
  bool read_by_worker;
   ...
   factory ViewModelShowConversation.fromJson(Map<String, dynamic> json) => _$ViewModelShowConversationFromJson(json);

   Map<String, dynamic> toJson() => _$ViewModelShowConversationToJson(this); 
  
}

@JsonSerializable()
class ShowConversationViewSuperBase {

  String? id;
  Meta? meta;
  List<Button?>? buttons;
  ViewModelShowConversation? model;
  ShowConversationViewSuperBase(
      this.id,
      this.buttons,
      this.meta,
      this.model,
  ...
  factory ShowConversationViewSuperBase.fromJson(Map<String, dynamic> json) => _$ShowConversationViewSuperBaseFromJson(json);
  Map<String, dynamic> toJson() => _$ShowConversationViewSuperBaseToJson(this);
   
}

class ShowConversationViewBase{
	var model;
	Map<String, dynamic> json;
	ShowConversationViewBase(this.json){
		model = ShowConversationViewSuperBase.fromJson(this.json);
	}
   ...
   List<SpeedDialChild>	 listButton(BuildContext context){
    ...
    {
      buttonChildren.add(ListButtonShowConversationWidget(model.buttons[i],context));
    }
