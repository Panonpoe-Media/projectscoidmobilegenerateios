...
part of 'show_conversation_place_new_bid_base.dart';
...
ModelActionPlaceNewBidShowConversation
    _$ModelActionPlaceNewBidShowConversationFromJson(
...
Map<String, dynamic> _$ModelActionPlaceNewBidShowConversationToJson(
        ModelActionPlaceNewBidShowConversation instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
PlaceNewBidShowConversationSuperBase
    _$PlaceNewBidShowConversationSuperBaseFromJson(Map<String, dynamic> json) =>
        PlaceNewBidShowConversationSuperBase(
          json['id'] as String?,
          ...
          json['model'] == null
              ? null
              : ModelActionPlaceNewBidShowConversation.fromJson(
                  json['model'] as Map<String, dynamic>),
        );

Map<String, dynamic> _$PlaceNewBidShowConversationSuperBaseToJson(
        PlaceNewBidShowConversationSuperBase instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
