...
part of 'show_conversation_view_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ViewModelShowConversation _$ViewModelShowConversationFromJson(
...
Map<String, dynamic> _$ViewModelShowConversationToJson(
        ViewModelShowConversation instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
ShowConversationViewSuperBase _$ShowConversationViewSuperBaseFromJson(
        Map<String, dynamic> json) =>
    ShowConversationViewSuperBase(
      ...
      json['model'] == null
          ? null
          : ViewModelShowConversation.fromJson(
              json['model'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$ShowConversationViewSuperBaseToJson(
        ShowConversationViewSuperBase instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
