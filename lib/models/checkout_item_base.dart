...
import 'photo.dart';
import 'paging.dart';
part 'checkout_item_base.g.dart';
//


class ItemCheckoutBase {
	var item;
	Map<String, dynamic> json;
	ItemCheckoutBase(this.json){
		item = ItemCheckout.fromJson(json);
	}	
...
class ItemCheckout{
  ...
  factory ItemCheckout.fromJson(Map<String, dynamic> json) => _$ItemCheckoutFromJson(json);

  Map<String, dynamic> toJson() => _$ItemCheckoutToJson(this);
