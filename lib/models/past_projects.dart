...
class ViewModelPastProjectsRev {
  ...
  factory ViewModelPastProjectsRev.fromJson(Map<String, dynamic> json) => _$ViewModelPastProjectsRevFromJson(json);
...
class PastProjectsViewSuperBaseRev {
  ...
  factory PastProjectsViewSuperBaseRev.fromJson(Map<String, dynamic> json) => _$PastProjectsViewSuperBaseRevFromJson(json);
...
class PastProjectsViewModel  extends PastProjectsViewBase{
 ...
 // PastProjectsViewModel(Map<String, dynamic> this.json):super(json);
  PastProjectsViewModel(Map<String, dynamic> this.json):super(json){model = PastProjectsViewSuperBaseRev.fromJson(this.json);}
    ...
    if(this.model.model.channels_url != null){
      return( 	ChannelRouteTagsWidget(
        ...
        getValue: (String? val) {
          ...
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => PublicPastProjectsListing(id: val!.split('?')[1])),
          );
  ...
  Widget viewBidder (BuildContext context){
    if(this.model.model.user_bids.items.length == 0 || this.model.model.description!.contains('This is a private project.')){
      return Container(height:0 , width: 0);
    }else{
      return   Container(
        height: 245.0,
        ...
        SingleChildScrollView(
            ...
            child: Column(
                ...
                children: <Widget>[
                  ...
                  Padding(
                    padding: const EdgeInsets.fromLTRB(20.0, 14.0, 20.0, 2.0),
                    child:  Html(data: info!.description!.replaceAll('<div>', '').replaceAll('<\/div>','').replaceAll('<br>', ' ').replaceAll('<p>', '').replaceAll('<\/p>', '<br>'),
  ...
  Widget build(BuildContext context) {
    ...
    final List<Widget> children = <Widget>[
      ...
      GestureDetector(
        ...
        child: SizedBox(
          height: destination!.item!.short_description!.length < 150 ? 50 : destination!.item!.short_description!.length < 200 ? 100.0 :  110.0,
...
class  SearchPastProjectsListing extends StatefulWidget {
  ...
  final String?  title ;
  bool? account;
  SearchPastProjectsListing({Key? key, this.id, this.title, this.account}) : super(key: key);
  @override
            ...
            if (state.past_projects!.tools.buttons.length == 0){
              ...
              return
                Scaffold(
                    ...
                    floatingActionButton: state.past_projects!.Buttons(context, _dialVisible, widget.account)
...
class  SearchPastProjectsListing1 extends StatefulWidget {
  ...
  final String?  title ;
  bool? account;
  SearchPastProjectsListing1({Key? key, this.id, this.title, this.account}) : super(key: key);
  @override
  SearchPastProjectsListing1State createState() =>  SearchPastProjectsListing1State();
}

class  SearchPastProjectsListing1State extends State< SearchPastProjectsListing1>  with RestorationMixin{
  String?  title = 'Past Projects';
  bool _dialVisible = true;
  bool search = false;
  String?  getPath = Env.value!.baseUrl! + '/public/past_projects/listing?page=%d';
