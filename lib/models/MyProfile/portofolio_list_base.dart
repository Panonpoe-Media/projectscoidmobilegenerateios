...
class ItemPortofolioCard extends StatelessWidget {
  const ItemPortofolioCard({ Key? key, @required this.destination, this.search, this.shape, this.height})
...
class ItemPortofolioContent extends StatelessWidget {
  const ItemPortofolioContent({ Key? key, @required this.destination })
      : assert(destination != null),
        super(key: key);
