...
part of 'cart_items_view_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ViewModelCartItems _$ViewModelCartItemsFromJson(Map<String, dynamic> json) =>
    ViewModelCartItems(
      json['id'] as String?,
...
Map<String, dynamic> _$ViewModelCartItemsToJson(ViewModelCartItems instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
CartItemsViewSuperBase _$CartItemsViewSuperBaseFromJson(
    ...
    CartItemsViewSuperBase(
      ...
      json['model'] == null
          ? null
          : ViewModelCartItems.fromJson(json['model'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$CartItemsViewSuperBaseToJson(
        CartItemsViewSuperBase instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
