...
part of 'cart_items_increase_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ModelActionIncreaseCartItems _$ModelActionIncreaseCartItemsFromJson(
...
Map<String, dynamic> _$ModelActionIncreaseCartItemsToJson(
        ModelActionIncreaseCartItems instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
IncreaseCartItemsSuperBase _$IncreaseCartItemsSuperBaseFromJson(
        Map<String, dynamic> json) =>
    IncreaseCartItemsSuperBase(
      ...
      json['model'] == null
          ? null
          : ModelActionIncreaseCartItems.fromJson(
              json['model'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$IncreaseCartItemsSuperBaseToJson(
        IncreaseCartItemsSuperBase instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
