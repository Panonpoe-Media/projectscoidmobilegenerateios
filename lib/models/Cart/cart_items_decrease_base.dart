...
part 'cart_items_decrease_base.g.dart';



@JsonSerializable()

class ModelActionDecreaseCartItems {
  int?    age;
  int?    cnt;
  int?    page;
  String? id;
...
String? cart_id;
  ...
  double? total_price;
    ...
    factory ModelActionDecreaseCartItems.fromJson(Map<String, dynamic> json) => _$ModelActionDecreaseCartItemsFromJson(json);

  Map<String, dynamic> toJson() => _$ModelActionDecreaseCartItemsToJson(this);

}

@JsonSerializable()
class DecreaseCartItemsSuperBase {

  String? id;
  Meta? meta;
  List<Button?>? buttons;
  ModelActionDecreaseCartItems? model;
  ...
  factory DecreaseCartItemsSuperBase.fromJson(Map<String, dynamic> json) => _$DecreaseCartItemsSuperBaseFromJson(json);

  Map<String, dynamic> toJson() => _$DecreaseCartItemsSuperBaseToJson(this);
  
 
}

class DecreaseCartItemsBase{
	var model;
	Map<String, dynamic> json;
	DecreaseCartItemsBase(this.json){
		model = DecreaseCartItemsSuperBase.fromJson(this.json);
	}
...
SpeedDialChild ButtonActionCartItemsWidget(Button button, BuildContext context,var formKey, ScrollController controller, SubModelController cart_items,
 var postCartItemsResult, State state, String? sendPath, String? id,  String? title){
  ...
  var postDecreaseResult, State state, String? sendPath, String? id,  String? title){
    final List<Widget> buttonChildren = <Widget>[
    ];
	for(var i = 0; i < model.buttons.length; i++)
    {
      if(model.buttons[i].text != "Table View"){
      buttonChildren.add(RButtonActionCartItemsWidget(model.buttons[i], context,formKey, controller,cart_items, postDecreaseResult, state, sendPath, id,  title));
      }
    }
       return(
	        buttonChildren 
  ...
  var postDecreaseResult, State state, String? sendPath, String? id,  String? title){
	...
	for(var i = 0; i < model.buttons.length; i++)
    {
      buttonChildren.add(ButtonActionCartItemsWidget(model.buttons[i], context,formKey, controller,cart_items, postDecreaseResult, state, sendPath, id,  title ));
    }
       return(
	        buttonChildren 
	   );
    ...
    return(
        ButtonBarTheme(
            ...
            child: ButtonBar(
                ...
                buttonMinWidth: 0.9 * width,
                children:
           RlistButton(context, formKey,controller,cart_items, postDecreaseResult, state, sendPath, id,  title )
  ...
  var postDecreaseResult, State state, String? sendPath, String? id,  String? title ){
	 ...
	 SpeedDial(
				...
				elevation: 8.0,
				shape: CircleBorder(),
				children:listButton(context, formKey,controller,cart_items, postDecreaseResult, state, sendPath, id,  title )
	    )
	 );
   } 
