...
part 'cart_items_remove_base.g.dart';



@JsonSerializable()

class ModelActionRemoveCartItems {
  int?    age;
  int?    cnt;
  int?    page;
  String? id;
...
String? cart_id;
  ...
  double? total_price;
    ...
    factory ModelActionRemoveCartItems.fromJson(Map<String, dynamic> json) => _$ModelActionRemoveCartItemsFromJson(json);

  Map<String, dynamic> toJson() => _$ModelActionRemoveCartItemsToJson(this);

}

@JsonSerializable()
class RemoveCartItemsSuperBase {

  String? id;
  Meta? meta;
  List<Button?>? buttons;
  ModelActionRemoveCartItems? model;
  RemoveCartItemsSuperBase(
	  this.id,
	  this.buttons,
	  this.meta,
	  this.model,
  ...
  factory RemoveCartItemsSuperBase.fromJson(Map<String, dynamic> json) => _$RemoveCartItemsSuperBaseFromJson(json);

  Map<String, dynamic> toJson() => _$RemoveCartItemsSuperBaseToJson(this);
  
 
}

class RemoveCartItemsBase{
	var model;
	Map<String, dynamic> json;
	RemoveCartItemsBase(this.json){
		model = RemoveCartItemsSuperBase.fromJson(this.json);
	}
 ...
 var postCartItemsResult, State state, String? sendPath, String? id,  String? title){
  ...
  var postRemoveResult, State state, String? sendPath, String? id,  String? title){
	...
	for(var i = 0; i < model.buttons.length; i++)
    {
      ...
      buttonChildren.add(RButtonActionCartItemsWidget(model.buttons[i], context,formKey, controller,cart_items, postRemoveResult, state, sendPath, id,  title));
      }
    }
       return(
	        buttonChildren 
  ...
  var postRemoveResult, State state, String? sendPath, String? id,  String? title){
	...
	for(var i = 0; i < model.buttons.length; i++)
    {
      buttonChildren.add(ButtonActionCartItemsWidget(model.buttons[i], context,formKey, controller,cart_items, postRemoveResult, state, sendPath, id,  title ));
    }
       return(
	        buttonChildren 
	   );
    ...
    return(
        ButtonBarTheme(
            ...
            child: ButtonBar(
                ...
                buttonMinWidth: 0.9 * width,
                children:
           RlistButton(context, formKey,controller,cart_items, postRemoveResult, state, sendPath, id,  title )
  ...
  var postRemoveResult, State state, String? sendPath, String? id,  String? title ){
	 ...
	 SpeedDial(
				...
				elevation: 8.0,
				shape: CircleBorder(),
				children:listButton(context, formKey,controller,cart_items, postRemoveResult, state, sendPath, id,  title )
	    )
	 );
   } 
