...
part of 'cart_items_remove_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ModelActionRemoveCartItems _$ModelActionRemoveCartItemsFromJson(
...
Map<String, dynamic> _$ModelActionRemoveCartItemsToJson(
        ModelActionRemoveCartItems instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
RemoveCartItemsSuperBase _$RemoveCartItemsSuperBaseFromJson(
        Map<String, dynamic> json) =>
    RemoveCartItemsSuperBase(
      ...
      json['model'] == null
          ? null
          : ModelActionRemoveCartItems.fromJson(
              json['model'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$RemoveCartItemsSuperBaseToJson(
        RemoveCartItemsSuperBase instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
