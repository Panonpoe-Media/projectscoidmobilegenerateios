...
part of 'cart_items_add_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

AddModelCartItems _$AddModelCartItemsFromJson(Map<String, dynamic> json) =>
    AddModelCartItems(
      json['id'] as String?,
      json['cart_id'] as int?,
      json['user_id'] as int?,
...
Map<String, dynamic> _$AddModelCartItemsToJson(AddModelCartItems instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
CartItemsSuperBase _$CartItemsSuperBaseFromJson(Map<String, dynamic> json) =>
    CartItemsSuperBase(
      ...
      json['model'] == null
          ? null
          : AddModelCartItems.fromJson(json['model'] as Map<String, dynamic>),
    );
