...
part of 'browse_services_item_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ItemBrowseServices _$ItemBrowseServicesFromJson(Map<String, dynamic> json) =>
    ItemBrowseServices(
...
Map<String, dynamic> _$ItemBrowseServicesToJson(ItemBrowseServices instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
