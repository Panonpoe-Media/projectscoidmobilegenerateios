...
import 'my_referals_item.dart';
import 'my_referals_item_base.dart';
import 'photo.dart';
import 'paging.dart';
import 'package:horizontal_data_table/horizontal_data_table.dart';
import 'package:flutter_widget_from_html_core/flutter_widget_from_html_core.dart';
import 'package:url_launcher/url_launcher.dart';
import 'package:projectscoid/models/MyReferals/action.dart';
import 'package:google_mobile_ads/google_mobile_ads.dart';
import 'package:projectscoid/views/route.dart' as rt;

part 'my_referals_base.g.dart';
...
class ModelMyReferals {
  ...
  String? coupon;
    ...
    factory ModelMyReferals.fromJson(Map<String, dynamic> json) => _$ModelMyReferalsFromJson(json);

  Map<String, dynamic> toJson() => _$ModelMyReferalsToJson(this);
...
class MyReferalsBase{
	var model;
	Map<String, dynamic> json;
	MyReferalsBase(this.json){
		model = MyReferalsSuperBase.fromJson(this.json);
   ...
   Map<String, dynamic> convertFormDataEdit(var data){
	...
	if (model.model.photo!= null) {
      ...
      var formData = {
      "my_referals[_trigger_]":"",
   "my_referals[user_id]": "${model.model.user_id }",
  "my_referals[user_name]": "${model.model.user_name }",
  "my_referals[group_id]": "${model.model.group_id }",
  "my_referals[email]": "${model.model.email }",
  "my_referals[password]": "${model.model.password }",
  "my_referals[password_confirmation]": "${model.model.password }",
  "my_referals[auth]": "${model.model.auth }",
   "my_referals[account_status_id]": "${model.model.account_status_id}",
   "my_referals[account_type_id]": "${model.model.account_type_id}",
  "my_referals[date_registered]": "${DateFormat('dd/MM/yyyy HH:mm:ss').format(model.model.date_registered)}",
  "my_referals[last_login]": "${DateFormat('dd/MM/yyyy HH:mm:ss').format(model.model.last_login)}",
  "my_referals[last_seen]": "${DateFormat('dd/MM/yyyy HH:mm:ss').format(model.model.last_seen)}",
  "my_referals[online]": "${model.model.online ? 1 : 0}",
  "my_referals[last_online_mark]": "${DateFormat('dd/MM/yyyy HH:mm:ss').format(model.model.last_online_mark)}",
  "my_referals[online_hours]": "${model.model.online_hours}",
  "my_referals[nomor_ktp]": "${model.model.nomor_ktp }",
  "my_referals[scan_ktp]": '$scan_ktp',
  "my_referals[scan_ktp_lastval]": '{"name":"${model.model.scan_ktp.name}","dir":"${model.model.scan_ktp.dir}","file":"${model.model.scan_ktp.file}","thumb":"${model.model.scan_ktp.thumb}"}',
  "my_referals[nomor_siup]": "${model.model.nomor_siup }",
  "my_referals[scan_siup]": '$scan_siup',
  "my_referals[scan_siup_lastval]": '{"name":"${model.model.scan_siup.name}","dir":"${model.model.scan_siup.dir}","file":"${model.model.scan_siup.file}","thumb":"${model.model.scan_siup.thumb}"}',
  "my_referals[npwp]": "${model.model.npwp }",
   "my_referals[status_marital_id]": "${model.model.status_marital_id}",
  "my_referals[jumlah_tanggungan]": "${model.model.jumlah_tanggungan }",
  "my_referals[personal_data]": "${model.model.personal_data }",
  "my_referals[photo]": '$photo',
  "my_referals[photo_lastval]": '{"name":"${model.model.photo.name}","dir":"${model.model.photo.dir}","file":"${model.model.photo.file}","thumb":"${model.model.photo.thumb}"}',
  "my_referals[display_name]": "${model.model.display_name }",
  "my_referals[birth_date]": "${DateFormat('dd/MM/yyyy').format(model.model.birth_date)}",
  "my_referals[birth_code]": "${model.model.birth_code }",
   "my_referals[jenis_kelamin_id]": "${model.model.jenis_kelamin_id}",
  "my_referals[address]": "${model.model.address }",
  "my_referals[country_id]": "${model.model.country_id }",
  "my_referals[provinsi_id]": "${model.model.provinsi_id }",
  "my_referals[kabupaten_id]": "${model.model.kabupaten_id }",
  "my_referals[kecamatan_id]": "${model.model.kecamatan_id }",
  "my_referals[kelurahan_id]": "${model.model.kelurahan_id }",
  "my_referals[post_code]": "${model.model.post_code }",
  "my_referals[handphone]": "${model.model.handphone }",
  "my_referals[self_introduction]": "${model.model.self_introduction }",
  "my_referals[website]": "${model.model.website }",
  "my_referals[language_id]": "${model.model.language_id }",
  "my_referals[full_name]": "${model.model.full_name }",
  "my_referals[captcha]": "${model.model.captcha }",
  "my_referals[secure_code]": "${model.model.secure_code }",
  "my_referals[old_password]": "${model.model.old_password }",
  "my_referals[old_password_confirmation]": "${model.model.old_password }",
  "my_referals[new_email]": "${model.model.new_email }",
  "my_referals[your_email]": "${model.model.your_email }",
  "my_referals[invitation_message]": "${model.model.invitation_message }",
  "my_referals[financial_data]": "${model.model.financial_data }",
  "my_referals[bank_id]": "${model.model.bank_id }",
  "my_referals[branch]": "${model.model.branch }",
  "my_referals[city]": "${model.model.city }",
  "my_referals[account_number]": "${model.model.account_number }",
  "my_referals[account_name]": "${model.model.account_name }",
   "my_referals[cutoff_period_id]": "${model.model.cutoff_period_id}",
  "my_referals[cutoff_amount]": "${model.model.cutoff_amount}",
  "my_referals[deposit_amount]": "${model.model.deposit_amount}",
  "my_referals[statistics]": "${model.model.statistics }",
  "my_referals[money_earned]": "${model.model.money_earned}",
  "my_referals[money_spent]": "${model.model.money_spent}",
  "my_referals[available_balance]": "${model.model.available_balance}",
  "my_referals[withheld_balance]": "${model.model.withheld_balance}",
  "my_referals[admin_notes]": "${model.model.admin_notes }",
  "my_referals[pesta_point]": "${model.model.pesta_point }",
  "my_referals[worker_rating]": "${model.model.worker_rating }",
  "my_referals[worker_ranking]": "${model.model.worker_ranking }",
  "my_referals[worker_point]": "${model.model.worker_point }",
  "my_referals[worker_rating_num]": "${model.model.worker_rating_num}",
  "my_referals[worker_rating_sum]": "${model.model.worker_rating_sum }",
  "my_referals[worker_rating_div]": "${model.model.worker_rating_div }",
  "my_referals[owner_rating]": "${model.model.owner_rating }",
  "my_referals[owner_ranking]": "${model.model.owner_ranking }",
  "my_referals[owner_point]": "${model.model.owner_point }",
  "my_referals[owner_rating_num]": "${model.model.owner_rating_num}",
  "my_referals[owner_rating_sum]": "${model.model.owner_rating_sum }",
  "my_referals[owner_rating_div]": "${model.model.owner_rating_div }",
  "my_referals[seller_rating]": "${model.model.seller_rating }",
  "my_referals[seller_ranking]": "${model.model.seller_ranking }",
  "my_referals[seller_point]": "${model.model.seller_point }",
  "my_referals[seller_rating_num]": "${model.model.seller_rating_num}",
  "my_referals[seller_rating_sum]": "${model.model.seller_rating_sum }",
  "my_referals[seller_rating_div]": "${model.model.seller_rating_div }",
  "my_referals[buyer_rating]": "${model.model.buyer_rating }",
  "my_referals[buyer_ranking]": "${model.model.buyer_ranking }",
  "my_referals[buyer_point]": "${model.model.buyer_point }",
  "my_referals[buyer_rating_num]": "${model.model.buyer_rating_num}",
  "my_referals[buyer_rating_sum]": "${model.model.buyer_rating_sum }",
  "my_referals[buyer_rating_div]": "${model.model.buyer_rating_div }",
  "my_referals[affiliate_rating]": "${model.model.affiliate_rating }",
  "my_referals[affiliate_ranking]": "${model.model.affiliate_ranking }",
  "my_referals[affiliate_point]": "${model.model.affiliate_point }",
  "my_referals[affiliate_rating_num]": "${model.model.affiliate_rating_num}",
  "my_referals[affiliate_rating_sum]": "${model.model.affiliate_rating_sum }",
  "my_referals[affiliate_rating_div]": "${model.model.affiliate_rating_div }",
  "my_referals[projects_won]": "${model.model.projects_won }",
  "my_referals[projects_won_cumulative]": "${model.model.projects_won_cumulative}",
  "my_referals[projects_owned]": "${model.model.projects_owned }",
  "my_referals[projects_owned_cumulative]": "${model.model.projects_owned_cumulative}",
  "my_referals[projects_noaction]": "${model.model.projects_noaction }",
  "my_referals[projects_canceled]": "${model.model.projects_canceled }",
  "my_referals[missed_payment]": "${model.model.missed_payment }",
  "my_referals[projects_completed]": "${model.model.projects_completed }",
  "my_referals[projects_arbitrated]": "${model.model.projects_arbitrated }",
  "my_referals[projects_arbit_won]": "${model.model.projects_arbit_won }",
  "my_referals[projects_arbit_lost]": "${model.model.projects_arbit_lost }",
  "my_referals[current_projects]": "${model.model.current_projects }",
  "my_referals[missed_weekly_report]": "${model.model.missed_weekly_report }",
  "my_referals[product_sold]": "${model.model.product_sold }",
  "my_referals[product_sold_cumulative]": "${model.model.product_sold_cumulative}",
  "my_referals[product_bought]": "${model.model.product_bought }",
  "my_referals[product_bought_cumulative]": "${model.model.product_bought_cumulative}",
  "my_referals[bid_count]": "${model.model.bid_count }",
  "my_referals[post_count]": "${model.model.post_count }",
  "my_referals[work_quality]": "${model.model.work_quality }",
  "my_referals[work_quality_num]": "${model.model.work_quality_num}",
  "my_referals[work_quality_sum]": "${model.model.work_quality_sum }",
  "my_referals[work_quality_div]": "${model.model.work_quality_div }",
  "my_referals[expertise]": "${model.model.expertise }",
  "my_referals[expertise_num]": "${model.model.expertise_num}",
  "my_referals[expertise_sum]": "${model.model.expertise_sum }",
  "my_referals[expertise_div]": "${model.model.expertise_div }",
  "my_referals[worker_communication]": "${model.model.worker_communication }",
  "my_referals[worker_communication_num]": "${model.model.worker_communication_num}",
  "my_referals[worker_communication_sum]": "${model.model.worker_communication_sum }",
  "my_referals[worker_communication_div]": "${model.model.worker_communication_div }",
  "my_referals[worker_professionalism]": "${model.model.worker_professionalism }",
  "my_referals[worker_professionalism_num]": "${model.model.worker_professionalism_num}",
  "my_referals[worker_professionalism_sum]": "${model.model.worker_professionalism_sum }",
  "my_referals[worker_professionalism_div]": "${model.model.worker_professionalism_div }",
  "my_referals[clarity]": "${model.model.clarity }",
  "my_referals[clarity_num]": "${model.model.clarity_num}",
  "my_referals[clarity_sum]": "${model.model.clarity_sum }",
  "my_referals[clarity_div]": "${model.model.clarity_div }",
  "my_referals[friendliness]": "${model.model.friendliness }",
  "my_referals[friendliness_num]": "${model.model.friendliness_num}",
  "my_referals[friendliness_sum]": "${model.model.friendliness_sum }",
  "my_referals[friendliness_div]": "${model.model.friendliness_div }",
  "my_referals[owner_communication]": "${model.model.owner_communication }",
  "my_referals[owner_communication_num]": "${model.model.owner_communication_num}",
  "my_referals[owner_communication_sum]": "${model.model.owner_communication_sum }",
  "my_referals[owner_communication_div]": "${model.model.owner_communication_div }",
  "my_referals[owner_professionalism]": "${model.model.owner_professionalism }",
  "my_referals[owner_professionalism_num]": "${model.model.owner_professionalism_num}",
  "my_referals[owner_professionalism_sum]": "${model.model.owner_professionalism_sum }",
  "my_referals[owner_professionalism_div]": "${model.model.owner_professionalism_div }",
  "my_referals[product_quality]": "${model.model.product_quality }",
  "my_referals[product_quality_num]": "${model.model.product_quality_num}",
  "my_referals[product_quality_sum]": "${model.model.product_quality_sum }",
  "my_referals[product_quality_div]": "${model.model.product_quality_div }",
  "my_referals[service_quality]": "${model.model.service_quality }",
  "my_referals[service_quality_num]": "${model.model.service_quality_num}",
  "my_referals[service_quality_sum]": "${model.model.service_quality_sum }",
  "my_referals[service_quality_div]": "${model.model.service_quality_div }",
  "my_referals[seller_communication]": "${model.model.seller_communication }",
  "my_referals[seller_communication_num]": "${model.model.seller_communication_num}",
  "my_referals[seller_communication_sum]": "${model.model.seller_communication_sum }",
  "my_referals[seller_communication_div]": "${model.model.seller_communication_div }",
  "my_referals[seller_professionalism]": "${model.model.seller_professionalism }",
  "my_referals[seller_professionalism_num]": "${model.model.seller_professionalism_num}",
  "my_referals[seller_professionalism_sum]": "${model.model.seller_professionalism_sum }",
  "my_referals[seller_professionalism_div]": "${model.model.seller_professionalism_div }",
  "my_referals[referer_id]": "${model.model.referer_id }",
  "my_referals[referer_expires]": "${DateFormat('dd/MM/yyyy HH:mm:ss').format(model.model.referer_expires)}",
  "my_referals[referal_this_month]": "${model.model.referal_this_month }",
  "my_referals[cookies_this_month]": "${model.model.cookies_this_month }",
  "my_referals[premium_affiliate]": "${model.model.premium_affiliate ? 1 : 0}",
  "my_referals[refered_users]": "${model.model.refered_users }",
  "my_referals[referal_earnings]": "${model.model.referal_earnings}",
  "my_referals[affiliate_id]": "${model.model.affiliate_id }",
  "my_referals[last_announced_project]": "${model.model.last_announced_project }",
  "my_referals[notif_count]": "${model.model.notif_count }",
  "my_referals[notify_projects]": "${model.model.notify_projects ? 1 : 0}",
  "my_referals[lost_arbitration_recently]": "${model.model.lost_arbitration_recently ? 1 : 0}",
  "my_referals[coupon]": "${model.model.coupon }",
	  
  };  
      int  count = 0;
      for(var tag in model.model.skills_id){
        formData.addAll({"my_referals[inline_tags][selection][$count]": "$tag"});
        count++;
      }
  ...
  List<SpeedDialChild> listButton(BuildContext context,var formKey, ScrollController controller, MyReferalsController my_referals,
  var postMyReferalsResult, State state, String? sendPath, String? id,  String? title){
    final List<SpeedDialChild> buttonChildren = <SpeedDialChild>[
    ];
	for(var i = 0; i < model.buttons.length; i++)
    {
      if(model.buttons[i].text != "Table View"){
      buttonChildren!.add(ButtonEditMyReferalsWidget(model.buttons[i], context,formKey, controller,my_referals, postMyReferalsResult, state, sendPath, id,  title ));
      }  
    }
       return(
	        buttonChildren 
    ...
    SpeedDial	 Buttons(BuildContext context, bool?visible, var formKey, ScrollController controller, MyReferalsController my_referals,
  var postMyReferalsResult, State state, String? sendPath, String? id,  String? title ){
     return(
	 SpeedDial(
				//marginRight: 18,
				...
				elevation: 8.0,
				shape: CircleBorder(),
				children:listButton(context, formKey,controller,my_referals, postMyReferalsResult, state, sendPath!, id!,  title! )
	    )
	 );
   } 

SpeedDialChild ButtonEditMyReferalsWidget(Button button, BuildContext context,var formKey, ScrollController controller, MyReferalsController my_referals,
 var postMyReferalsResult, State state, String? sendPath, String? id,  String? title){
  if(button.type == 'custom_filter'){
	...
	return(	SpeedDialChild(
		  ...
		  onTap: ()async{
		  {
                        ...
                        formData,
						false);
                        final future = my_referals.postMyReferals();
                        future.then((value) {
                        state.setState(() {
                        postMyReferalsResult = value;
...
class MyReferalsSuperBase {

  String? id;
  Meta? meta;
  List<Button?>? buttons;
  ModelMyReferals? model;
  MyReferalsSuperBase(
	  this.id,
	  this.buttons,
	  this.meta,
  ...
  factory MyReferalsSuperBase.fromJson(Map<String, dynamic> json) => _$MyReferalsSuperBaseFromJson(json);

  Map<String, dynamic> toJson() => _$MyReferalsSuperBaseToJson(this);
...
class ViewModelMyReferals {
  ...
  String? referal_earnings_str;
   ...
   factory ViewModelMyReferals.fromJson(Map<String, dynamic> json) => _$ViewModelMyReferalsFromJson(json);

   Map<String, dynamic> toJson() => _$ViewModelMyReferalsToJson(this); 
  
}


class MyReferalsViewBase{
	var model;
	Map<String, dynamic> json;
	final List<Widget> viewChildren = <Widget>[
	];
	MyReferalsViewBase(this.json);
	
	
   List<SpeedDialChild>	 listButton(BuildContext context, bool?visible, var formKey, ScrollController controller, MyReferalsController my_referals,
	...
	for(var i = 0; i < model.buttons.length; i++)
    {
      ...
      buttonChildren!.add(ButtonViewMyReferalsWidget(model.buttons[i],context,  formKey, controller, my_referals,
 ...
 SpeedDialChild ButtonViewMyReferalsWidget(Button button, BuildContext context,var formKey, ScrollController controller, MyReferalsController my_referals,
  State state, String? sendPath, String? id,  String? title, bool?account){
  if(button.type == 'custom_filter'){
    return (
	       SpeedDialChild(
	...
	return(	SpeedDialChild(
		  ...
		  onTap: ()async{
		  {
                        ...
                        null,
						false);
                        final future = my_referals.downloadFile();
                        future.then((value) {
                        state.setState(() {
                       // postMyReferalsResult = value;
						//AppProvider.getRouter(context)!.pop(context);	
    ...
    State state, String? sendPath, String? id,  String? title, bool? account){
	 ...
	 SpeedDial(
				...
				elevation: 8.0,
				shape: CircleBorder(),
				children:listButton(context, visible!, formKey, controller, my_referals,
                                    state, sendPath, id!,  title!, account! )
	    )
	 );
   } 	
	...
	Widget view (BuildContext context, ScrollController controller, bool?account) {
	  ...
	  if(this.model.meta.before_content != null){ viewChildren!.add(Padding(
	   ...
	   viewChildren!.add(viewAffiliateId(context)); 
	   viewChildren!.add(viewReferalThisMonth(context)); 
	   viewChildren!.add(viewCookiesThisMonth(context)); 
	   viewChildren!.add(viewReferedUsers(context)); 
	   viewChildren!.add(viewReferalEarnings(context)); 
   ...
   return(  SingleChildScrollView(
    ...
    if(model.model.affiliate_id != null){
		return(  NumberView(
		value: model.model.affiliate_id,
		caption: 'Affiliate ID',
	    ));
    ...
    if(model.model.referal_this_month != null){
		return(  NumberView(
		value: model.model.referal_this_month,
		caption: 'Referal This Month',
	    ));
    ...
    if(model.model.cookies_this_month != null){
		return(  NumberView(
		value: model.model.cookies_this_month,
		caption: 'Cookies This Month',
	    ));
    ...
    if(model.model.referal_earnings != null){
		return(  MoneyView(
		value: model.model.referal_earnings,
		caption: 'Referal Earnings',
		));
...
@JsonSerializable()
class MyReferalsViewSuperBase {

  String? id;
  Meta? meta;
  List<Button?>? buttons;
  ViewModelMyReferals? model;
  MyReferalsViewSuperBase(
      this.id,
      this.buttons,
      this.meta,
      this.model,
      ...
      factory MyReferalsViewSuperBase.fromJson(Map<String, dynamic> json) => _$MyReferalsViewSuperBaseFromJson(json);
      Map<String, dynamic> toJson() => _$MyReferalsViewSuperBaseToJson(this);
...
class MyReferalsListingBase{
  var items;
  var tools;
	Map<String, dynamic> json;
	MyReferalsListingBase(this.json){
		items = MyReferalsListingItems.fromJson(this.json);
		tools = MyReferalsListingTools.fromJson(this.json);
	}
	
  Widget viewItem (ItemMyReferalsModel item,String? search, bool?account) {
	ShapeBorder? shape;
    double? height = 0;
	...
	totalHeight = totalHeight + 4 ;
	  ...
	  height = totalHeight * 50;
        ...
        child:  ItemMyReferalsCard(destination :item, search : search!, shape : shape!, height : height!)
    );
  ...
  Widget viewItemId(ItemMyReferalsModel item,String? search, int? index, bool?account, String? id) {
	ShapeBorder? shape;
    double? height = 0;
	double? totalHeight = 0;
	   totalHeight = totalHeight + 2 ;
	...
	totalHeight = totalHeight + 4 ;
	  ...
	  Widget viewItemIndex (ItemMyReferalsModel item,String? search, int? index, bool?account) {
	ShapeBorder? shape;
    double? height = 0;
	double? totalHeight = 0;
	   totalHeight = totalHeight + 2 ;
...
Widget viewItem1 (ItemMyReferalsModel item,ItemMyReferalsModel item1, String? search, BuildContext context,bool?account, String? id , bool?isMax, int? max, int? index) {
	ShapeBorder? shape;
    double? height = 0;
	double? totalHeight = 0;
	    return Visibility (
	...
	Widget viewItemState (ItemMyReferalsModel item,String? search, int? index, BuildContext context, bool?account, State st, VoidCallback onrefresh) {
	ShapeBorder? shape;
    double? height = 0;
	double? totalHeight = 0;
	   totalHeight = totalHeight + 2 ;
   ...
   // if(tools.buttons[i].text != "Table View"){
      ...
      buttonChildren!.add(ListButtonMyReferalsWidget(tools.buttons[i],context, account));
   // }  
    }
...
class MyReferalsListingItems{
  List<ItemMyReferalsModel?>? items;
  MyReferalsListingItems(
      this.items,
      );

  factory MyReferalsListingItems.fromJson(Map<String, dynamic> json) {
  	return MyReferalsListingItems(
				(json['items'] as List)
						?.map((e) => e == null
						? null
						: ItemMyReferalsModel(e as Map<String, dynamic>))
						?.toList());
	}
}
...
@JsonSerializable()
class MyReferalsListingTools{

	String? id;
	Meta? meta;
	List<Button?>? buttons;
	Paging? paging;
	List<ItemMyReferals?>? items;
	MyReferalsListingTools(
			this.id,
			this.buttons,
			this.meta,
			this.paging,
	...
	factory MyReferalsListingTools.fromJson(Map<String, dynamic> json) => _$MyReferalsListingToolsFromJson(json);

	Map<String, dynamic> toJson() => _$MyReferalsListingToolsToJson(this);
...
class ItemMyReferalsCard extends StatelessWidget {
  const ItemMyReferalsCard({ Key? key, @required this.destination, this.search, this.shape, this.height})
      : assert(destination != null),
        super(key: key);

  // This height will allow for all the Card's content to fit comfortably within the card.
  final double? height ;
  final ItemMyReferalsModel? destination;
  final String? search;
            ...
            Container(
             // height: height,
              child: Card(
                ...
                shape: shape,
                child: ItemMyReferalsContent(destination: destination),
              ),
            ),
          ],
        ),
...
class ItemMyReferalsContent extends StatelessWidget {
  const ItemMyReferalsContent({ Key? key, @required this.destination })
      : assert(destination != null),
        super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    final List<Widget>buttonChildren = <Widget>[
	  ...
	  if (destination!.item.buttons != null) {
		...
		{
		  buttonChildren!.add(itemMyReferalsButton(destination,i , context));
		}
    }
...
Widget itemMyReferalsButton(ItemMyReferalsModel? destination, int? index, BuildContext context){
...
class ItemMyReferalsWidget extends StatelessWidget {

	final ItemMyReferalsModel?  item;
	final String? search;
	const  ItemMyReferalsWidget({Key? key, @required this.item, this.search}) : super(key: key);
...
SpeedDialChild ListButtonMyReferalsWidget(Button button, BuildContext context, bool?account){
    var cl;
	var ic;
  	if (button.color == 'green'){
  		cl = Colors.green;
