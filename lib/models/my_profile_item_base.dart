...
import 'photo.dart';
import 'paging.dart';
part 'my_profile_item_base.g.dart';



class ItemMyProfileBase {
	var item;
	Map<String, dynamic> json;
	ItemMyProfileBase(this.json){
		item = ItemMyProfile.fromJson(json);
	}	
...
class ItemMyProfile{
  ...
  factory ItemMyProfile.fromJson(Map<String, dynamic> json) => _$ItemMyProfileFromJson(json);

  Map<String, dynamic> toJson() => _$ItemMyProfileToJson(this);
