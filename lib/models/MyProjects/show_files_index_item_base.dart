...
import '../photo.dart';
import '../paging.dart';
part 'show_files_index_item_base.g.dart';

class ItemIndexShowFilesBase {
	ItemIndexShowFiles? item;
	Map<String, dynamic> json;
	ItemIndexShowFilesBase(this.json){
		item = ItemIndexShowFiles.fromJson(json);
	}	
...
class ItemIndexShowFiles{
  ...
  factory ItemIndexShowFiles.fromJson(Map<String, dynamic> json) => _$ItemIndexShowFilesFromJson(json);

  Map<String, dynamic> toJson() => _$ItemIndexShowFilesToJson(this);
