...
part 'shortlisted_bids_edit_base.g.dart';
...
class EditModelShortlistedBids {
  int?    age;
  int?    cnt;
  int?    page;
  String? id;
  ...
  String? published_budget;
    ...
    factory EditModelShortlistedBids.fromJson(Map<String, dynamic> json) => _$EditModelShortlistedBidsFromJson(json);

  Map<String, dynamic> toJson() => _$EditModelShortlistedBidsToJson(this);
...
class ShortlistedBidsSuperBase {
  ...
  Meta? meta;
  List<Button?>? buttons;
  EditModelShortlistedBids? model;
...
class EditShortlistedBidsBase{
	var model;
	Map<String, dynamic> json;
	EditShortlistedBidsBase(this.json){
  ...
  var formData = convertFormDataEdit(model);  
	...
	for(var i = 0; i < model.buttons.length; i++)
    {
      ...
      buttonChildren.add(RButtonActionShortlistedBidsWidget(model.buttons[i], context,formKey, controller,shortlisted_bids, postShortlistedBidsResult, state, sendPath, id,  title, formData));
      }
    }
       return(
	        buttonChildren 
    ...
    return(
        ButtonBarTheme(
            ...
            child: ButtonBar(
                ...
                buttonMinWidth: 0.9 * width,
                children:
           RlistButton(context, formKey,controller,shortlisted_bids, postShortlistedBidsResult, state, sendPath, id,  title )
