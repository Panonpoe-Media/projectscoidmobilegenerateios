...
part 'show_thread_report_progress_base.g.dart';



@JsonSerializable()

class ModelActionReportProgressShowThread {
  int?    age;
  int?    cnt;
  int?    page;
  String? id;
...
String? post_id;
  ...
  bool?  read_by_worker;
	  ...
	  ModelActionReportProgressShowThread(
            this.id,
			this.post_id,
			this.user_id,
			this.user_str,
    ...
    factory ModelActionReportProgressShowThread.fromJson(Map<String, dynamic> json) => _$ModelActionReportProgressShowThreadFromJson(json);

  Map<String, dynamic> toJson() => _$ModelActionReportProgressShowThreadToJson(this);

}

@JsonSerializable()
class ReportProgressShowThreadSuperBase {

  String? id;
  Meta? meta;
  List<Button?>? buttons;
  ModelActionReportProgressShowThread? model;
  ReportProgressShowThreadSuperBase(
	  this.id,
	  this.buttons,
	  this.meta,
	  this.model,
  ...
  factory ReportProgressShowThreadSuperBase.fromJson(Map<String, dynamic> json) => _$ReportProgressShowThreadSuperBaseFromJson(json);

  Map<String, dynamic> toJson() => _$ReportProgressShowThreadSuperBaseToJson(this);
  
 
}

class ReportProgressShowThreadBase{
	var model;
	Map<String, dynamic> json;
            var attachmentslast ;   
	ReportProgressShowThreadBase(this.json){
		model = ReportProgressShowThreadSuperBase.fromJson(this.json);
 ...
 var postShowThreadResult, State state, String? sendPath, String? id,  String? title){
  ...
  var postReportProgressResult, State state, String? sendPath, String? id,  String? title){
	...
	for(var i = 0; i < model.buttons.length; i++)
    {
      ...
      buttonChildren.add(RButtonActionShowThreadWidget(model.buttons[i], context,formKey, controller,show_thread, postReportProgressResult, state, sendPath, id,  title));
      }
    }
       return(
	        buttonChildren 
  ...
  var postReportProgressResult, State state, String? sendPath, String? id,  String? title){
	...
	for(var i = 0; i < model.buttons.length; i++)
    {
      buttonChildren.add(ButtonActionShowThreadWidget(model.buttons[i], context,formKey, controller,show_thread, postReportProgressResult, state, sendPath, id,  title ));
    }
       return(
	        buttonChildren 
	   );
    ...
    return(
        ButtonBarTheme(
            ...
            child: ButtonBar(
                ...
                buttonMinWidth: 0.9 * width,
                children:
           RlistButton(context, formKey,controller,show_thread, postReportProgressResult, state, sendPath, id,  title )
  ...
  var postReportProgressResult, State state, String? sendPath, String? id,  String? title ){
	 ...
	 SpeedDial(
				...
				elevation: 8.0,
				shape: CircleBorder(),
				children:listButton(context, formKey,controller,show_thread, postReportProgressResult, state, sendPath, id,  title )
	    )
	 );
   } 
