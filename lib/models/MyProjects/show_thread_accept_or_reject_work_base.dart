...
part 'show_thread_accept_or_reject_work_base.g.dart';



@JsonSerializable()

class ModelActionAcceptOrRejectWorkShowThread {
  int?    age;
  int?    cnt;
  int?    page;
  String? id;
...
String? post_id;
  ...
  bool?  read_by_worker;
	  ...
	  ModelActionAcceptOrRejectWorkShowThread(
            this.id,
			this.post_id,
			this.user_id,
			this.user_str,
    ...
    factory ModelActionAcceptOrRejectWorkShowThread.fromJson(Map<String, dynamic> json) => _$ModelActionAcceptOrRejectWorkShowThreadFromJson(json);

  Map<String, dynamic> toJson() => _$ModelActionAcceptOrRejectWorkShowThreadToJson(this);

}

@JsonSerializable()
class AcceptOrRejectWorkShowThreadSuperBase {

  String? id;
  Meta? meta;
  List<Button?>? buttons;
  ModelActionAcceptOrRejectWorkShowThread? model;
  AcceptOrRejectWorkShowThreadSuperBase(
	  this.id,
	  this.buttons,
	  this.meta,
	  this.model,
  ...
  factory AcceptOrRejectWorkShowThreadSuperBase.fromJson(Map<String, dynamic> json) => _$AcceptOrRejectWorkShowThreadSuperBaseFromJson(json);

  Map<String, dynamic> toJson() => _$AcceptOrRejectWorkShowThreadSuperBaseToJson(this);
  
 
}

class AcceptOrRejectWorkShowThreadBase{
	var model;
	Map<String, dynamic> json;
            var attachmentslast ;   
	AcceptOrRejectWorkShowThreadBase(this.json){
		model = AcceptOrRejectWorkShowThreadSuperBase.fromJson(this.json);
 ...
 var postShowThreadResult, State state, String? sendPath, String? id,  String? title){
  ...
  String? attachments_last = '';
   if(isEdit && attachmentslast != null){
	...
	if (model.model.attachments!= null) {
     ...
     String? tgr =   'accept_or_reject_work';
  ...
  var postAcceptOrRejectWorkResult, State state, String? sendPath, String? id,  String? title){
	...
	for(var i = 0; i < model.buttons.length; i++)
    {
      ...
      buttonChildren.add(RButtonActionShowThreadWidget(model.buttons[i], context,formKey, controller,show_thread, postAcceptOrRejectWorkResult, state, sendPath, id,  title));
      }
    }
       return(
	        buttonChildren 
  ...
  var postAcceptOrRejectWorkResult, State state, String? sendPath, String? id,  String? title){
	...
	for(var i = 0; i < model.buttons.length; i++)
    {
      buttonChildren.add(ButtonActionShowThreadWidget(model.buttons[i], context,formKey, controller,show_thread, postAcceptOrRejectWorkResult, state, sendPath, id,  title ));
    }
       return(
	        buttonChildren 
	   );
    ...
    return(
        ButtonBarTheme(
            ...
            child: ButtonBar(
                ...
                buttonMinWidth: 0.9 * width,
                children:
           RlistButton(context, formKey,controller,show_thread, postAcceptOrRejectWorkResult, state, sendPath, id,  title )
  ...
  var postAcceptOrRejectWorkResult, State state, String? sendPath, String? id,  String? title ){
	 ...
	 SpeedDial(
				...
				elevation: 8.0,
				shape: CircleBorder(),
				children:listButton(context, formKey,controller,show_thread, postAcceptOrRejectWorkResult, state, sendPath, id,  title )
	    )
	 );
   } 
