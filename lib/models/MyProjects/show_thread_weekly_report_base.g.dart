...
part of 'show_thread_weekly_report_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ModelActionWeeklyReportShowThread _$ModelActionWeeklyReportShowThreadFromJson(
...
Map<String, dynamic> _$ModelActionWeeklyReportShowThreadToJson(
        ModelActionWeeklyReportShowThread instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
WeeklyReportShowThreadSuperBase _$WeeklyReportShowThreadSuperBaseFromJson(
        Map<String, dynamic> json) =>
    WeeklyReportShowThreadSuperBase(
      ...
      json['model'] == null
          ? null
          : ModelActionWeeklyReportShowThread.fromJson(
              json['model'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$WeeklyReportShowThreadSuperBaseToJson(
        WeeklyReportShowThreadSuperBase instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
