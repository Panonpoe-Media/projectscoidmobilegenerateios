...
part of 'show_files_view_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ViewModelShowFiles _$ViewModelShowFilesFromJson(Map<String, dynamic> json) =>
    ViewModelShowFiles(
      json['id'] as String?,
...
Map<String, dynamic> _$ViewModelShowFilesToJson(ViewModelShowFiles instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
ShowFilesViewSuperBase _$ShowFilesViewSuperBaseFromJson(
    ...
    ShowFilesViewSuperBase(
      ...
      json['model'] == null
          ? null
          : ViewModelShowFiles.fromJson(json['model'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$ShowFilesViewSuperBaseToJson(
        ShowFilesViewSuperBase instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
