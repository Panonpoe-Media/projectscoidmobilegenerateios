...
part of 'show_conversation_edit_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

EditModelShowConversation _$EditModelShowConversationFromJson(
...
Map<String, dynamic> _$EditModelShowConversationToJson(
        EditModelShowConversation instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
ShowConversationSuperBase _$ShowConversationSuperBaseFromJson(
        Map<String, dynamic> json) =>
    ShowConversationSuperBase(
      ...
      json['model'] == null
          ? null
          : EditModelShowConversation.fromJson(
              json['model'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$ShowConversationSuperBaseToJson(
        ShowConversationSuperBase instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
