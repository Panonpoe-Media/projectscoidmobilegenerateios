...
part of 'show_thread_report_progress_base.dart';
...
ModelActionReportProgressShowThread
    _$ModelActionReportProgressShowThreadFromJson(Map<String, dynamic> json) =>
        ModelActionReportProgressShowThread(
          json['id'] as String?,
...
Map<String, dynamic> _$ModelActionReportProgressShowThreadToJson(
        ModelActionReportProgressShowThread instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
ReportProgressShowThreadSuperBase _$ReportProgressShowThreadSuperBaseFromJson(
    ...
    ReportProgressShowThreadSuperBase(
      ...
      json['model'] == null
          ? null
          : ModelActionReportProgressShowThread.fromJson(
              json['model'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$ReportProgressShowThreadSuperBaseToJson(
        ReportProgressShowThreadSuperBase instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
