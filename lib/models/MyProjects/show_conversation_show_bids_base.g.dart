...
part of 'show_conversation_show_bids_base.dart';
...
ModelActionShowBidsShowConversation
    _$ModelActionShowBidsShowConversationFromJson(Map<String, dynamic> json) =>
        ModelActionShowBidsShowConversation(
          json['id'] as String?,
...
Map<String, dynamic> _$ModelActionShowBidsShowConversationToJson(
        ModelActionShowBidsShowConversation instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
ShowBidsShowConversationSuperBase _$ShowBidsShowConversationSuperBaseFromJson(
    ...
    ShowBidsShowConversationSuperBase(
      ...
      json['model'] == null
          ? null
          : ModelActionShowBidsShowConversation.fromJson(
              json['model'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$ShowBidsShowConversationSuperBaseToJson(
        ShowBidsShowConversationSuperBase instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
