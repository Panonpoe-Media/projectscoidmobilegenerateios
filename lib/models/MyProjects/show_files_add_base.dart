...
part 'show_files_add_base.g.dart';
...
class AddModelShowFiles {
  ...
  bool? read_by_worker;
    ...
    factory AddModelShowFiles.fromJson(Map<String, dynamic> json) => _$AddModelShowFilesFromJson(json);

  Map<String, dynamic> toJson() => _$AddModelShowFilesToJson(this);
...
class ShowFilesAddBase{
	var model;
	Map<String, dynamic> json;
	ShowFilesAddBase(this.json){
