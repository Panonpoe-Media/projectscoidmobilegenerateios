...
part of 'show_bids_add_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

AddModelShowBids _$AddModelShowBidsFromJson(Map<String, dynamic> json) =>
    AddModelShowBids(
      json['id'] as String?,
      json['bid_id'] as int?,
...
Map<String, dynamic> _$AddModelShowBidsToJson(AddModelShowBids instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
ShowBidsSuperBase _$ShowBidsSuperBaseFromJson(Map<String, dynamic> json) =>
    ShowBidsSuperBase(
      ...
      json['model'] == null
          ? null
          : AddModelShowBids.fromJson(json['model'] as Map<String, dynamic>),
    );
