...
part of 'show_thread_respond_arbitration_base.dart';
...
ModelActionRespondArbitrationShowThread
    _$ModelActionRespondArbitrationShowThreadFromJson(
...
Map<String, dynamic> _$ModelActionRespondArbitrationShowThreadToJson(
        ModelActionRespondArbitrationShowThread instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
RespondArbitrationShowThreadSuperBase
    _$RespondArbitrationShowThreadSuperBaseFromJson(
            Map<String, dynamic> json) =>
        RespondArbitrationShowThreadSuperBase(
          json['id'] as String?,
          ...
          json['model'] == null
              ? null
              : ModelActionRespondArbitrationShowThread.fromJson(
                  json['model'] as Map<String, dynamic>),
        );

Map<String, dynamic> _$RespondArbitrationShowThreadSuperBaseToJson(
        RespondArbitrationShowThreadSuperBase instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
