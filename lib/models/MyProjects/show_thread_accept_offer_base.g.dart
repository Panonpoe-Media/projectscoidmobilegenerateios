...
part of 'show_thread_accept_offer_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ModelActionAcceptOfferShowThread _$ModelActionAcceptOfferShowThreadFromJson(
...
Map<String, dynamic> _$ModelActionAcceptOfferShowThreadToJson(
        ModelActionAcceptOfferShowThread instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
AcceptOfferShowThreadSuperBase _$AcceptOfferShowThreadSuperBaseFromJson(
        Map<String, dynamic> json) =>
    AcceptOfferShowThreadSuperBase(
      ...
      json['model'] == null
          ? null
          : ModelActionAcceptOfferShowThread.fromJson(
              json['model'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$AcceptOfferShowThreadSuperBaseToJson(
        AcceptOfferShowThreadSuperBase instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
