...
part of 'show_thread_cancel_arbitration_base.dart';
...
ModelActionCancelArbitrationShowThread
    _$ModelActionCancelArbitrationShowThreadFromJson(
...
Map<String, dynamic> _$ModelActionCancelArbitrationShowThreadToJson(
        ModelActionCancelArbitrationShowThread instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
CancelArbitrationShowThreadSuperBase
    _$CancelArbitrationShowThreadSuperBaseFromJson(Map<String, dynamic> json) =>
        CancelArbitrationShowThreadSuperBase(
          json['id'] as String?,
          ...
          json['model'] == null
              ? null
              : ModelActionCancelArbitrationShowThread.fromJson(
                  json['model'] as Map<String, dynamic>),
        );

Map<String, dynamic> _$CancelArbitrationShowThreadSuperBaseToJson(
        CancelArbitrationShowThreadSuperBase instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
