...
part 'shortlisted_bids_view_base.g.dart';
...
@JsonSerializable()
class ViewModelShortlistedBids {
  int?    age;
  int?    cnt;
  int?    page;
  String? id;
  ...
  String? captcha;
   ...
   factory ViewModelShortlistedBids.fromJson(Map<String, dynamic> json) => _$ViewModelShortlistedBidsFromJson(json);

   Map<String, dynamic> toJson() => _$ViewModelShortlistedBidsToJson(this); 
  
}

@JsonSerializable()
class ShortlistedBidsViewSuperBase {

  String? id;
  Meta? meta;
  List<Button?>? buttons;
  ViewModelShortlistedBids? model;
  ShortlistedBidsViewSuperBase(
      this.id,
      this.buttons,
      this.meta,
      this.model,
  ...
  factory ShortlistedBidsViewSuperBase.fromJson(Map<String, dynamic> json) => _$ShortlistedBidsViewSuperBaseFromJson(json);
  Map<String, dynamic> toJson() => _$ShortlistedBidsViewSuperBaseToJson(this);
   
}

class ShortlistedBidsViewBase{
	var model;
	Map<String, dynamic> json;
	ShortlistedBidsViewBase(this.json){
		model = ShortlistedBidsViewSuperBase.fromJson(this.json);
	}
   ...
   List<SpeedDialChild>	 listButton(BuildContext context){
    ...
    {
      buttonChildren.add(ListButtonShortlistedBidsWidget(model.buttons[i],context));
    }
