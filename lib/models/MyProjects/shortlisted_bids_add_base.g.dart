...
part of 'shortlisted_bids_add_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

AddModelShortlistedBids _$AddModelShortlistedBidsFromJson(
...
Map<String, dynamic> _$AddModelShortlistedBidsToJson(
        AddModelShortlistedBids instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
ShortlistedBidsSuperBase _$ShortlistedBidsSuperBaseFromJson(
    ...
    ShortlistedBidsSuperBase(
      ...
      json['model'] == null
          ? null
          : AddModelShortlistedBids.fromJson(
