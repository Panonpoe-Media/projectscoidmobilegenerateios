...
part 'show_thread_view_base.g.dart';
...
class ViewModelShowThread {
  ...
  bool read_by_worker;
   ...
   factory ViewModelShowThread.fromJson(Map<String, dynamic> json) => _$ViewModelShowThreadFromJson(json);

   Map<String, dynamic> toJson() => _$ViewModelShowThreadToJson(this); 
  
}

@JsonSerializable()
class ShowThreadViewSuperBase {

  String? id;
  Meta? meta;
  List<Button?>? buttons;
  ViewModelShowThread? model;
  ...
  factory ShowThreadViewSuperBase.fromJson(Map<String, dynamic> json) => _$ShowThreadViewSuperBaseFromJson(json);
  Map<String, dynamic> toJson() => _$ShowThreadViewSuperBaseToJson(this);
   
}

class ShowThreadViewBase{
	var model;
	Map<String, dynamic> json;
	ShowThreadViewBase(this.json){
		model = ShowThreadViewSuperBase.fromJson(this.json);
	}
   ...
   List<SpeedDialChild>	 listButton(BuildContext context){
    ...
    {
      buttonChildren.add(ListButtonShowThreadWidget(model.buttons[i],context));
    }
