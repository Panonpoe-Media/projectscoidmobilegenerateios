...
part of 'show_files_add_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

AddModelShowFiles _$AddModelShowFilesFromJson(Map<String, dynamic> json) =>
    AddModelShowFiles(
      json['id'] as String?,
      json['post_id'] as int?,
      json['user_id'] as int?,
...
Map<String, dynamic> _$AddModelShowFilesToJson(AddModelShowFiles instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
ShowFilesSuperBase _$ShowFilesSuperBaseFromJson(Map<String, dynamic> json) =>
    ShowFilesSuperBase(
      ...
      json['model'] == null
          ? null
          : AddModelShowFiles.fromJson(json['model'] as Map<String, dynamic>),
    );
