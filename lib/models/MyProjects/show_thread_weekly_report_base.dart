...
part 'show_thread_weekly_report_base.g.dart';



@JsonSerializable()

class ModelActionWeeklyReportShowThread {
  int?    age;
  int?    cnt;
  int?    page;
  String? id;
...
String? post_id;
  ...
  bool?  read_by_worker;
	  ...
	  ModelActionWeeklyReportShowThread(
            this.id,
			this.post_id,
			this.user_id,
			this.user_str,
    ...
    factory ModelActionWeeklyReportShowThread.fromJson(Map<String, dynamic> json) => _$ModelActionWeeklyReportShowThreadFromJson(json);

  Map<String, dynamic> toJson() => _$ModelActionWeeklyReportShowThreadToJson(this);

}

@JsonSerializable()
class WeeklyReportShowThreadSuperBase {

  String? id;
  Meta? meta;
  List<Button?>? buttons;
  ModelActionWeeklyReportShowThread? model;
  WeeklyReportShowThreadSuperBase(
	  this.id,
	  this.buttons,
	  this.meta,
	  this.model,
  ...
  factory WeeklyReportShowThreadSuperBase.fromJson(Map<String, dynamic> json) => _$WeeklyReportShowThreadSuperBaseFromJson(json);

  Map<String, dynamic> toJson() => _$WeeklyReportShowThreadSuperBaseToJson(this);
  
 
}

class WeeklyReportShowThreadBase{
	var model;
	Map<String, dynamic> json;
            var attachmentslast ;   
	WeeklyReportShowThreadBase(this.json){
		model = WeeklyReportShowThreadSuperBase.fromJson(this.json);
 ...
 var postShowThreadResult, State state, String? sendPath, String? id,  String? title){
  ...
  var postWeeklyReportResult, State state, String? sendPath, String? id,  String? title){
	...
	for(var i = 0; i < model.buttons.length; i++)
    {
      ...
      buttonChildren.add(RButtonActionShowThreadWidget(model.buttons[i], context,formKey, controller,show_thread, postWeeklyReportResult, state, sendPath, id,  title));
      }
    }
       return(
	        buttonChildren 
  ...
  var postWeeklyReportResult, State state, String? sendPath, String? id,  String? title){
	...
	for(var i = 0; i < model.buttons.length; i++)
    {
      buttonChildren.add(ButtonActionShowThreadWidget(model.buttons[i], context,formKey, controller,show_thread, postWeeklyReportResult, state, sendPath, id,  title ));
    }
       return(
	        buttonChildren 
	   );
    ...
    return(
        ButtonBarTheme(
            ...
            child: ButtonBar(
                ...
                buttonMinWidth: 0.9 * width,
                children:
           RlistButton(context, formKey,controller,show_thread, postWeeklyReportResult, state, sendPath, id,  title )
  ...
  var postWeeklyReportResult, State state, String? sendPath, String? id,  String? title ){
	 ...
	 SpeedDial(
				...
				elevation: 8.0,
				shape: CircleBorder(),
				children:listButton(context, formKey,controller,show_thread, postWeeklyReportResult, state, sendPath, id,  title )
	    )
	 );
   } 
