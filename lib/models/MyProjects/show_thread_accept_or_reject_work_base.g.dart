...
part of 'show_thread_accept_or_reject_work_base.dart';
...
ModelActionAcceptOrRejectWorkShowThread
    _$ModelActionAcceptOrRejectWorkShowThreadFromJson(
...
Map<String, dynamic> _$ModelActionAcceptOrRejectWorkShowThreadToJson(
        ModelActionAcceptOrRejectWorkShowThread instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
AcceptOrRejectWorkShowThreadSuperBase
    _$AcceptOrRejectWorkShowThreadSuperBaseFromJson(
            Map<String, dynamic> json) =>
        AcceptOrRejectWorkShowThreadSuperBase(
          json['id'] as String?,
          ...
          json['model'] == null
              ? null
              : ModelActionAcceptOrRejectWorkShowThread.fromJson(
                  json['model'] as Map<String, dynamic>),
        );

Map<String, dynamic> _$AcceptOrRejectWorkShowThreadSuperBaseToJson(
        AcceptOrRejectWorkShowThreadSuperBase instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
