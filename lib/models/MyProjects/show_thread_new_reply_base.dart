...
part 'show_thread_new_reply_base.g.dart';
...
class ModelActionNewReplyShowThread {
  int?    age;
  int?    cnt;
  int?    page;
  String? id;
...
String? post_id;
  ...
  List<FileField?>? attachments;
    ...
    factory ModelActionNewReplyShowThread.fromJson(Map<String, dynamic> json) => _$ModelActionNewReplyShowThreadFromJson(json);

  Map<String, dynamic> toJson() => _$ModelActionNewReplyShowThreadToJson(this);

}

@JsonSerializable()
class NewReplyShowThreadSuperBase {

  String? id;
  Meta? meta;
  List<Button?>? buttons;
  ModelActionNewReplyShowThread? model;
  ...
  factory NewReplyShowThreadSuperBase.fromJson(Map<String, dynamic> json) => _$NewReplyShowThreadSuperBaseFromJson(json);

  Map<String, dynamic> toJson() => _$NewReplyShowThreadSuperBaseToJson(this);
  
 
}

class NewReplyShowThreadBase{
	var model;
	Map<String, dynamic> json;
            var attachmentslast ;   
	NewReplyShowThreadBase(this.json){
		model = NewReplyShowThreadSuperBase.fromJson(this.json);
 ...
 var postShowThreadResult, State state, String sendPath, String id,  String title){
  ...
  var postNewReplyResult, State state, String sendPath, String id,  String title){
	...
	for(var i = 0; i < model.buttons.length; i++)
    {
      ...
      buttonChildren.add(RButtonActionShowThreadWidget(model.buttons[i], context,formKey, controller,show_thread, postNewReplyResult, state, sendPath, id,  title));
      }
    }
       return(
	        buttonChildren 
  ...
  var postNewReplyResult, State state, String sendPath, String id,  String title){
	...
	for(var i = 0; i < model.buttons.length; i++)
    {
      buttonChildren.add(ButtonActionShowThreadWidget(model.buttons[i], context,formKey, controller,show_thread, postNewReplyResult, state, sendPath, id,  title ));
    }
       return(
	        buttonChildren 
	   );
    ...
    return(
        ButtonBarTheme(
            ...
            child: ButtonBar(
                ...
                buttonMinWidth: 0.9 * width,
                children:
           RlistButton(context, formKey,controller,show_thread, postNewReplyResult, state, sendPath, id,  title )
  ...
  var postNewReplyResult, State state, String sendPath, String id,  String title ){
	 ...
	 SpeedDial(
        ...
        childMargin: const EdgeInsets.symmetric(horizontal: 18, vertical: 20),
				...
				elevation: 8.0,
				shape: CircleBorder(),
				children:listButton(context, formKey,controller,show_thread, postNewReplyResult, state, sendPath, id,  title )
	    )
	 );
   } 
