...
part of 'show_thread_report_done_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ModelActionReportDoneShowThread _$ModelActionReportDoneShowThreadFromJson(
...
Map<String, dynamic> _$ModelActionReportDoneShowThreadToJson(
        ModelActionReportDoneShowThread instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
ReportDoneShowThreadSuperBase _$ReportDoneShowThreadSuperBaseFromJson(
        Map<String, dynamic> json) =>
    ReportDoneShowThreadSuperBase(
      ...
      json['model'] == null
          ? null
          : ModelActionReportDoneShowThread.fromJson(
              json['model'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$ReportDoneShowThreadSuperBaseToJson(
        ReportDoneShowThreadSuperBase instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
