...
part 'shortlisted_bids_view_profile_base.g.dart';



@JsonSerializable()

class ModelActionViewProfileShortlistedBids {
  int?    age;
  int?    cnt;
  int?    page;
  String? id;
...
String? bid_id;
  ...
  String? published_budget;
   ...
   String? budget_range_str;
    ...
    factory ModelActionViewProfileShortlistedBids.fromJson(Map<String, dynamic> json) => _$ModelActionViewProfileShortlistedBidsFromJson(json);

  Map<String, dynamic> toJson() => _$ModelActionViewProfileShortlistedBidsToJson(this);

}

@JsonSerializable()
class ViewProfileShortlistedBidsSuperBase {

  String? id;
  Meta? meta;
  List<Button?>? buttons;
  ModelActionViewProfileShortlistedBids? model;
  ...
  factory ViewProfileShortlistedBidsSuperBase.fromJson(Map<String, dynamic> json) => _$ViewProfileShortlistedBidsSuperBaseFromJson(json);

  Map<String, dynamic> toJson() => _$ViewProfileShortlistedBidsSuperBaseToJson(this);
  
 
}

class ViewProfileShortlistedBidsBase{
	var model;
	Map<String, dynamic> json;
            var attachmentslast ;   
	ViewProfileShortlistedBidsBase(this.json){
		model = ViewProfileShortlistedBidsSuperBase.fromJson(this.json);
 ...
 var postShortlistedBidsResult, State state, String? sendPath, String? id,  String? title){
  ...
  var postViewProfileResult, State state, String? sendPath, String? id,  String? title){
	...
	for(var i = 0; i < model.buttons.length; i++)
    {
      ...
      buttonChildren.add(RButtonActionShortlistedBidsWidget(model.buttons[i], context,formKey, controller,shortlisted_bids, postViewProfileResult, state, sendPath, id,  title));
      }
    }
       return(
	        buttonChildren 
  ...
  var postViewProfileResult, State state, String? sendPath, String? id,  String? title){
	...
	for(var i = 0; i < model.buttons.length; i++)
    {
      buttonChildren.add(ButtonActionShortlistedBidsWidget(model.buttons[i], context,formKey, controller,shortlisted_bids, postViewProfileResult, state, sendPath, id,  title ));
    }
       return(
	        buttonChildren 
	   );
    ...
    return(
        ButtonBarTheme(
            ...
            child: ButtonBar(
                ...
                buttonMinWidth: 0.9 * width,
                children:
           RlistButton(context, formKey,controller,shortlisted_bids, postViewProfileResult, state, sendPath, id,  title )
  ...
  var postViewProfileResult, State state, String? sendPath, String? id,  String? title ){
	 ...
	 SpeedDial(
				...
				elevation: 8.0,
				shape: CircleBorder(),
				children:listButton(context, formKey,controller,shortlisted_bids, postViewProfileResult, state, sendPath, id,  title )
	    )
	 );
   } 
