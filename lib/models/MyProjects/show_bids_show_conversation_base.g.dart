...
part of 'show_bids_show_conversation_base.dart';
...
ModelActionShowConversationShowBids
    _$ModelActionShowConversationShowBidsFromJson(Map<String, dynamic> json) =>
        ModelActionShowConversationShowBids(
          json['id'] as String?,
...
Map<String, dynamic> _$ModelActionShowConversationShowBidsToJson(
        ModelActionShowConversationShowBids instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
ShowConversationShowBidsSuperBase _$ShowConversationShowBidsSuperBaseFromJson(
    ...
    ShowConversationShowBidsSuperBase(
      ...
      json['model'] == null
          ? null
          : ModelActionShowConversationShowBids.fromJson(
              json['model'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$ShowConversationShowBidsSuperBaseToJson(
        ShowConversationShowBidsSuperBase instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
