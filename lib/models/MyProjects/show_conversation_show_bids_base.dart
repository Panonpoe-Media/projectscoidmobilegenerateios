...
part 'show_conversation_show_bids_base.g.dart';



@JsonSerializable()

class ModelActionShowBidsShowConversation {
  int?    age;
  int?    cnt;
  int?    page;
  String? id;
...
String? post_id;
  ...
  bool?  read_by_worker;
	  ...
	  ModelActionShowBidsShowConversation(
            this.id,
			this.post_id,
			this.user_id,
			this.user_str,
    ...
    factory ModelActionShowBidsShowConversation.fromJson(Map<String, dynamic> json) => _$ModelActionShowBidsShowConversationFromJson(json);

  Map<String, dynamic> toJson() => _$ModelActionShowBidsShowConversationToJson(this);

}

@JsonSerializable()
class ShowBidsShowConversationSuperBase {

  String? id;
  Meta? meta;
  List<Button?>? buttons;
  ModelActionShowBidsShowConversation? model;
  ShowBidsShowConversationSuperBase(
	  this.id,
	  this.buttons,
	  this.meta,
	  this.model,
  ...
  factory ShowBidsShowConversationSuperBase.fromJson(Map<String, dynamic> json) => _$ShowBidsShowConversationSuperBaseFromJson(json);

  Map<String, dynamic> toJson() => _$ShowBidsShowConversationSuperBaseToJson(this);
  
 
}

class ShowBidsShowConversationBase{
	var model;
	Map<String, dynamic> json;
            var attachmentslast ;   
	ShowBidsShowConversationBase(this.json){
		model = ShowBidsShowConversationSuperBase.fromJson(this.json);
 ...
 var postShowConversationResult, State state, String? sendPath, String? id,  String? title){
  ...
  var postShowBidsResult, State state, String? sendPath, String? id,  String? title){
	...
	for(var i = 0; i < model.buttons.length; i++)
    {
      ...
      buttonChildren.add(RButtonActionShowConversationWidget(model.buttons[i], context,formKey, controller,show_conversation, postShowBidsResult, state, sendPath, id,  title));
      }
    }
       return(
	        buttonChildren 
  ...
  var postShowBidsResult, State state, String? sendPath, String? id,  String? title){
	...
	for(var i = 0; i < model.buttons.length; i++)
    {
      buttonChildren.add(ButtonActionShowConversationWidget(model.buttons[i], context,formKey, controller,show_conversation, postShowBidsResult, state, sendPath, id,  title ));
    }
       return(
	        buttonChildren 
	   );
    ...
    return(
        ButtonBarTheme(
            ...
            child: ButtonBar(
                ...
                buttonMinWidth: 0.9 * width,
                children:
           RlistButton(context, formKey,controller,show_conversation, postShowBidsResult, state, sendPath, id,  title )
  ...
  var postShowBidsResult, State state, String? sendPath, String? id,  String? title ){
	 ...
	 SpeedDial(
				...
				elevation: 8.0,
				shape: CircleBorder(),
				children:listButton(context, formKey,controller,show_conversation, postShowBidsResult, state, sendPath, id,  title )
	    )
	 );
   } 
