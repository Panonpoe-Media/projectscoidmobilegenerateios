...
part of 'show_thread_rate_owner_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ModelActionRateOwnerShowThread _$ModelActionRateOwnerShowThreadFromJson(
...
Map<String, dynamic> _$ModelActionRateOwnerShowThreadToJson(
        ModelActionRateOwnerShowThread instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
RateOwnerShowThreadSuperBase _$RateOwnerShowThreadSuperBaseFromJson(
        Map<String, dynamic> json) =>
    RateOwnerShowThreadSuperBase(
      ...
      json['model'] == null
          ? null
          : ModelActionRateOwnerShowThread.fromJson(
              json['model'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$RateOwnerShowThreadSuperBaseToJson(
        RateOwnerShowThreadSuperBase instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
