...
import '../photo.dart';
import '../paging.dart';
part 'show_thread_index_item_base.g.dart';

class ItemIndexShowThreadBase {
	ItemIndexShowThread? item;
	Map<String, dynamic> json;
	ItemIndexShowThreadBase(this.json){
		item = ItemIndexShowThread.fromJson(json);
	}	
...
class ItemIndexShowThread{
  ...
  factory ItemIndexShowThread.fromJson(Map<String, dynamic> json) => _$ItemIndexShowThreadFromJson(json);

  Map<String, dynamic> toJson() => _$ItemIndexShowThreadToJson(this);
