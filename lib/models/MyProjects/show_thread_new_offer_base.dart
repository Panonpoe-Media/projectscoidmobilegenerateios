...
part 'show_thread_new_offer_base.g.dart';



@JsonSerializable()

class ModelActionNewOfferShowThread {
  int?    age;
  int?    cnt;
  int?    page;
  String? id;
...
String? post_id;
  ...
  bool?  read_by_worker;
    ...
    factory ModelActionNewOfferShowThread.fromJson(Map<String, dynamic> json) => _$ModelActionNewOfferShowThreadFromJson(json);

  Map<String, dynamic> toJson() => _$ModelActionNewOfferShowThreadToJson(this);

}

@JsonSerializable()
class NewOfferShowThreadSuperBase {

  String? id;
  Meta? meta;
  List<Button?>? buttons;
  ModelActionNewOfferShowThread? model;
  NewOfferShowThreadSuperBase(
	  this.id,
	  this.buttons,
	  this.meta,
	  this.model,
  ...
  factory NewOfferShowThreadSuperBase.fromJson(Map<String, dynamic> json) => _$NewOfferShowThreadSuperBaseFromJson(json);

  Map<String, dynamic> toJson() => _$NewOfferShowThreadSuperBaseToJson(this);
  
 
}

class NewOfferShowThreadBase{
	var model;
	Map<String, dynamic> json;
            var attachmentslast ;   
	NewOfferShowThreadBase(this.json){
		model = NewOfferShowThreadSuperBase.fromJson(this.json);
 ...
 var postShowThreadResult, State state, String? sendPath, String? id,  String? title){
  ...
  var postNewOfferResult, State state, String? sendPath, String? id,  String? title){
	...
	for(var i = 0; i < model.buttons.length; i++)
    {
      ...
      buttonChildren.add(RButtonActionShowThreadWidget(model.buttons[i], context,formKey, controller,show_thread, postNewOfferResult, state, sendPath, id,  title));
      }
    }
       return(
	        buttonChildren 
  ...
  var postNewOfferResult, State state, String? sendPath, String? id,  String? title){
	...
	for(var i = 0; i < model.buttons.length; i++)
    {
      buttonChildren.add(ButtonActionShowThreadWidget(model.buttons[i], context,formKey, controller,show_thread, postNewOfferResult, state, sendPath, id,  title ));
    }
       return(
	        buttonChildren 
	   );
    ...
    return(
        ButtonBarTheme(
            ...
            child: ButtonBar(
                ...
                buttonMinWidth: 0.9 * width,
                children:
           RlistButton(context, formKey,controller,show_thread, postNewOfferResult, state, sendPath, id,  title )
  ...
  var postNewOfferResult, State state, String? sendPath, String? id,  String? title ){
	 ...
	 SpeedDial(
				...
				elevation: 8.0,
				shape: CircleBorder(),
				children:listButton(context, formKey,controller,show_thread, postNewOfferResult, state, sendPath, id,  title )
	    )
	 );
   } 
