...
part of 'show_bids_accept_bid_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ModelActionAcceptBidShowBids _$ModelActionAcceptBidShowBidsFromJson(
...
Map<String, dynamic> _$ModelActionAcceptBidShowBidsToJson(
        ModelActionAcceptBidShowBids instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
AcceptBidShowBidsSuperBase _$AcceptBidShowBidsSuperBaseFromJson(
        Map<String, dynamic> json) =>
    AcceptBidShowBidsSuperBase(
      ...
      json['model'] == null
          ? null
          : ModelActionAcceptBidShowBids.fromJson(
              json['model'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$AcceptBidShowBidsSuperBaseToJson(
        AcceptBidShowBidsSuperBase instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
