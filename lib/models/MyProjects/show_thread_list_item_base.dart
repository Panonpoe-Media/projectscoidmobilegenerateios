...
import '../photo.dart';
import '../paging.dart';
part 'show_thread_list_item_base.g.dart';

class ItemShowThreadBase {
	var item;
	Map<String, dynamic> json;
	ItemShowThreadBase(this.json){
		item = ItemShowThread.fromJson(json);
	}	
...
class ItemShowThread{
  ...
  factory ItemShowThread.fromJson(Map<String, dynamic> json) => _$ItemShowThreadFromJson(json);

  Map<String, dynamic> toJson() => _$ItemShowThreadToJson(this);
