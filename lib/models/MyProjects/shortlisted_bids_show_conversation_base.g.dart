...
part of 'shortlisted_bids_show_conversation_base.dart';
...
ModelActionShowConversationShortlistedBids
    _$ModelActionShowConversationShortlistedBidsFromJson(
...
Map<String, dynamic> _$ModelActionShowConversationShortlistedBidsToJson(
        ModelActionShowConversationShortlistedBids instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
ShowConversationShortlistedBidsSuperBase
    _$ShowConversationShortlistedBidsSuperBaseFromJson(
            Map<String, dynamic> json) =>
        ShowConversationShortlistedBidsSuperBase(
          json['id'] as String?,
          ...
          json['model'] == null
              ? null
              : ModelActionShowConversationShortlistedBids.fromJson(
                  json['model'] as Map<String, dynamic>),
        );

Map<String, dynamic> _$ShowConversationShortlistedBidsSuperBaseToJson(
        ShowConversationShortlistedBidsSuperBase instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
