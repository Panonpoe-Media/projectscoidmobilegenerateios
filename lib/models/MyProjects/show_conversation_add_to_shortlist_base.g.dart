...
part of 'show_conversation_add_to_shortlist_base.dart';
...
ModelActionAddToShortlistShowConversation
    _$ModelActionAddToShortlistShowConversationFromJson(
...
Map<String, dynamic> _$ModelActionAddToShortlistShowConversationToJson(
        ModelActionAddToShortlistShowConversation instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
AddToShortlistShowConversationSuperBase
    _$AddToShortlistShowConversationSuperBaseFromJson(
            Map<String, dynamic> json) =>
        AddToShortlistShowConversationSuperBase(
          json['id'] as String?,
          ...
          json['model'] == null
              ? null
              : ModelActionAddToShortlistShowConversation.fromJson(
                  json['model'] as Map<String, dynamic>),
        );

Map<String, dynamic> _$AddToShortlistShowConversationSuperBaseToJson(
        AddToShortlistShowConversationSuperBase instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
