...
part of 'show_bids_view_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ViewModelShowBids _$ViewModelShowBidsFromJson(Map<String, dynamic> json) =>
    ViewModelShowBids(
      json['id'] as String?,
...
Map<String, dynamic> _$ViewModelShowBidsToJson(ViewModelShowBids instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
ShowBidsViewSuperBase _$ShowBidsViewSuperBaseFromJson(
    ...
    ShowBidsViewSuperBase(
      ...
      json['model'] == null
          ? null
          : ViewModelShowBids.fromJson(json['model'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$ShowBidsViewSuperBaseToJson(
        ShowBidsViewSuperBase instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
