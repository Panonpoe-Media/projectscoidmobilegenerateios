...
part of 'shortlisted_bids_remove_from_shortlist_base.dart';
...
ModelActionRemoveFromShortlistShortlistedBids
    _$ModelActionRemoveFromShortlistShortlistedBidsFromJson(
...
Map<String, dynamic> _$ModelActionRemoveFromShortlistShortlistedBidsToJson(
        ModelActionRemoveFromShortlistShortlistedBids instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
RemoveFromShortlistShortlistedBidsSuperBase
    _$RemoveFromShortlistShortlistedBidsSuperBaseFromJson(
            Map<String, dynamic> json) =>
        RemoveFromShortlistShortlistedBidsSuperBase(
          json['id'] as String?,
          ...
          json['model'] == null
              ? null
              : ModelActionRemoveFromShortlistShortlistedBids.fromJson(
                  json['model'] as Map<String, dynamic>),
        );

Map<String, dynamic> _$RemoveFromShortlistShortlistedBidsSuperBaseToJson(
        RemoveFromShortlistShortlistedBidsSuperBase instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
