...
import '../photo.dart';
import '../paging.dart';
part 'show_files_list_item_base.g.dart';

class ItemShowFilesBase {
	var item;
	Map<String, dynamic> json;
	ItemShowFilesBase(this.json){
		item = ItemShowFiles.fromJson(json);
	}	
...
class ItemShowFiles{
  ...
  factory ItemShowFiles.fromJson(Map<String, dynamic> json) => _$ItemShowFilesFromJson(json);

  Map<String, dynamic> toJson() => _$ItemShowFilesToJson(this);
