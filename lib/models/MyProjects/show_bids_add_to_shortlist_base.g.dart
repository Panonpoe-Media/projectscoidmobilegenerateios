...
part of 'show_bids_add_to_shortlist_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ModelActionAddToShortlistShowBids _$ModelActionAddToShortlistShowBidsFromJson(
...
Map<String, dynamic> _$ModelActionAddToShortlistShowBidsToJson(
        ModelActionAddToShortlistShowBids instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
AddToShortlistShowBidsSuperBase _$AddToShortlistShowBidsSuperBaseFromJson(
        Map<String, dynamic> json) =>
    AddToShortlistShowBidsSuperBase(
      ...
      json['model'] == null
          ? null
          : ModelActionAddToShortlistShowBids.fromJson(
              json['model'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$AddToShortlistShowBidsSuperBaseToJson(
        AddToShortlistShowBidsSuperBase instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
