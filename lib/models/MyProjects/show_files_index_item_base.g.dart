...
part of 'show_files_index_item_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ItemIndexShowFiles _$ItemIndexShowFilesFromJson(Map<String, dynamic> json) =>
    ItemIndexShowFiles(
...
Map<String, dynamic> _$ItemIndexShowFilesToJson(ItemIndexShowFiles instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
