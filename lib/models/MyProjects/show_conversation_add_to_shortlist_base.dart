...
part 'show_conversation_add_to_shortlist_base.g.dart';



@JsonSerializable()

class ModelActionAddToShortlistShowConversation {
  int?    age;
  int?    cnt;
  int?    page;
  String? id;
...
String? post_id;
  ...
  bool?  read_by_worker;
	  ...
	  ModelActionAddToShortlistShowConversation(
            this.id,
			this.post_id,
			this.user_id,
			this.user_str,
    ...
    factory ModelActionAddToShortlistShowConversation.fromJson(Map<String, dynamic> json) => _$ModelActionAddToShortlistShowConversationFromJson(json);

  Map<String, dynamic> toJson() => _$ModelActionAddToShortlistShowConversationToJson(this);

}

@JsonSerializable()
class AddToShortlistShowConversationSuperBase {

  String? id;
  Meta? meta;
  List<Button?>? buttons;
  ModelActionAddToShortlistShowConversation? model;
  AddToShortlistShowConversationSuperBase(
	  this.id,
	  this.buttons,
	  this.meta,
	  this.model,
  ...
  factory AddToShortlistShowConversationSuperBase.fromJson(Map<String, dynamic> json) => _$AddToShortlistShowConversationSuperBaseFromJson(json);

  Map<String, dynamic> toJson() => _$AddToShortlistShowConversationSuperBaseToJson(this);
  
 
}

class AddToShortlistShowConversationBase{
	var model;
	Map<String, dynamic> json;
            var attachmentslast ;   
	AddToShortlistShowConversationBase(this.json){
		model = AddToShortlistShowConversationSuperBase.fromJson(this.json);
 ...
 var postShowConversationResult, State state, String? sendPath, String? id,  String? title){
  ...
  var postAddToShortlistResult, State state, String? sendPath, String? id,  String? title){
	...
	for(var i = 0; i < model.buttons.length; i++)
    {
      ...
      buttonChildren.add(RButtonActionShowConversationWidget(model.buttons[i], context,formKey, controller,show_conversation, postAddToShortlistResult, state, sendPath, id,  title));
      }
    }
       return(
	        buttonChildren 
  ...
  var postAddToShortlistResult, State state, String? sendPath, String? id,  String? title){
	...
	for(var i = 0; i < model.buttons.length; i++)
    {
      buttonChildren.add(ButtonActionShowConversationWidget(model.buttons[i], context,formKey, controller,show_conversation, postAddToShortlistResult, state, sendPath, id,  title ));
    }
       return(
	        buttonChildren 
	   );
    ...
    return(
        ButtonBarTheme(
            ...
            child: ButtonBar(
                ...
                buttonMinWidth: 0.9 * width,
                children:
           RlistButton(context, formKey,controller,show_conversation, postAddToShortlistResult, state, sendPath, id,  title )
  ...
  var postAddToShortlistResult, State state, String? sendPath, String? id,  String? title ){
	 ...
	 SpeedDial(
				...
				elevation: 8.0,
				shape: CircleBorder(),
				children:listButton(context, formKey,controller,show_conversation, postAddToShortlistResult, state, sendPath, id,  title )
	    )
	 );
   } 
