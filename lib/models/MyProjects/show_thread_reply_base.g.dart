...
part of 'show_thread_reply_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ModelActionReplyShowThread _$ModelActionReplyShowThreadFromJson(
...
Map<String, dynamic> _$ModelActionReplyShowThreadToJson(
        ModelActionReplyShowThread instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
ReplyShowThreadSuperBase _$ReplyShowThreadSuperBaseFromJson(
        Map<String, dynamic> json) =>
    ReplyShowThreadSuperBase(
      ...
      json['model'] == null
          ? null
          : ModelActionReplyShowThread.fromJson(
              json['model'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$ReplyShowThreadSuperBaseToJson(
        ReplyShowThreadSuperBase instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
