...
part of 'show_thread_new_offer_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ModelActionNewOfferShowThread _$ModelActionNewOfferShowThreadFromJson(
...
Map<String, dynamic> _$ModelActionNewOfferShowThreadToJson(
        ModelActionNewOfferShowThread instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
NewOfferShowThreadSuperBase _$NewOfferShowThreadSuperBaseFromJson(
        Map<String, dynamic> json) =>
    NewOfferShowThreadSuperBase(
      ...
      json['model'] == null
          ? null
          : ModelActionNewOfferShowThread.fromJson(
              json['model'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$NewOfferShowThreadSuperBaseToJson(
        NewOfferShowThreadSuperBase instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
