...
part of 'show_thread_edit_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

EditModelShowThread _$EditModelShowThreadFromJson(Map<String, dynamic> json) =>
    EditModelShowThread(
      json['id'] as String?,
...
Map<String, dynamic> _$EditModelShowThreadToJson(
        EditModelShowThread instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
ShowThreadSuperBase _$ShowThreadSuperBaseFromJson(Map<String, dynamic> json) =>
    ShowThreadSuperBase(
      json['id'] as String?,
      ...
      json['model'] == null
          ? null
          : EditModelShowThread.fromJson(json['model'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$ShowThreadSuperBaseToJson(
        ShowThreadSuperBase instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
