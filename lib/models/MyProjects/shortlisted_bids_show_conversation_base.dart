...
part 'shortlisted_bids_show_conversation_base.g.dart';



@JsonSerializable()

class ModelActionShowConversationShortlistedBids {
  int?    age;
  int?    cnt;
  int?    page;
  String? id;
...
String? bid_id;
  ...
  String? published_budget;
   ...
   String? budget_range_str;
	  ...
	  ModelActionShowConversationShortlistedBids(
            this.id,
			this.bid_id,
			this.worker_id,
			this.worker_str,
    ...
    factory ModelActionShowConversationShortlistedBids.fromJson(Map<String, dynamic> json) => _$ModelActionShowConversationShortlistedBidsFromJson(json);

  Map<String, dynamic> toJson() => _$ModelActionShowConversationShortlistedBidsToJson(this);

}

@JsonSerializable()
class ShowConversationShortlistedBidsSuperBase {

  String? id;
  Meta? meta;
  List<Button?>? buttons;
  ModelActionShowConversationShortlistedBids? model;
  ShowConversationShortlistedBidsSuperBase(
	  this.id,
	  this.buttons,
	  this.meta,
	  this.model,
  ...
  factory ShowConversationShortlistedBidsSuperBase.fromJson(Map<String, dynamic> json) => _$ShowConversationShortlistedBidsSuperBaseFromJson(json);

  Map<String, dynamic> toJson() => _$ShowConversationShortlistedBidsSuperBaseToJson(this);
  
 
}

class ShowConversationShortlistedBidsBase{
	var model;
	Map<String, dynamic> json;
            var attachmentslast ;   
	ShowConversationShortlistedBidsBase(this.json){
		model = ShowConversationShortlistedBidsSuperBase.fromJson(this.json);
...
SpeedDialChild ButtonActionShortlistedBidsWidget(Button button, BuildContext context,var formKey, ScrollController controller, SubModelController shortlisted_bids,
 var postShortlistedBidsResult, State state, String? sendPath, String? id,  String? title){
  ...
  String? action =   'ShowConversation';
  ...
  var postShowConversationResult, State state, String? sendPath, String? id,  String? title){
	...
	for(var i = 0; i < model.buttons.length; i++)
    {
      ...
      buttonChildren.add(RButtonActionShortlistedBidsWidget(model.buttons[i], context,formKey, controller,shortlisted_bids, postShowConversationResult, state, sendPath, id,  title));
      }
    }
       return(
	        buttonChildren 
  ...
  var postShowConversationResult, State state, String? sendPath, String? id,  String? title){
	...
	for(var i = 0; i < model.buttons.length; i++)
    {
      buttonChildren.add(ButtonActionShortlistedBidsWidget(model.buttons[i], context,formKey, controller,shortlisted_bids, postShowConversationResult, state, sendPath, id,  title ));
    }
       return(
	        buttonChildren 
	   );
    ...
    return(
        ButtonBarTheme(
            ...
            child: ButtonBar(
                ...
                buttonMinWidth: 0.9 * width,
                children:
           RlistButton(context, formKey,controller,shortlisted_bids, postShowConversationResult, state, sendPath, id,  title )
  ...
  var postShowConversationResult, State state, String? sendPath, String? id,  String? title ){
	 ...
	 SpeedDial(
				...
				elevation: 8.0,
				shape: CircleBorder(),
				children:listButton(context, formKey,controller,shortlisted_bids, postShowConversationResult, state, sendPath, id,  title )
	    )
	 );
   } 
