...
part of 'shortlisted_bids_view_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ViewModelShortlistedBids _$ViewModelShortlistedBidsFromJson(
...
Map<String, dynamic> _$ViewModelShortlistedBidsToJson(
        ViewModelShortlistedBids instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
ShortlistedBidsViewSuperBase _$ShortlistedBidsViewSuperBaseFromJson(
        Map<String, dynamic> json) =>
    ShortlistedBidsViewSuperBase(
      ...
      json['model'] == null
          ? null
          : ViewModelShortlistedBids.fromJson(
              json['model'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$ShortlistedBidsViewSuperBaseToJson(
        ShortlistedBidsViewSuperBase instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
