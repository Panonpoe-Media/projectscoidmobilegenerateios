...
part 'show_thread_file_arbitration_base.g.dart';



@JsonSerializable()

class ModelActionFileArbitrationShowThread {
  int?    age;
  int?    cnt;
  int?    page;
  String? id;
...
String? post_id;
  ...
  bool?  read_by_worker;
	  ...
	  ModelActionFileArbitrationShowThread(
            this.id,
			this.post_id,
			this.user_id,
			this.user_str,
    ...
    factory ModelActionFileArbitrationShowThread.fromJson(Map<String, dynamic> json) => _$ModelActionFileArbitrationShowThreadFromJson(json);

  Map<String, dynamic> toJson() => _$ModelActionFileArbitrationShowThreadToJson(this);

}

@JsonSerializable()
class FileArbitrationShowThreadSuperBase {

  String? id;
  Meta? meta;
  List<Button?>? buttons;
  ModelActionFileArbitrationShowThread? model;
  FileArbitrationShowThreadSuperBase(
	  this.id,
	  this.buttons,
	  this.meta,
	  this.model,
  ...
  factory FileArbitrationShowThreadSuperBase.fromJson(Map<String, dynamic> json) => _$FileArbitrationShowThreadSuperBaseFromJson(json);

  Map<String, dynamic> toJson() => _$FileArbitrationShowThreadSuperBaseToJson(this);
  
 
}

class FileArbitrationShowThreadBase{
	var model;
	Map<String, dynamic> json;
            var attachmentslast ;   
	FileArbitrationShowThreadBase(this.json){
		model = FileArbitrationShowThreadSuperBase.fromJson(this.json);
 ...
 var postShowThreadResult, State state, String? sendPath, String? id,  String? title){
  ...
  var postFileArbitrationResult, State state, String? sendPath, String? id,  String? title){
	...
	for(var i = 0; i < model.buttons.length; i++)
    {
      ...
      buttonChildren.add(RButtonActionShowThreadWidget(model.buttons[i], context,formKey, controller,show_thread, postFileArbitrationResult, state, sendPath, id,  title));
      }
    }
       return(
	        buttonChildren 
  ...
  var postFileArbitrationResult, State state, String? sendPath, String? id,  String? title){
	...
	for(var i = 0; i < model.buttons.length; i++)
    {
      buttonChildren.add(ButtonActionShowThreadWidget(model.buttons[i], context,formKey, controller,show_thread, postFileArbitrationResult, state, sendPath, id,  title ));
    }
       return(
	        buttonChildren 
	   );
    ...
    return(
        ButtonBarTheme(
            ...
            child: ButtonBar(
                ...
                buttonMinWidth: 0.9 * width,
                children:
           RlistButton(context, formKey,controller,show_thread, postFileArbitrationResult, state, sendPath, id,  title )
  ...
  var postFileArbitrationResult, State state, String? sendPath, String? id,  String? title ){
	 ...
	 SpeedDial(
				...
				elevation: 8.0,
				shape: CircleBorder(),
				children:listButton(context, formKey,controller,show_thread, postFileArbitrationResult, state, sendPath, id,  title )
	    )
	 );
   } 
