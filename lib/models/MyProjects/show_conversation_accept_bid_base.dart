...
part 'show_conversation_accept_bid_base.g.dart';



@JsonSerializable()

class ModelActionAcceptBidShowConversation {
  int?    age;
  int?    cnt;
  int?    page;
  String? id;
...
String? post_id;
  ...
  bool?  read_by_worker;
    ...
    factory ModelActionAcceptBidShowConversation.fromJson(Map<String, dynamic> json) => _$ModelActionAcceptBidShowConversationFromJson(json);

  Map<String, dynamic> toJson() => _$ModelActionAcceptBidShowConversationToJson(this);

}

@JsonSerializable()
class AcceptBidShowConversationSuperBase {

  String? id;
  Meta? meta;
  List<Button?>? buttons;
  ModelActionAcceptBidShowConversation? model;
  ...
  factory AcceptBidShowConversationSuperBase.fromJson(Map<String, dynamic> json) => _$AcceptBidShowConversationSuperBaseFromJson(json);

  Map<String, dynamic> toJson() => _$AcceptBidShowConversationSuperBaseToJson(this);
  
 
}

class AcceptBidShowConversationBase{
	var model;
	Map<String, dynamic> json;
            var attachmentslast ;   
	AcceptBidShowConversationBase(this.json){
		model = AcceptBidShowConversationSuperBase.fromJson(this.json);
 ...
 var postShowConversationResult, State state, String? sendPath, String? id,  String? title){
  ...
  var postAcceptBidResult, State state, String? sendPath, String? id,  String? title){
	...
	for(var i = 0; i < model.buttons.length; i++)
    {
      ...
      buttonChildren.add(RButtonActionShowConversationWidget(model.buttons[i], context,formKey, controller,show_conversation, postAcceptBidResult, state, sendPath, id,  title));
      }
    }
       return(
	        buttonChildren 
  ...
  var postAcceptBidResult, State state, String? sendPath, String? id,  String? title){
	...
	for(var i = 0; i < model.buttons.length; i++)
    {
      buttonChildren.add(ButtonActionShowConversationWidget(model.buttons[i], context,formKey, controller,show_conversation, postAcceptBidResult, state, sendPath, id,  title ));
    }
       return(
	        buttonChildren 
	   );
    ...
    return(
        ButtonBarTheme(
            ...
            child: ButtonBar(
                ...
                buttonMinWidth: 0.9 * width,
                children:
           RlistButton(context, formKey,controller,show_conversation, postAcceptBidResult, state, sendPath, id,  title )
  ...
  var postAcceptBidResult, State state, String? sendPath, String? id,  String? title ){
	 ...
	 SpeedDial(
				...
				elevation: 8.0,
				shape: CircleBorder(),
				children:listButton(context, formKey,controller,show_conversation, postAcceptBidResult, state, sendPath, id,  title )
	    )
	 );
   } 
