...
part of 'show_thread_file_arbitration_base.dart';
...
ModelActionFileArbitrationShowThread
    _$ModelActionFileArbitrationShowThreadFromJson(Map<String, dynamic> json) =>
        ModelActionFileArbitrationShowThread(
          json['id'] as String?,
...
Map<String, dynamic> _$ModelActionFileArbitrationShowThreadToJson(
        ModelActionFileArbitrationShowThread instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
FileArbitrationShowThreadSuperBase _$FileArbitrationShowThreadSuperBaseFromJson(
    ...
    FileArbitrationShowThreadSuperBase(
      ...
      json['model'] == null
          ? null
          : ModelActionFileArbitrationShowThread.fromJson(
              json['model'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$FileArbitrationShowThreadSuperBaseToJson(
        FileArbitrationShowThreadSuperBase instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
