...
part 'show_bids_accept_bid_base.g.dart';



@JsonSerializable()

class ModelActionAcceptBidShowBids {
  int?    age;
  int?    cnt;
  int?    page;
  String? id;
...
String? bid_id;
    ...
    factory ModelActionAcceptBidShowBids.fromJson(Map<String, dynamic> json) => _$ModelActionAcceptBidShowBidsFromJson(json);

  Map<String, dynamic> toJson() => _$ModelActionAcceptBidShowBidsToJson(this);

}

@JsonSerializable()
class AcceptBidShowBidsSuperBase {

  String? id;
  Meta? meta;
  List<Button?>? buttons;
  ModelActionAcceptBidShowBids? model;
  AcceptBidShowBidsSuperBase(
	  this.id,
	  this.buttons,
	  this.meta,
	  this.model,
  ...
  factory AcceptBidShowBidsSuperBase.fromJson(Map<String, dynamic> json) => _$AcceptBidShowBidsSuperBaseFromJson(json);

  Map<String, dynamic> toJson() => _$AcceptBidShowBidsSuperBaseToJson(this);
  
 
}

class AcceptBidShowBidsBase{
	var model;
	Map<String, dynamic> json;
            var attachmentslast ;   
	AcceptBidShowBidsBase(this.json){
		model = AcceptBidShowBidsSuperBase.fromJson(this.json);
 ...
 var postShowBidsResult, State state, String? sendPath, String? id,  String? title){
  ...
  var postAcceptBidResult, State state, String? sendPath, String? id,  String? title){
	...
	for(var i = 0; i < model.buttons.length; i++)
    {
      ...
      buttonChildren.add(RButtonActionShowBidsWidget(model.buttons[i], context,formKey, controller,show_bids, postAcceptBidResult, state, sendPath, id,  title));
      }
    }
       return(
	        buttonChildren 
  ...
  var postAcceptBidResult, State state, String? sendPath, String? id,  String? title){
	...
	for(var i = 0; i < model.buttons.length; i++)
    {
      buttonChildren.add(ButtonActionShowBidsWidget(model.buttons[i], context,formKey, controller,show_bids, postAcceptBidResult, state, sendPath, id,  title ));
    }
       return(
	        buttonChildren 
	   );
    ...
    return(
        ButtonBarTheme(
            ...
            child: ButtonBar(
                ...
                buttonMinWidth: 0.9 * width,
                children:
           RlistButton(context, formKey,controller,show_bids, postAcceptBidResult, state, sendPath, id,  title )
  ...
  var postAcceptBidResult, State state, String? sendPath, String? id,  String? title ){
	 ...
	 SpeedDial(
				...
				elevation: 8.0,
				shape: CircleBorder(),
				children:listButton(context, formKey,controller,show_bids, postAcceptBidResult, state, sendPath, id,  title )
	    )
	 );
   } 
