...
part 'show_bids_add_base.g.dart';
...
class AddModelShowBids {
  ...
  String? published_budget;
    ...
    factory AddModelShowBids.fromJson(Map<String, dynamic> json) => _$AddModelShowBidsFromJson(json);

  Map<String, dynamic> toJson() => _$AddModelShowBidsToJson(this);
...
class ShowBidsAddBase{
	var model;
	Map<String, dynamic> json;
	ShowBidsAddBase(this.json){
  ...
  "project_bids[project_id]": "${model.model.project_id }",
   ...
   "project_bids[mark_id]": "${model.model.mark_id}",
