...
part of 'show_conversation_reply_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ModelActionReplyShowConversation _$ModelActionReplyShowConversationFromJson(
...
Map<String, dynamic> _$ModelActionReplyShowConversationToJson(
        ModelActionReplyShowConversation instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
ReplyShowConversationSuperBase _$ReplyShowConversationSuperBaseFromJson(
        Map<String, dynamic> json) =>
    ReplyShowConversationSuperBase(
      ...
      json['model'] == null
          ? null
          : ModelActionReplyShowConversation.fromJson(
              json['model'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$ReplyShowConversationSuperBaseToJson(
        ReplyShowConversationSuperBase instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
