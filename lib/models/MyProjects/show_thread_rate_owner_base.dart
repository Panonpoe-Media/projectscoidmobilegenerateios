...
part 'show_thread_rate_owner_base.g.dart';



@JsonSerializable()

class ModelActionRateOwnerShowThread {
  int?    age;
  int?    cnt;
  int?    page;
  String? id;
...
String? post_id;
  ...
  bool?  read_by_worker;
	  ...
	  ModelActionRateOwnerShowThread(
            this.id,
			this.post_id,
			this.user_id,
			this.user_str,
    ...
    factory ModelActionRateOwnerShowThread.fromJson(Map<String, dynamic> json) => _$ModelActionRateOwnerShowThreadFromJson(json);

  Map<String, dynamic> toJson() => _$ModelActionRateOwnerShowThreadToJson(this);

}

@JsonSerializable()
class RateOwnerShowThreadSuperBase {

  String? id;
  Meta? meta;
  List<Button?>? buttons;
  ModelActionRateOwnerShowThread? model;
  RateOwnerShowThreadSuperBase(
	  this.id,
	  this.buttons,
	  this.meta,
	  this.model,
  ...
  factory RateOwnerShowThreadSuperBase.fromJson(Map<String, dynamic> json) => _$RateOwnerShowThreadSuperBaseFromJson(json);

  Map<String, dynamic> toJson() => _$RateOwnerShowThreadSuperBaseToJson(this);
  
 
}

class RateOwnerShowThreadBase{
	var model;
	Map<String, dynamic> json;
            var attachmentslast ;   
	RateOwnerShowThreadBase(this.json){
		model = RateOwnerShowThreadSuperBase.fromJson(this.json);
 ...
 var postShowThreadResult, State state, String? sendPath, String? id,  String? title){
  ...
  var postRateOwnerResult, State state, String? sendPath, String? id,  String? title){
	...
	for(var i = 0; i < model.buttons.length; i++)
    {
      ...
      buttonChildren.add(RButtonActionShowThreadWidget(model.buttons[i], context,formKey, controller,show_thread, postRateOwnerResult, state, sendPath, id,  title));
      }
    }
       return(
	        buttonChildren 
  ...
  var postRateOwnerResult, State state, String? sendPath, String? id,  String? title){
	...
	for(var i = 0; i < model.buttons.length; i++)
    {
      buttonChildren.add(ButtonActionShowThreadWidget(model.buttons[i], context,formKey, controller,show_thread, postRateOwnerResult, state, sendPath, id,  title ));
    }
       return(
	        buttonChildren 
	   );
    ...
    return(
        ButtonBarTheme(
            ...
            child: ButtonBar(
                ...
                buttonMinWidth: 0.9 * width,
                children:
           RlistButton(context, formKey,controller,show_thread, postRateOwnerResult, state, sendPath, id,  title )
  ...
  var postRateOwnerResult, State state, String? sendPath, String? id,  String? title ){
	 ...
	 SpeedDial(
				...
				elevation: 8.0,
				shape: CircleBorder(),
				children:listButton(context, formKey,controller,show_thread, postRateOwnerResult, state, sendPath, id,  title )
	    )
	 );
   } 
