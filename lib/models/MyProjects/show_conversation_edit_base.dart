...
class EditShowConversationBase{
   ...
   Map<String, dynamic> convertFormDataEdit(var data){
      var formData = {
      "bid_conversation[_trigger_]":"",
  "bid_conversation[user_id]": "${model.model.user_id }",
  "bid_conversation[project_id]": "${model.model.project_id }",
  "bid_conversation[thread_id]": "${model.model.thread_id }",
   "bid_conversation[post_type_id]": "${model.model.post_type_id}",
  "bid_conversation[post_date]": "${model.model.post_date}",
  "bid_conversation[bid_amount]": "${model.model.bid_amount}",
  "bid_conversation[message]": "${model.model.message }",
  "bid_conversation[attachments]": '[{"name":"${model.model.attachments[0].name}","size":${model.model.attachments[0].size.toString()},"created":${model.model.attachments[0].date.toString()},"modified":${model.model.attachments[0].date.toString()},"temp":"${model.model.attachments[0].temp}","remote":"","dir":"temp"}]',
  "bid_conversation[read_by_owner]": "${model.model.read_by_owner}",
  "bid_conversation[read_by_worker]": "${model.model.read_by_worker}",
