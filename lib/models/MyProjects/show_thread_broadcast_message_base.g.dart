...
part of 'show_thread_broadcast_message_base.dart';
...
ModelActionBroadcastMessageShowThread
    _$ModelActionBroadcastMessageShowThreadFromJson(
...
Map<String, dynamic> _$ModelActionBroadcastMessageShowThreadToJson(
        ModelActionBroadcastMessageShowThread instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
BroadcastMessageShowThreadSuperBase
    _$BroadcastMessageShowThreadSuperBaseFromJson(Map<String, dynamic> json) =>
        BroadcastMessageShowThreadSuperBase(
          json['id'] as String?,
          ...
          json['model'] == null
              ? null
              : ModelActionBroadcastMessageShowThread.fromJson(
                  json['model'] as Map<String, dynamic>),
        );

Map<String, dynamic> _$BroadcastMessageShowThreadSuperBaseToJson(
        BroadcastMessageShowThreadSuperBase instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
