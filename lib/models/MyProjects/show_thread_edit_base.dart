...
part 'show_thread_edit_base.g.dart';
...
class EditModelShowThread {
  ...
  bool? read_by_worker;
    ...
    factory EditModelShowThread.fromJson(Map<String, dynamic> json) => _$EditModelShowThreadFromJson(json);

  Map<String, dynamic> toJson() => _$EditModelShowThreadToJson(this);
...
class EditShowThreadBase{
	var model;
	Map<String, dynamic> json;
	EditShowThreadBase(this.json){
  ...
  var formData = convertFormDataEdit(model);  
	...
	for(var i = 0; i < model.buttons.length; i++)
    {
      ...
      buttonChildren.add(RButtonActionShowThreadWidget(model.buttons[i], context,formKey, controller,show_thread, postShowThreadResult, state, sendPath, id,  title, formData));
      }
    }
       return(
	        buttonChildren 
    ...
    return(
        ButtonBarTheme(
            ...
            child: ButtonBar(
                ...
                buttonMinWidth: 0.9 * width,
                children:
           RlistButton(context, formKey,controller,show_thread, postShowThreadResult, state, sendPath, id,  title )
