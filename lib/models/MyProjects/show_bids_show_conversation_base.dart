...
part 'show_bids_show_conversation_base.g.dart';



@JsonSerializable()

class ModelActionShowConversationShowBids {
  int?    age;
  int?    cnt;
  int?    page;
  String? id;
...
String? bid_id;
  ...
  String? published_budget;
   ...
   String? budget_range_str;
	  ...
	  ModelActionShowConversationShowBids(
            this.id,
			this.bid_id,
			this.worker_id,
			this.worker_str,
    ...
    factory ModelActionShowConversationShowBids.fromJson(Map<String, dynamic> json) => _$ModelActionShowConversationShowBidsFromJson(json);

  Map<String, dynamic> toJson() => _$ModelActionShowConversationShowBidsToJson(this);

}

@JsonSerializable()
class ShowConversationShowBidsSuperBase {

  String? id;
  Meta? meta;
  List<Button?>? buttons;
  ModelActionShowConversationShowBids? model;
  ShowConversationShowBidsSuperBase(
	  this.id,
	  this.buttons,
	  this.meta,
	  this.model,
  ...
  factory ShowConversationShowBidsSuperBase.fromJson(Map<String, dynamic> json) => _$ShowConversationShowBidsSuperBaseFromJson(json);

  Map<String, dynamic> toJson() => _$ShowConversationShowBidsSuperBaseToJson(this);
  
 
}

class ShowConversationShowBidsBase{
	var model;
	Map<String, dynamic> json;
            var attachmentslast ;   
	ShowConversationShowBidsBase(this.json){
		model = ShowConversationShowBidsSuperBase.fromJson(this.json);
 ...
 var postShowBidsResult, State state, String? sendPath, String? id,  String? title){
  ...
  var postShowConversationResult, State state, String? sendPath, String? id,  String? title){
	...
	for(var i = 0; i < model.buttons.length; i++)
    {
      ...
      buttonChildren.add(RButtonActionShowBidsWidget(model.buttons[i], context,formKey, controller,show_bids, postShowConversationResult, state, sendPath, id,  title));
      }
    }
       return(
	        buttonChildren 
  ...
  var postShowConversationResult, State state, String? sendPath, String? id,  String? title){
	...
	for(var i = 0; i < model.buttons.length; i++)
    {
      buttonChildren.add(ButtonActionShowBidsWidget(model.buttons[i], context,formKey, controller,show_bids, postShowConversationResult, state, sendPath, id,  title ));
    }
       return(
	        buttonChildren 
	   );
    ...
    return(
        ButtonBarTheme(
            ...
            child: ButtonBar(
                ...
                buttonMinWidth: 0.9 * width,
                children:
           RlistButton(context, formKey,controller,show_bids, postShowConversationResult, state, sendPath, id,  title )
  ...
  var postShowConversationResult, State state, String? sendPath, String? id,  String? title ){
	 ...
	 SpeedDial(
				...
				elevation: 8.0,
				shape: CircleBorder(),
				children:listButton(context, formKey,controller,show_bids, postShowConversationResult, state, sendPath, id,  title )
	    )
	 );
   } 
