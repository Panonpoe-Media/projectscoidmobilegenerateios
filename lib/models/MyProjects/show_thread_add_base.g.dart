...
part of 'show_thread_add_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

AddModelShowThread _$AddModelShowThreadFromJson(Map<String, dynamic> json) =>
    AddModelShowThread(
      json['id'] as String?,
      json['post_id'] as int?,
      json['user_id'] as int?,
...
Map<String, dynamic> _$AddModelShowThreadToJson(AddModelShowThread instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
ShowThreadSuperBase _$ShowThreadSuperBaseFromJson(Map<String, dynamic> json) =>
    ShowThreadSuperBase(
      ...
      json['model'] == null
          ? null
          : AddModelShowThread.fromJson(json['model'] as Map<String, dynamic>),
    );
