...
part of 'show_thread_rate_worker_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ModelActionRateWorkerShowThread _$ModelActionRateWorkerShowThreadFromJson(
...
Map<String, dynamic> _$ModelActionRateWorkerShowThreadToJson(
        ModelActionRateWorkerShowThread instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
RateWorkerShowThreadSuperBase _$RateWorkerShowThreadSuperBaseFromJson(
        Map<String, dynamic> json) =>
    RateWorkerShowThreadSuperBase(
      ...
      json['model'] == null
          ? null
          : ModelActionRateWorkerShowThread.fromJson(
              json['model'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$RateWorkerShowThreadSuperBaseToJson(
        RateWorkerShowThreadSuperBase instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
