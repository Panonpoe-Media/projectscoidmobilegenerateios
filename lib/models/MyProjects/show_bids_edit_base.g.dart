...
part of 'show_bids_edit_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

EditModelShowBids _$EditModelShowBidsFromJson(Map<String, dynamic> json) =>
    EditModelShowBids(
      json['id'] as String?,
...
Map<String, dynamic> _$EditModelShowBidsToJson(EditModelShowBids instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
ShowBidsSuperBase _$ShowBidsSuperBaseFromJson(Map<String, dynamic> json) =>
    ShowBidsSuperBase(
      json['id'] as String?,
      ...
      json['model'] == null
          ? null
          : EditModelShowBids.fromJson(json['model'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$ShowBidsSuperBaseToJson(ShowBidsSuperBase instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
