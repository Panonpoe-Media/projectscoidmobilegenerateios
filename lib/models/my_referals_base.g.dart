...
part of 'my_referals_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ModelMyReferals _$ModelMyReferalsFromJson(Map<String, dynamic> json) =>
    ModelMyReferals(
      json['id'] as String?,
...
Map<String, dynamic> _$ModelMyReferalsToJson(ModelMyReferals instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
MyReferalsSuperBase _$MyReferalsSuperBaseFromJson(Map<String, dynamic> json) =>
    MyReferalsSuperBase(
      json['id'] as String?,
      ...
      json['model'] == null
          ? null
          : ModelMyReferals.fromJson(json['model'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$MyReferalsSuperBaseToJson(
        MyReferalsSuperBase instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
...
ViewModelMyReferals _$ViewModelMyReferalsFromJson(Map<String, dynamic> json) =>
    ViewModelMyReferals(
      json['id'] as String?,
...
Map<String, dynamic> _$ViewModelMyReferalsToJson(
        ViewModelMyReferals instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
MyReferalsViewSuperBase _$MyReferalsViewSuperBaseFromJson(
    ...
    MyReferalsViewSuperBase(
      ...
      json['model'] == null
          ? null
          : ViewModelMyReferals.fromJson(json['model'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$MyReferalsViewSuperBaseToJson(
        MyReferalsViewSuperBase instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
      'buttons': instance.buttons,
...
MyReferalsListingTools _$MyReferalsListingToolsFromJson(
        Map<String, dynamic> json) =>
    MyReferalsListingTools(
      ...
      (json['items'] as List<dynamic>?)
          ?.map((e) => e == null
              ? null
              : ItemMyReferals.fromJson(e as Map<String, dynamic>))
          .toList(),
    );

Map<String, dynamic> _$MyReferalsListingToolsToJson(
        MyReferalsListingTools instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
      'buttons': instance.buttons,
