...
part of 'service_reviews_add_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

AddModelServiceReviews _$AddModelServiceReviewsFromJson(
...
Map<String, dynamic> _$AddModelServiceReviewsToJson(
        AddModelServiceReviews instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
ServiceReviewsSuperBase _$ServiceReviewsSuperBaseFromJson(
    ...
    ServiceReviewsSuperBase(
      ...
      json['model'] == null
          ? null
          : AddModelServiceReviews.fromJson(
