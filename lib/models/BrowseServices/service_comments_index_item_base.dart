...
import '../photo.dart';
import '../paging.dart';
part 'service_comments_index_item_base.g.dart';

class ItemIndexServiceCommentsBase {
	ItemIndexServiceComments? item;
	Map<String, dynamic> json;
	ItemIndexServiceCommentsBase(this.json){
		item = ItemIndexServiceComments.fromJson(json);
	}	
...
class ItemIndexServiceComments{
  ...
  factory ItemIndexServiceComments.fromJson(Map<String, dynamic> json) => _$ItemIndexServiceCommentsFromJson(json);

  Map<String, dynamic> toJson() => _$ItemIndexServiceCommentsToJson(this);
