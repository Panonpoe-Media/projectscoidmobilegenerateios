...
part of 'service_comments_list_item_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ItemServiceComments _$ItemServiceCommentsFromJson(Map<String, dynamic> json) =>
    ItemServiceComments(
...
Map<String, dynamic> _$ItemServiceCommentsToJson(
        ItemServiceComments instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
