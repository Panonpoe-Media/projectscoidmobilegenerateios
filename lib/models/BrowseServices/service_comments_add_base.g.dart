...
part of 'service_comments_add_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

AddModelServiceComments _$AddModelServiceCommentsFromJson(
...
Map<String, dynamic> _$AddModelServiceCommentsToJson(
        AddModelServiceComments instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
ServiceCommentsSuperBase _$ServiceCommentsSuperBaseFromJson(
    ...
    ServiceCommentsSuperBase(
      ...
      json['model'] == null
          ? null
          : AddModelServiceComments.fromJson(
