...
import '../photo.dart';
import '../paging.dart';
part 'service_comments_list_item_base.g.dart';

class ItemServiceCommentsBase {
	var item;
	Map<String, dynamic> json;
	ItemServiceCommentsBase(this.json){
		item = ItemServiceComments.fromJson(json);
	}	
...
class ItemServiceComments{
  ...
  factory ItemServiceComments.fromJson(Map<String, dynamic> json) => _$ItemServiceCommentsFromJson(json);

  Map<String, dynamic> toJson() => _$ItemServiceCommentsToJson(this);
