...
part 'service_reviews_add_base.g.dart';
...
class AddModelServiceReviews {
  ...
  String? admin_notes;
    ...
    factory AddModelServiceReviews.fromJson(Map<String, dynamic> json) => _$AddModelServiceReviewsFromJson(json);

  Map<String, dynamic> toJson() => _$AddModelServiceReviewsToJson(this);
...
class ServiceReviewsAddBase{
	var model;
	Map<String, dynamic> json;
	ServiceReviewsAddBase(this.json){
