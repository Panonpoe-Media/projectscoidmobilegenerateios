...
part 'service_comments_new_reply_base.g.dart';



@JsonSerializable()

class ModelActionNewReplyServiceComments {
  int?    age;
  int?    cnt;
  int?    page;
  String? id;
...
String? service_post_id;
  ...
  String? captcha;
    ...
    factory ModelActionNewReplyServiceComments.fromJson(Map<String, dynamic> json) => _$ModelActionNewReplyServiceCommentsFromJson(json);

  Map<String, dynamic> toJson() => _$ModelActionNewReplyServiceCommentsToJson(this);

}

@JsonSerializable()
class NewReplyServiceCommentsSuperBase {

  String? id;
  Meta? meta;
  List<Button?>? buttons;
  ModelActionNewReplyServiceComments? model;
  ...
  factory NewReplyServiceCommentsSuperBase.fromJson(Map<String, dynamic> json) => _$NewReplyServiceCommentsSuperBaseFromJson(json);

  Map<String, dynamic> toJson() => _$NewReplyServiceCommentsSuperBaseToJson(this);
  
 
}

class NewReplyServiceCommentsBase{
	var model;
	Map<String, dynamic> json;
	NewReplyServiceCommentsBase(this.json){
		model = NewReplyServiceCommentsSuperBase.fromJson(this.json);
	}
...
SpeedDialChild ButtonActionServiceCommentsWidget(Button button, BuildContext context,var formKey, ScrollController controller, SubModelController service_comments,
 var postServiceCommentsResult, State state, String? sendPath, String? id,  String? title){
  if(button.type == 'custom_filter'){
    return (
	       SpeedDialChild(
  ...
  var postNewReplyResult, State state, String? sendPath, String? id,  String? title){
	...
	for(var i = 0; i < model.buttons.length; i++)
    {
      ...
      buttonChildren.add(RButtonActionServiceCommentsWidget(model.buttons[i], context,formKey, controller,service_comments, postNewReplyResult, state, sendPath, id,  title));
      }
    }
       return(
	        buttonChildren 
  ...
  var postNewReplyResult, State state, String? sendPath, String? id,  String? title){
	...
	for(var i = 0; i < model.buttons.length; i++)
    {
      buttonChildren.add(ButtonActionServiceCommentsWidget(model.buttons[i], context,formKey, controller,service_comments, postNewReplyResult, state, sendPath, id,  title ));
    }
       return(
	        buttonChildren 
	   );
