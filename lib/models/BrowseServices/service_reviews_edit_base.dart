...
part 'service_reviews_edit_base.g.dart';


Widget RButtonActionServiceReviewsWidget(Button button, BuildContext context,var formKey, ScrollController controller,  SubModelController service_reviews,
 var postServiceReviewsResult, State state, String? sendPath, String? id,  String? title,  var formData){
  var cl;
  var ic;
		 ...
		 children: <Widget>[
             ...
             // color : Color(0xFF037f51),
              onPressed: () async  {
                        ...
                        service_reviews =      SubModelController(AppProvider.getApplication(context),
                        sendPath,
                        formData);
                        final future = service_reviews.sendData();
                        future.then((value) {
                        state.setState(() {
                        postServiceReviewsResult = value;
                        });
                        });
...
SpeedDialChild ButtonEditServiceReviewsWidget(Button button, BuildContext context,var formKey, ScrollController controller, SubModelController service_reviews,
 var postServiceReviewsResult, State state, String? sendPath, String? id,  String? title, var formData){
  if(button.type == 'custom_filter'){
    return (
	       SpeedDialChild(
...
class EditModelServiceReviews {
  ...
  String? admin_notes;
    ...
    factory EditModelServiceReviews.fromJson(Map<String, dynamic> json) => _$EditModelServiceReviewsFromJson(json);

  Map<String, dynamic> toJson() => _$EditModelServiceReviewsToJson(this);
...
class ServiceReviewsSuperBase {

  String? id;
  Meta? meta;
  List<Button?>? buttons;
  EditModelServiceReviews? model;
  ServiceReviewsSuperBase(
	  this.id,
	  this.buttons,
	  this.meta,
	  this.model,
  ...
  factory ServiceReviewsSuperBase.fromJson(Map<String, dynamic> json) => _$ServiceReviewsSuperBaseFromJson(json);

  Map<String, dynamic> toJson() => _$ServiceReviewsSuperBaseToJson(this);
...
class EditServiceReviewsBase{
	var model;
	Map<String, dynamic> json;
	EditServiceReviewsBase(this.json){
		model = ServiceReviewsSuperBase.fromJson(this.json);
	}
	
   Map<String, dynamic> convertFormDataEdit(var data){
      var formData = {
      "service_reviews[_trigger_]":"",
  "service_reviews[owner_id]": "${model.model.owner_id }",
  "service_reviews[category_id]": "${model.model.category_id }",
  "service_reviews[title]": "${model.model.title }",
  "service_reviews[description]": "${model.model.description }",
  "service_reviews[short_description]": "${model.model.short_description }",
  "service_reviews[attachments]": '[{"name":"${model.model.attachments[0].name}","size":${model.model.attachments[0].size.toString()},"created":${model.model.attachments[0].date.toString()},"modified":${model.model.attachments[0].date.toString()},"temp":"${model.model.attachments[0].temp}","remote":"","dir":"temp"}]',
  "service_reviews[finish_days]": "${model.model.finish_days }",
  "service_reviews[search_text]": "${model.model.search_text }",
  "service_reviews[last_bump]": "${model.model.last_bump}",
  "service_reviews[select_deadline]": "${model.model.select_deadline}",
  "service_reviews[start_date]": "${model.model.start_date}",
  "service_reviews[finish_deadline]": "${model.model.finish_deadline}",
  "service_reviews[finish_date]": "${model.model.finish_date}",
  "service_reviews[closed_date]": "${model.model.closed_date}",
  "service_reviews[bid_count]": "${model.model.bid_count }",
  "service_reviews[progress]": "${model.model.progress }",
   "service_reviews[project_status_id]": "${model.model.project_status_id}",
   "service_reviews[project_ending_id]": "${model.model.project_ending_id}",
   "service_reviews[project_type_id]": "${model.model.project_type_id}",
   "service_reviews[project_class_id]": "${model.model.project_class_id}",
  "service_reviews[published_budget]": "${model.model.published_budget}",
  "service_reviews[fee_percent]": "${model.model.fee_percent }",
  "service_reviews[service_id]": "${model.model.service_id }",
  "service_reviews[private_worker_id]": "${model.model.private_worker_id }",
  "service_reviews[invited_users]": "${model.model.invited_users }",
  "service_reviews[accepted_bid_id]": "${model.model.accepted_bid_id }",
  "service_reviews[accepted_worker_id]": "${model.model.accepted_worker_id }",
  "service_reviews[accepted_budget]": "${model.model.accepted_budget}",
  "service_reviews[accepted_work_id]": "${model.model.accepted_work_id }",
  "service_reviews[accepted_date]": "${model.model.accepted_date}",
  "service_reviews[available_budget]": "${model.model.available_budget}",
  "service_reviews[need_weekly_report]": "${model.model.need_weekly_report}",
  "service_reviews[weekly_report_needed]": "${model.model.weekly_report_needed}",
  "service_reviews[weekly_report_posted]": "${model.model.weekly_report_posted}",
  "service_reviews[deadline_passed_sent]": "${model.model.deadline_passed_sent}",
  "service_reviews[deadline_approaching_sent]": "${model.model.deadline_approaching_sent}",
  "service_reviews[rating_for_worker]": "${model.model.rating_for_worker }",
  "service_reviews[work_quality]": "${model.model.work_quality }",
  "service_reviews[expertise]": "${model.model.expertise }",
  "service_reviews[worker_communication]": "${model.model.worker_communication }",
  "service_reviews[worker_professionalism]": "${model.model.worker_professionalism }",
  "service_reviews[worker_rating]": "${model.model.worker_rating }",
  "service_reviews[worker_rating_num]": "${model.model.worker_rating_num}",
  "service_reviews[worker_feedback]": "${model.model.worker_feedback }",
  "service_reviews[rating_for_owner]": "${model.model.rating_for_owner }",
  "service_reviews[clarity]": "${model.model.clarity }",
  "service_reviews[friendliness]": "${model.model.friendliness }",
  "service_reviews[owner_communication]": "${model.model.owner_communication }",
  "service_reviews[owner_professionalism]": "${model.model.owner_professionalism }",
  "service_reviews[owner_rating]": "${model.model.owner_rating }",
  "service_reviews[owner_rating_num]": "${model.model.owner_rating_num}",
  "service_reviews[owner_feedback]": "${model.model.owner_feedback }",
  "service_reviews[owner_signature_ip]": "${model.model.owner_signature_ip }",
  "service_reviews[owner_signature_date]": "${model.model.owner_signature_date}",
  "service_reviews[worker_signature_ip]": "${model.model.worker_signature_ip }",
  "service_reviews[worker_signature_date]": "${model.model.worker_signature_date}",
  "service_reviews[owner_escrow_id]": "${model.model.owner_escrow_id }",
  "service_reviews[worker_credit_id]": "${model.model.worker_credit_id }",
  "service_reviews[arbitration_id]": "${model.model.arbitration_id }",
  "service_reviews[owner_credit_id]": "${model.model.owner_credit_id }",
  "service_reviews[registered_by_id]": "${model.model.registered_by_id }",
  "service_reviews[registered_date]": "${model.model.registered_date}",
  "service_reviews[registered_from_ip]": "${model.model.registered_from_ip }",
  "service_reviews[canceled_by_id]": "${model.model.canceled_by_id }",
  "service_reviews[canceled_date]": "${model.model.canceled_date}",
  "service_reviews[canceled_from_ip]": "${model.model.canceled_from_ip }",
  "service_reviews[published_by_id]": "${model.model.published_by_id }",
  "service_reviews[published_date]": "${model.model.published_date}",
  "service_reviews[published_from_ip]": "${model.model.published_from_ip }",
  "service_reviews[rejected_by_id]": "${model.model.rejected_by_id }",
  "service_reviews[rejected_date]": "${model.model.rejected_date}",
  "service_reviews[rejected_from_ip]": "${model.model.rejected_from_ip }",
  "service_reviews[admin_note]": "${model.model.admin_note }",
  "service_reviews[announced]": "${model.model.announced}",
  "service_reviews[your_wishes]": "${model.model.your_wishes }",
  "service_reviews[extend_deadline_days]": "${model.model.extend_deadline_days }",
  "service_reviews[testimony]": "${model.model.testimony }",
  "service_reviews[pick_user_name]": "${model.model.pick_user_name }",
  "service_reviews[enter_email_address]": "${model.model.enter_email_address }",
  "service_reviews[handphone]": "${model.model.handphone }",
  "service_reviews[broadcast_message]": "${model.model.broadcast_message }",
  "service_reviews[attach_file]": '[{"name":"${model.model.attach_file[0].name}","size":${model.model.attach_file[0].size.toString()},"created":${model.model.attach_file[0].date.toString()},"modified":${model.model.attach_file[0].date.toString()},"temp":"${model.model.attach_file[0].temp}","remote":"","dir":"temp"}]',
  "service_reviews[automatic_send_to_new_bidder]": "${model.model.automatic_send_to_new_bidder}",
  "service_reviews[is_system_message]": "${model.model.is_system_message}",
  "service_reviews[admin_notes]": "${model.model.admin_notes }",
	  
  };  
      int count = 0;
      for(var tag in model.model.channels_id){
        formData.addAll({"service_reviews[inline_tags][selection][$count]": "$tag"});
        count++;
      }
  ...
  List<Widget> RlistButton(BuildContext context,var formKey, ScrollController controller, SubModelController service_reviews,
  var postServiceReviewsResult, State state, String? sendPath, String? id,  String? title){
  var formData = convertFormDataEdit(model);  
	...
	for(var i = 0; i < model.buttons.length; i++)
    {
      ...
      buttonChildren.add(RButtonActionServiceReviewsWidget(model.buttons[i], context,formKey, controller,service_reviews, postServiceReviewsResult, state, sendPath, id,  title, formData));
      }
    }
       return(
	        buttonChildren 
  ...
  List<SpeedDialChild> listButton(BuildContext context,var formKey, ScrollController controller, SubModelController service_reviews,
  var postServiceReviewsResult, State state, String? sendPath, String? id,  String? title){
	var formData = convertFormDataEdit(model);   
	...
	for(var i = 0; i < model.buttons.length; i++)
    {
      buttonChildren.add(ButtonEditServiceReviewsWidget(model.buttons[i], context,formKey, controller,service_reviews, postServiceReviewsResult, state, sendPath, id,  title, formData ));
    }
       return(
	        buttonChildren 
	   );
       ...
       Widget	 RButtons(BuildContext context, bool? visible, var formKey, ScrollController controller, SubModelController service_reviews,
  var postServiceReviewsResult, State state, String? sendPath, String? id,  String? title ){
    //  final size =MediaQuery.of(context).size;
    double? width = 400;
    ...
    return(
        ButtonBarTheme(
            ...
            child: ButtonBar(
                ...
                buttonMinWidth: 0.9 * width,
                children:
           RlistButton(context, formKey,controller,service_reviews, postServiceReviewsResult, state, sendPath, id,  title )
    ...
    SpeedDial	 Buttons(BuildContext context, bool? visible, var formKey, ScrollController controller, SubModelController service_reviews,
  var postServiceReviewsResult, State state, String? sendPath, String? id,  String? title ){
     return(
	 SpeedDial(
				...
				elevation: 8.0,
				shape: CircleBorder(),
				children:listButton(context, formKey,controller,service_reviews, postServiceReviewsResult, state, sendPath, id,  title )
	    )
	 );
   } 	
