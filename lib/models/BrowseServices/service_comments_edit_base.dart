...
part 'service_comments_edit_base.g.dart';
...
class EditModelServiceComments {
  int?    age;
  int?    cnt;
  int?    page;
  String? id;
  ...
  String? captcha;
    ...
    factory EditModelServiceComments.fromJson(Map<String, dynamic> json) => _$EditModelServiceCommentsFromJson(json);

  Map<String, dynamic> toJson() => _$EditModelServiceCommentsToJson(this);
...
class ServiceCommentsSuperBase {
  ...
  Meta? meta;
  List<Button?>? buttons;
  EditModelServiceComments? model;
...
class EditServiceCommentsBase{
	var model;
	Map<String, dynamic> json;
	EditServiceCommentsBase(this.json){
  ...
  var formData = convertFormDataEdit(model);  
	...
	for(var i = 0; i < model.buttons.length; i++)
    {
      ...
      buttonChildren.add(RButtonActionServiceCommentsWidget(model.buttons[i], context,formKey, controller,service_comments, postServiceCommentsResult, state, sendPath, id,  title, formData));
      }
    }
       return(
	        buttonChildren 
    ...
    return(
        ButtonBarTheme(
            ...
            child: ButtonBar(
                ...
                buttonMinWidth: 0.9 * width,
                children:
           RlistButton(context, formKey,controller,service_comments, postServiceCommentsResult, state, sendPath, id,  title )
