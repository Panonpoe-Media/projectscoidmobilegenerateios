...
part of 'comments_add_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

AddModelComments _$AddModelCommentsFromJson(Map<String, dynamic> json) =>
    AddModelComments(
      json['id'] as String?,
      json['service_post_id'] as int?,
      json['user_id'] as int?,
...
Map<String, dynamic> _$AddModelCommentsToJson(AddModelComments instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
CommentsSuperBase _$CommentsSuperBaseFromJson(Map<String, dynamic> json) =>
    CommentsSuperBase(
      json['id'] as String?,
      ...
      json['model'] == null
          ? null
          : AddModelComments.fromJson(json['model'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$CommentsSuperBaseToJson(CommentsSuperBase instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
