...
class AddModelComments {
  ...
  String? captcha;
    ...
    factory AddModelComments.fromJson(Map<String, dynamic> json) => _$AddModelCommentsFromJson(json);

  Map<String, dynamic> toJson() => _$AddModelCommentsToJson(this);
...
class CommentsAddBase{
	var model;
	Map<String, dynamic> json;
	CommentsAddBase(this.json){
		model = CommentsSuperBase.fromJson(this.json);
	}
	
   Map<String, dynamic> convertFormDataEdit(var data){
      var formData = {
      "my_service_comments[_trigger_]":"",
  "my_service_comments[user_id]": "${model.model.user_id }",
  "my_service_comments[service_id]": "${model.model.service_id }",
  "my_service_comments[thread_id]": "${model.model.thread_id }",
   "my_service_comments[post_type_id]": "${model.model.post_type_id}",
  "my_service_comments[post_date]": "${model.model.post_date}",
  "my_service_comments[message]": "${model.model.message }",
  "my_service_comments[attachments]": '[{"name":"${model.model.attachments[0].name}","size":${model.model.attachments[0].size.toString()},"created":${model.model.attachments[0].date.toString()},"modified":${model.model.attachments[0].date.toString()},"temp":"${model.model.attachments[0].temp}","remote":"","dir":"temp"}]',
  "my_service_comments[read_by_seller]": "${model.model.read_by_seller}",
  "my_service_comments[read_by_buyer]": "${model.model.read_by_buyer}",
  "my_service_comments[captcha]": "${model.model.captcha }",
