...
part of 'comments_view_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ViewModelComments _$ViewModelCommentsFromJson(Map<String, dynamic> json) =>
    ViewModelComments(
      json['id'] as String?,
...
Map<String, dynamic> _$ViewModelCommentsToJson(ViewModelComments instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
CommentsViewSuperBase _$CommentsViewSuperBaseFromJson(
    ...
    CommentsViewSuperBase(
      ...
      json['model'] == null
          ? null
          : ViewModelComments.fromJson(json['model'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$CommentsViewSuperBaseToJson(
        CommentsViewSuperBase instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
