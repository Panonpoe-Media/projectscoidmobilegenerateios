...
part of 'sales_add_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

AddModelSales _$AddModelSalesFromJson(Map<String, dynamic> json) =>
    AddModelSales(
      json['id'] as String?,
...
Map<String, dynamic> _$AddModelSalesToJson(AddModelSales instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
SalesSuperBase _$SalesSuperBaseFromJson(Map<String, dynamic> json) =>
    SalesSuperBase(
      ...
      json['model'] == null
          ? null
          : AddModelSales.fromJson(json['model'] as Map<String, dynamic>),
    );
