...
part 'user_bids_view_base.g.dart';
...
class ViewModelUserBids {
  ...
  String? captcha;
   ...
   factory ViewModelUserBids.fromJson(Map<String, dynamic> json) => _$ViewModelUserBidsFromJson(json);

   Map<String, dynamic> toJson() => _$ViewModelUserBidsToJson(this); 
  
}

@JsonSerializable()
class UserBidsViewSuperBase {

  String? id;
  Meta? meta;
  List<Button?>? buttons;
  ViewModelUserBids? model;
  UserBidsViewSuperBase(
      this.id,
      this.buttons,
      this.meta,
      this.model,
  ...
  factory UserBidsViewSuperBase.fromJson(Map<String, dynamic> json) => _$UserBidsViewSuperBaseFromJson(json);
  Map<String, dynamic> toJson() => _$UserBidsViewSuperBaseToJson(this);
   
}

class UserBidsViewBase{
	var model;
	Map<String, dynamic> json;
	UserBidsViewBase(this.json){
		model = UserBidsViewSuperBase.fromJson(this.json);
	}
   ...
   List<SpeedDialChild>	 listButton(BuildContext context){
    ...
    {
      buttonChildren.add(ListButtonUserBidsWidget(model.buttons[i],context));
    }
