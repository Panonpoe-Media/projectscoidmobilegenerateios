  ...
  Map<String, dynamic> convertFormDataAction(var data, String? triger) {
    ...
    if (model!.model!.attachments != null) {
      if (model!.model!.attachments[0].temp != '') {
        attachments =
            '[{"name":"${model!.model!.attachments[0].name}","size":${model!.model!.attachments[0].size},"created":${model!.model!.attachments[0].date},"modified":${model!.model!.attachments[0].date},"temp":"${model!.model!.attachments[0].temp}","remote":"${model!.model!.attachments[0].remote}","dir":"${model!.model!.attachments[0].dir}"}]';
      }
    }
...
class BrowseUsersViewSuperBaseRev {
  ...
  factory BrowseUsersViewSuperBaseRev.fromJson(Map<String, dynamic> json) =>
      _$BrowseUsersViewSuperBaseRevFromJson(json);
}
/*
...
//  BrowseUsersViewModel(Map<String, dynamic> this.json):super(json);
  BrowseUsersViewModel(Map<String, dynamic> this.json) : super(json) {
    model = BrowseUsersViewSuperBaseRev.fromJson(this.json);
  }
  ...
  Widget viewHeader(BuildContext context, bool? account, ChatBloc? cb) {
    ...
    // final rng = Random();
    final itm = model!.model!.kabupaten_id == null
        ? getViewBackground(1)
        : getViewBackground(model!.model!.kabupaten_id);
        ...
        child: SingleChildScrollView(
          child: Column(children: <Widget>[
            ...
            Padding(
                ...
                child: Center(
                  child: Text('Project Statistics As Worker',
            ...
            Center(
                child: Text(
              'Current Projects : ' +
                  this.model!.model!.current_projects.toString(),
                ...
                Navigator.push(
                  ...
                  MaterialPageRoute(
                      builder: (context) => ShowItemScreenshots(
                          image: this.model!.model!.photo_url)),
                );
              },
              child: ClipRRect(
  ...
  Widget _buildFullName() {
    ...
    return (Html(data: readText(this.model!.model!.display_name, 100), style: {
      "html": Style(
  ...
  Widget _buildUserName() {
    ...
    return (Html(data: '(${this.model!.model!.user_name})', style: {
      "html": Style(
          alignment: Alignment.center,
          textAlign: TextAlign.center,
 ...
 */
  ...
  Widget _buildBio(BuildContext context, bool? account) {
    ...
    return ExpandablePanel(
        ...
        collapsed: Padding(
            ...
            child: Column(children: <Widget>[
              HtmlWidget(this.model!.model!.self_introduction == null
                  ? ''
                  : readText(
                      this
                          .model!
            ...
            child: Column(
                ...
                children: <Widget>[
                  ...
                  Padding(
                      ...
                      child: HtmlWidget(
                        this.model!.model!.self_introduction == null
                            ? ''
                            : this
                                .model!
                                .model!
            ...
            case 'Projects':
              {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => SearchPastProjectsListing11(
                          id: '',
                          title:
                              'List ${this.model!.model!.user_name} Projects',
                          search: '${this.model!.model!.user_name}')),
                );
              }
              break;
            case 'Sales':
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (context) => ServicesList(
                            id: this.model!.model!.user_id,
                            title: this.model!.meta.title,
                            url: Env.value!.baseUrl! +
                                '/public/browse_users/services_list/' +
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (context) => ProductsList(
                            ...
                            title: this.model!.meta.title,
                            url: Env.value!.baseUrl! +
                                '/public/browse_users/products_list/' +
                                this.model!.model!.user_id +
                                '/' +
                                this.model!.meta.title +
                                '?')),
            ...
            case 'Points':
              {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => AsProjectWorkerList(
                          id: this.model!.model!.user_id,
                          title: this.model!.meta.title,
                          url: Env.value!.baseUrl! +
                              '/public/browse_users/as_project_worker_list/' +
                              this.model!.model!.user_id +
                              '/' +
                              this.model!.meta.title +
                              '?')),
            ...
            case 'Arbitrated':
              {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => UserArbitrationsList(
                          id: this.model!.model!.user_id,
                          title: this.model!.meta.title,
                          url: Env.value!.baseUrl! +
                              '/public/browse_users/user_arbitrations_list/' +
                              this.model!.model!.user_id +
                              '/' +
                              this.model!.meta.title +
                              '?')),
  ...
  Widget _buildStatContainer(BuildContext context) {
    return Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          _buildStatItem("Projects",
              this.model!.model!.projects_completed.toString(), context),
          _buildStatItem(
              "Sales", this.model!.model!.product_sold.toString(), context),
          _buildStatItem(
              "Owner", this.model!.model!.projects_owned.toString(), context),
        ],
      ),
    );
  }
  ...
  Widget _buildStatContainer1(BuildContext context) {
    return Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          _buildStatItem1(
              "Rank", this.model!.model!.worker_ranking.toString(), context),
          _buildStatItem1(
              "Points", this.model!.model!.worker_point.toString(), context),
          _buildStatItem1("Arbitrated",
              this.model!.model!.projects_arbitrated.toString(), context),
        ],
      ),
    );
  }

  Widget _buildPointIndicator(String type, String? label, String? count,
      int? cnt, double? rating, BuildContext context) {
    TextStyle _statLabelTextStyle = TextStyle(
      fontFamily: 'Roboto',
      //  color: Colors.black45,
      fontSize: 12.0,
      ...
      child: Row(
        ...
        children: <Widget>[
          _buildPointIndicator(
              "Worker",
              "Points",
              this.model!.model!.worker_point.toString(),
              this.model!.model!.worker_point,
              this.model!.model!.worker_rating.toDouble(),
              context),
          _buildPointIndicator(
              "Seller",
              "Points",
              this.model!.model!.seller_point.toString(),
              this.model!.model!.seller_point,
              this.model!.model!.seller_rating.toDouble(),
              context),
          _buildPointIndicator(
              "Owner",
              "Points",
              this.model!.model!.owner_point.toString(),
              this.model!.model!.owner_point,
              this.model!.model!.owner_rating.toDouble(),
              context),
        ],
      ),
    );
  ...
  Widget _buildProcentageIndicator(
      String type, String? label, int? cnt, int? cnt1, BuildContext context) {
    TextStyle _statLabelTextStyle = TextStyle(
      fontFamily: 'Roboto',
      color: Colors.black45,
      fontSize: 12.0,
      ...
      children: <Widget>[
        cnt1 == 0
            ...
            : type == 'Arbitrated'
                ? CircularPercentIndicator(
                    progressColor:
                        this.model!.model!.arbitration_rate / 100 > 0.5
                            ? Colors.blue
                            : this.model!.model!.arbitration_rate / 100 > 0.25
                                ? Colors.yellow
                                : Colors.blue,
                    percent: this.model!.model!.arbitration_rate < 0
                        ? 0.0
                   ...
                   // arcType: ArcType.HALF,
                    ...
                    center: Column(
                        ...
                        children: <Widget>[
                          Text(
                            (this.model!.model!.arbitration_rate < 0
                                ? '-'
                                : this
                                    .model!
                                    .model!
                ...
                : type == 'Noaction'
                    ? CircularPercentIndicator(
                        progressColor: cnt! / cnt1! > 0.5
                            ? Colors.redAccent
                            : cnt! / cnt1! > 0.25
                                ? Colors.yellow
                                : Colors.blue,
                        percent: cnt! / cnt1 > 1.0
                            ? 1.0
                            : cnt < 0.0
                                ? 0.0
                                : cnt! / cnt1,
                    ...
                    : CircularPercentIndicator(
                        progressColor: this.model!.model!.completion_rate /
                                    100 >
                                0.5
                            ? Colors.blue
                            : this.model!.model!.completion_rate / 100 > 0.25
                                ? Colors.yellow
                                : Colors.redAccent,
                        percent: this.model!.model!.completion_rate < 0
                            ? 0.0
                        ...
                        center: Column(
                            ...
                            children: <Widget>[
                              Text(
                                (this.model!.model!.completion_rate < 0
                                    ? '-'
                                    : this
                                        .model!
                                        .model!
 ...
 */
  ...
  Widget viewProcentageContainer(
      ...
      child: Row(
        ...
        children: <Widget>[
          _buildProcentageIndicator(
              "Arbitrated",
              "%",
              this.model!.model!.projects_arbitrated,
              this.model!.model!.projects_won == 0
                  ? 1 + this.model!.model!.projects_owned
          ...
          _buildProcentageIndicator(
              "Completed",
              "%",
              this.model!.model!.projects_completed,
              this.model!.model!.projects_won == 0
                  ? 1
                  : this.model!.model!.projects_won,
              context),
          ...
          _buildProcentageIndicator(
              "Noaction",
              "%",
              this.model!.model!.projects_noaction,
              this.model!.model!.projects_owned == 0
                  ? 1
                  : this.model!.model!.projects_owned,
              context),
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              Padding(
                                  padding: EdgeInsets.only(
                                      left: 55.0, right: 8.0, top: 0.0),
                                  child: Html(
                                      data: this.model!.model!.user_name,
                                      style: {
                                        "html": Style(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              Padding(
                                  padding: EdgeInsets.only(
                                      left: 55.0, right: 8.0, top: 0.0),
                                  child: this.model!.model!.provinsi_str == ''
                                      ...
                                      : Html(
                                          data: this.model!.model!.provinsi_str,
                                          style: {
                                              "html": Style(
                                                  fontSize: FontSize.small,
                                                  fontWeight: FontWeight.w400),
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              Padding(
                                  padding: EdgeInsets.only(
                                      left: 55.0, right: 8.0, top: 0.0),
                                  child: this.model!.model!.kabupaten_id == null
                                      ? Html(data: 'Unavailable', style: {
                                          "html": Style(
                                              fontSize: FontSize.small,
                                              fontWeight: FontWeight.w400),
                                        })
                                      : this.model!.model!.kabupaten_str == ''
                                          ? Html(data: 'Unavailable', style: {
                                              "html": Style(
                                                  fontSize: FontSize.small,
                                                  fontWeight: FontWeight.w400),
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              this.model!.model!.date_registered == null
                                  ? Container(
                                      width: 0.0,
                                      height: 0.0,
                                    )
                            ...
                            children: <Widget>[
                              ...
                              Padding(
                                  padding: EdgeInsets.only(
                                      left: 55.0, right: 8.0, top: 0.0),
                                  child: Html(
                                      data: this.model!.model!.website == null
                                          ? '-'
                                          : this.model!.model!.website == ''
                                              ? '-'
                                              : this.model!.model!.website,
  ...
  Widget viewUserServices(BuildContext context, ChatBloc? cb) {
    return this.model!.model!.services.items.length == 0
        ...
        : Column(
            children: <Widget>[
              ...
              Container(
                ...
                child: this.model!.model!.services.items.length == 1
                    ? Center(
                        child: ServiceUserItem(
                            model: this.model!.model!.services.items[0],
                            cb: cb))
                    : ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int? index) {
                          return index! >=
                              ...
                              : ServiceUserItem(
                                  model:
                                      this.model!.model!.services.items[index],
                                  cb: cb);
                        },
                        itemCount:
                            this.model!.model!.services.items.length == 10
                                ? this.model!.model!.services.items.length
                                : this.model!.model!.services.items.length + 1,
                        // controller: controller!,
                      ),
  ...
  Widget viewUserProducts(BuildContext context, ChatBloc? cb) {
    return this.model!.model!.products.items.length == 0
        ? Container(height: 0.0, width: 0.0)
        : Column(
            children: <Widget>[
              Container(
              ...
              Container(
                ...
                padding: const EdgeInsets.fromLTRB(0.0, 10.0, 0.0, 0.0),
                child: this.model!.model!.products.items.length == 1
                    ? Center(
                        child: ProductUserItem(
                            model: this.model!.model!.products.items[0],
                            cb: cb))
                    : ListView.builder(
                        scrollDirection: Axis.horizontal,
                        itemBuilder: (BuildContext context, int? index) {
                          return index! >=
                              ...
                              : ProductUserItem(
                                  model:
                                      this.model!.model!.products.items[index],
                                  cb: cb);
                        },
                        itemCount:
                            this.model!.model!.products.items.length == 10
                                ? this.model!.model!.products.items.length
                                : this.model!.model!.products.items.length + 1,
                        // controller: controller!,
                      ),
  ...
  Widget reviewUserAsWorker(BuildContext context) {
    ...
    return model!.model!.as_project_worker!.items.length == 0
        ? Padding(
            ...
            child: InkWell(
               ...
               */
                              ...
                              Padding(
                                ...
                                child: HtmlWidget(
                                  '${readText(this.model!.model!.as_project_worker.items![0].worker_feedback!.replaceAll('<div>', '')!.replaceAll('<\/div>', '')!.replaceAll('<br>', ' ')!.replaceAll('<p>', '')!.replaceAll('<\/p>', '<br>') ?? '', 400)}',
            ...
            child: InkWell(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => AsProjectOwnerList(
                            id: this.model!.model!.user_id,
                            title: this.model!.meta.title,
                            url: Env.value!.baseUrl! +
                                '/public/browse_users/as_project_owner_list/' +
                                this.model!.model!.user_id +
                                '/' +
                                this.model!.meta.title +
                                '?')),
                        ...
                        child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                padding: EdgeInsets.symmetric(horizontal: 25),
                                child: HtmlWidget(
                                  '${readText(this.model!.model!.as_project_owner.items[0].owner_feedback!.replaceAll('%;\"><\/div>', '%;background-color: #FF8000;\"><\/div>')!.replaceAll('<div>', '')!.replaceAll('<\/div>', '')!.replaceAll('<br>', ' ')!.replaceAll('<p>', '')!.replaceAll('<\/p>', '<br>') ?? '', 800)}',
                                  //tableCellPadding : EdgeInsets.only(left : 0.0,top: 0.0,bottom: 0.0, right: 5),
                                  textStyle: TextStyle(
                                    fontSize: 15,
                                    letterSpacing: 1,
                        ...
                        child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                padding: EdgeInsets.symmetric(horizontal: 25),
                                child: HtmlWidget(
                                  '${readText(data['plaintiff_description'].trim()!.replaceAll('<div>', '')!.replaceAll('<\/div>', '')!.replaceAll('<br>', ' ')!.replaceAll('<p>', '')!.replaceAll('<\/p>', '<br>') ?? '', 400).trim()}',
                                  //tableCellPadding : EdgeInsets.only(left : 0.0,top: 0.0,bottom: 0.0, right: 5),
                                  textStyle: TextStyle(
                                    fontSize: 15,
                                    letterSpacing: 1,
            ...
            : ListView.builder(
                ...
                itemBuilder: (BuildContext context, int? index) {
                  return index! >= this.model!.model!.portofolio.items.length
                      ? Container(width: 0.0, height: 0.0)
                      : PortfoliosItem(
                          model: this.model!.model!.portofolio.items[index],
                          info: this.model!.model!.portofolio);
                },
        ...
        actions: <Widget>[
          Padding(
              ...
              child: GestureDetector(
                onTap: () {
                  Share.share(
                      '${model!.meta.title} https://projects.co.id/public/browse_users/view/${this.model!.model!.user_id}/user',
            ...
            InkWell(
              onTap: () {
                ...
                Navigator.push(
                  ...
                  MaterialPageRoute(
                      builder: (context) =>
                          ShowItemPortfolios(image: this.model!.image_url)),
                );
              },
              child: Container(
                height: 120.0,
              ...
              onTap: () {
                if (account!) {
                  AppProvider.getRouter(context)!.navigateTo(
                      context,
                      urlToRoute(
                          'public/browse_users/hire_me/${this.info!.user_id}/haloo'));
                } else {
                  AppProvider.getRouter(context)!
                      .navigateTo(context, '/login/1');
                }
              ...
              onTap: () {
                if (account!) {
                  AppProvider.getRouter(context)!.navigateTo(
                      context,
                      urlToRoute(
                          'public/browse_users/invite_to_bid/${this.info!.user_id}/test'));
                } else {
                  AppProvider.getRouter(context)!
                      .navigateTo(context, '/login/1');
                }
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Padding(
                      padding:
                          EdgeInsets.only(left: 28.0, top: 0.0, right: 0.0),
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Padding(
                      padding:
                          EdgeInsets.only(left: 28.0, top: 5.0, right: 0.0),
                      child: Text(model!.price_str!,
                          style: TextStyle(
                              fontSize: 10.5,
                              //   color: Colors.black54,
...
class BrowseUsersListingModel extends BrowseUsersListingBase {
  ...
  Widget viewItemIndex(
      ItemBrowseUsersModel item, String? search, int? index, bool? account) {
    ShapeBorder? shape;
    double? height = 302;
  ...
  //@override
  Widget viewItemcb(ItemBrowseUsersModel item, String? search, int? index,
      bool? account, ChatBloc? cb) {
    ShapeBorder? shape;
    double? height = 302;
    ...
    return SpeedDialChild(
      ...
      onTap: () => {
        Navigator.push(
          ...
          MaterialPageRoute(
              builder: (context) =>
                  SearchBrowseUsersListing(id: '', title: '')),
        )
      },
    );
  }
  ...
  List<SpeedDialChild> listButton(BuildContext context, bool? account) {
    ...
    for (var i = 0; i < tools.buttons.length; i++) {
      buttonChildren
          .add(ListButtonBrowseUsersWidget(tools.buttons[i], context, account));
    }
...
class SearchBrowseUsersListing extends StatefulWidget {
  ...
  bool? account;
  ChatBloc? cb;
  SearchBrowseUsersListing(
      {Key? key, this.id, this.title, this.account, this.cb})
      : super(key: key);
  @override
  SearchBrowseUsersListingState createState() =>
...
class SearchBrowseUsersListingState extends State<SearchBrowseUsersListing> {
  ...
  bool? search = false;
  String? getPath =
      Env.value!.baseUrl! + '/public/browse_users/listing?page=%d';
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.id == '') {
      getPath = Env.value!.baseUrl! +
          '/public/browse_users/listing?page=%d&' +
          'search=' +
          searchText!;
    } else {
      getPath = Env.value!.baseUrl! +
          '/public/browse_users/listing/' +
          widget.id! +
          '?page=%d';
    }
    accountController =
              ...
              child: ListView.builder(
                itemBuilder: (BuildContext context, int? index) {
                  return index! >= state.browse_users!.items.items.length
                      ? search!
                          ? state.browse_users!.tools.paging.total_pages ==
                                  state.browse_users!.tools.paging.current_page
                              ? Container(
                                  height: 0.0,
                                  width: 0.0,
                                )
                  ...
                  itemBuilder: (BuildContext context, int? index) {
                    return index! >= state.browse_users!.items.items.length
                        ? search!
                            ? state.browse_users!.tools.paging.total_pages ==
                                    state
                                        .browse_users!.tools.paging.current_page
                                ? Container(
                                    height: 0.0,
                                    width: 0.0,
                                  )
...
class SearchBrowseUsersListing1 extends StatefulWidget {
  ...
  SearchBrowseUsersListing1(
      ...
      : super(key: key);
  @override
  SearchBrowseUsersListing1State createState() =>
      SearchBrowseUsersListing1State();
}
          ...
          children: <Widget>[
            ...
            SizedBox(
              ...
              /*   child: Card(
                ...
                borderOnForeground : false, */
              child: index == 0
                  ? ItemBrowseUsersContent2(destination: destination)
                  : ItemBrowseUsersContent1(destination: destination),
              //   ),
            ),
    ...
    return (Stack(children: <Widget>[
              ...
              children: <Widget>[
                Padding(
                  ...
                  child: Row(children: <Widget>[
                    destination!.item.skills_str.isEmpty
                        ? Container()
                        : Text(destination!.item.skills_str[0],
                            style:
      ...
      Column(crossAxisAlignment: CrossAxisAlignment.center, children: <Widget>[
        ...
        Row(
            ...
            children: <Widget>[
              Text(
                '${destination!.item.worker_ranking.toString()} rank',
                style: descriptionStyle!
              ...
              Text(
                '${destination!.item.worker_point.toString()} points',
                style: descriptionStyle!
                    .copyWith(fontSize: 12, color: Colors.white),
              ),
            ]),
    ...
    final List<Widget> children = <Widget>[
      ...
      Row(crossAxisAlignment: CrossAxisAlignment.start, children: <Widget>[
            ...
            child: Column(
                ...
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: RatingBarIndicator(
                      rating:
                          destination!.item.worker_rating.toDouble() / 2 - 0.01,
                      itemBuilder: (context, index) => Icon(
                        Icons.star,
                        color: CurrentTheme.PrimaryLightColor,
                      ),
        ...
        Padding(
          ...
          child: destination!.item.projects_completed == 0
              ? Text('0 Project Completed',
                  style: TextStyle(fontSize: 13, color: Colors.white))
              : Text(
                  '${destination!.item.projects_completed.toString()} Projects Completed',
                  style: TextStyle(fontSize: 13, color: Colors.white),
                ),
        ),
        SizedBox(height: 10),
      ...
      Container(
        ...
        child: GestureDetector(
            ...
            child: Ink(
              ...
              child: HtmlWidget(
                readText(
                    destination!.item.self_introduction!
                        .replaceAll('<div>', '')!
                        .replaceAll('<\/div>', '')!
                        .replaceAll('<br>', ' ')!
                        .replaceAll('<p>', '')!
...
class SearchPastProjectsListing11 extends StatefulWidget {
  ...
  final String? title;
  final String? search;
  SearchPastProjectsListing11({Key? key, this.id, this.title, this.search})
      : super(key: key);
  @override
  SearchPastProjectsListing11State createState() =>
      SearchPastProjectsListing11State();
}

class SearchPastProjectsListing11State
    extends State<SearchPastProjectsListing11> with RestorationMixin {
