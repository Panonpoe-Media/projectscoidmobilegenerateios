...
import 'photo.dart';
import 'paging.dart';
part 'existing_user_item_base.g.dart';
//


class ItemExistingUserBase {
	var item;
	Map<String, dynamic> json;
	ItemExistingUserBase(this.json){
		item = ItemExistingUser.fromJson(json);
	}	
...
class ItemExistingUser{
  ...
  factory ItemExistingUser.fromJson(Map<String, dynamic> json) => _$ItemExistingUserFromJson(json);

  Map<String, dynamic> toJson() => _$ItemExistingUserToJson(this);
