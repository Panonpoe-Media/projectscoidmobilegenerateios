...
class ItemNewUserBase {
	...
	ItemNewUserBase(this.json){
		item = ItemNewUser.fromJson(json);
	}	
...
class ItemNewUser{
  ...
  factory ItemNewUser.fromJson(Map<String, dynamic> json) => _$ItemNewUserFromJson(json);

  Map<String, dynamic> toJson() => _$ItemNewUserToJson(this);
