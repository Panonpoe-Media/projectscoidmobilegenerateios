...
part 'payment_history_add_base.g.dart';
...
class AddModelPaymentHistory {
  ...
  String? secure_code;
    ...
    factory AddModelPaymentHistory.fromJson(Map<String, dynamic> json) => _$AddModelPaymentHistoryFromJson(json);

  Map<String, dynamic> toJson() => _$AddModelPaymentHistoryToJson(this);
...
class PaymentHistoryAddBase{
	var model;
	Map<String, dynamic> json;
	PaymentHistoryAddBase(this.json){
