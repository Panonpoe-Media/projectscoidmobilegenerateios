...
part of 'payment_history_edit_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

EditModelPaymentHistory _$EditModelPaymentHistoryFromJson(
...
Map<String, dynamic> _$EditModelPaymentHistoryToJson(
        EditModelPaymentHistory instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
PaymentHistorySuperBase _$PaymentHistorySuperBaseFromJson(
    ...
    PaymentHistorySuperBase(
      ...
      json['model'] == null
          ? null
          : EditModelPaymentHistory.fromJson(
