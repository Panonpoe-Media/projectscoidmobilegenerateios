...
import '../photo.dart';
import '../paging.dart';
part 'credit_history_list_item_base.g.dart';

class ItemCreditHistoryBase {
	var item;
	Map<String, dynamic> json;
	ItemCreditHistoryBase(this.json){
		item = ItemCreditHistory.fromJson(json);
	}	
...
class ItemCreditHistory{
  ...
  factory ItemCreditHistory.fromJson(Map<String, dynamic> json) => _$ItemCreditHistoryFromJson(json);

  Map<String, dynamic> toJson() => _$ItemCreditHistoryToJson(this);
