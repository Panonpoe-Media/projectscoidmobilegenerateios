...
part of 'credit_history_edit_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

EditModelCreditHistory _$EditModelCreditHistoryFromJson(
...
Map<String, dynamic> _$EditModelCreditHistoryToJson(
        EditModelCreditHistory instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
CreditHistorySuperBase _$CreditHistorySuperBaseFromJson(
    ...
    CreditHistorySuperBase(
      ...
      json['model'] == null
          ? null
          : EditModelCreditHistory.fromJson(
