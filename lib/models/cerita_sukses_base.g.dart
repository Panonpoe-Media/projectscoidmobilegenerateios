...
part of 'cerita_sukses_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ModelCeritaSukses _$ModelCeritaSuksesFromJson(Map<String, dynamic> json) =>
    ModelCeritaSukses(
      json['id'] as String?,
...
Map<String, dynamic> _$ModelCeritaSuksesToJson(ModelCeritaSukses instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
CeritaSuksesSuperBase _$CeritaSuksesSuperBaseFromJson(
    ...
    CeritaSuksesSuperBase(
      ...
      json['model'] == null
          ? null
          : ModelCeritaSukses.fromJson(json['model'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$CeritaSuksesSuperBaseToJson(
        CeritaSuksesSuperBase instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
...
ViewModelCeritaSukses _$ViewModelCeritaSuksesFromJson(
        Map<String, dynamic> json) =>
...
Map<String, dynamic> _$ViewModelCeritaSuksesToJson(
        ViewModelCeritaSukses instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
CeritaSuksesViewSuperBase _$CeritaSuksesViewSuperBaseFromJson(
        Map<String, dynamic> json) =>
    CeritaSuksesViewSuperBase(
      ...
      json['model'] == null
          ? null
          : ViewModelCeritaSukses.fromJson(
              json['model'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$CeritaSuksesViewSuperBaseToJson(
        CeritaSuksesViewSuperBase instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
      'buttons': instance.buttons,
...
CeritaSuksesListingTools _$CeritaSuksesListingToolsFromJson(
        Map<String, dynamic> json) =>
    CeritaSuksesListingTools(
      ...
      (json['items'] as List<dynamic>?)
          ?.map((e) => e == null
              ? null
              : ItemCeritaSukses.fromJson(e as Map<String, dynamic>))
          .toList(),
    );

Map<String, dynamic> _$CeritaSuksesListingToolsToJson(
        CeritaSuksesListingTools instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
      'buttons': instance.buttons,
