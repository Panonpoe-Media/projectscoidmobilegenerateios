...
part 'checkout_items_add_base.g.dart';
...
class AddModelCheckoutItems {
  ...
  String? total_price_str;
    ...
    factory AddModelCheckoutItems.fromJson(Map<String, dynamic> json) => _$AddModelCheckoutItemsFromJson(json);

  Map<String, dynamic> toJson() => _$AddModelCheckoutItemsToJson(this);
...
class CheckoutItemsAddBase{
	var model;
	Map<String, dynamic> json;
	CheckoutItemsAddBase(this.json){
