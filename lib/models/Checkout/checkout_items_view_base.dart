...
part 'checkout_items_view_base.g.dart';
...
class ViewModelCheckoutItems {
  ...
  String? total_price_str;
   ...
   factory ViewModelCheckoutItems.fromJson(Map<String, dynamic> json) => _$ViewModelCheckoutItemsFromJson(json);

   Map<String, dynamic> toJson() => _$ViewModelCheckoutItemsToJson(this); 
  
}

@JsonSerializable()
class CheckoutItemsViewSuperBase {

  String? id;
  Meta? meta;
  List<Button?>? buttons;
  ViewModelCheckoutItems? model;
  CheckoutItemsViewSuperBase(
      this.id,
      this.buttons,
      this.meta,
      this.model,
  ...
  factory CheckoutItemsViewSuperBase.fromJson(Map<String, dynamic> json) => _$CheckoutItemsViewSuperBaseFromJson(json);
  Map<String, dynamic> toJson() => _$CheckoutItemsViewSuperBaseToJson(this);
   
}

class CheckoutItemsViewBase{
	var model;
	Map<String, dynamic> json;
	CheckoutItemsViewBase(this.json){
		model = CheckoutItemsViewSuperBase.fromJson(this.json);
	}
   ...
   List<SpeedDialChild>	 listButton(BuildContext context){
    ...
    {
      buttonChildren.add(ListButtonCheckoutItemsWidget(model.buttons[i],context));
    }
