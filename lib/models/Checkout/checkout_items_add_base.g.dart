...
part of 'checkout_items_add_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

AddModelCheckoutItems _$AddModelCheckoutItemsFromJson(
...
Map<String, dynamic> _$AddModelCheckoutItemsToJson(
        AddModelCheckoutItems instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
CheckoutItemsSuperBase _$CheckoutItemsSuperBaseFromJson(
    ...
    CheckoutItemsSuperBase(
      ...
      json['model'] == null
          ? null
          : AddModelCheckoutItems.fromJson(
