...
import '../photo.dart';
import '../paging.dart';
part 'checkout_items_list_item_base.g.dart';

class ItemCheckoutItemsBase {
	var item;
	Map<String, dynamic> json;
	ItemCheckoutItemsBase(this.json){
		item = ItemCheckoutItems.fromJson(json);
	}	
...
class ItemCheckoutItems{
  ...
  factory ItemCheckoutItems.fromJson(Map<String, dynamic> json) => _$ItemCheckoutItemsFromJson(json);

  Map<String, dynamic> toJson() => _$ItemCheckoutItemsToJson(this);
