...
import '../photo.dart';
import '../paging.dart';
part 'sales_index_item_base.g.dart';

class ItemIndexSalesBase {
	ItemIndexSales? item;
	Map<String, dynamic> json;
	ItemIndexSalesBase(this.json){
		item = ItemIndexSales.fromJson(json);
	}	
...
class ItemIndexSales{
  ...
  factory ItemIndexSales.fromJson(Map<String, dynamic> json) => _$ItemIndexSalesFromJson(json);

  Map<String, dynamic> toJson() => _$ItemIndexSalesToJson(this);
