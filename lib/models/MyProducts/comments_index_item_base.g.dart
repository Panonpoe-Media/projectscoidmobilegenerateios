...
part of 'comments_index_item_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ItemIndexComments _$ItemIndexCommentsFromJson(Map<String, dynamic> json) =>
    ItemIndexComments(
...
Map<String, dynamic> _$ItemIndexCommentsToJson(ItemIndexComments instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
