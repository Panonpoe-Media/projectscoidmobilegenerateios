...
part of 'sales_view_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ViewModelSales _$ViewModelSalesFromJson(Map<String, dynamic> json) =>
    ViewModelSales(
      json['id'] as String?,
...
Map<String, dynamic> _$ViewModelSalesToJson(ViewModelSales instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
SalesViewSuperBase _$SalesViewSuperBaseFromJson(Map<String, dynamic> json) =>
    SalesViewSuperBase(
      json['id'] as String?,
      ...
      json['model'] == null
          ? null
          : ViewModelSales.fromJson(json['model'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$SalesViewSuperBaseToJson(SalesViewSuperBase instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
