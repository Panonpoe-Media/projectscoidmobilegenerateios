...
part of 'comments_edit_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

EditModelComments _$EditModelCommentsFromJson(Map<String, dynamic> json) =>
    EditModelComments(
      json['id'] as String?,
...
Map<String, dynamic> _$EditModelCommentsToJson(EditModelComments instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
CommentsSuperBase _$CommentsSuperBaseFromJson(Map<String, dynamic> json) =>
    CommentsSuperBase(
      ...
      json['model'] == null
          ? null
          : EditModelComments.fromJson(json['model'] as Map<String, dynamic>),
    );
