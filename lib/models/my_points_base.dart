...
import 'package:projectscoid/models/MyPoints/action.dart';
import 'package:google_mobile_ads/google_mobile_ads.dart';
import 'package:projectscoid/views/route.dart' as rt;

part 'my_points_base.g.dart';
...
class ModelMyPoints {
  ...
  String? coupon;
    ...
    factory ModelMyPoints.fromJson(Map<String, dynamic> json) => _$ModelMyPointsFromJson(json);

  Map<String, dynamic> toJson() => _$ModelMyPointsToJson(this);
...
class MyPointsBase{
	...
	MyPointsBase(this.json){
		model = MyPointsSuperBase.fromJson(this.json);
   ...
   Map<String, dynamic> convertFormDataEdit(var data){
	...
	if (model.model.photo!= null) {
      ...
      var formData = {
      "my_points[_trigger_]":"",
   "my_points[user_id]": "${model.model.user_id }",
  "my_points[user_name]": "${model.model.user_name }",
  "my_points[group_id]": "${model.model.group_id }",
  "my_points[email]": "${model.model.email }",
  "my_points[password]": "${model.model.password }",
  "my_points[password_confirmation]": "${model.model.password }",
  "my_points[auth]": "${model.model.auth }",
   "my_points[account_status_id]": "${model.model.account_status_id}",
   "my_points[account_type_id]": "${model.model.account_type_id}",
  "my_points[date_registered]": "${DateFormat('dd/MM/yyyy HH:mm:ss').format(model.model.date_registered)}",
  "my_points[last_login]": "${DateFormat('dd/MM/yyyy HH:mm:ss').format(model.model.last_login)}",
  "my_points[last_seen]": "${DateFormat('dd/MM/yyyy HH:mm:ss').format(model.model.last_seen)}",
  "my_points[online]": "${model.model.online ? 1 : 0}",
  "my_points[last_online_mark]": "${DateFormat('dd/MM/yyyy HH:mm:ss').format(model.model.last_online_mark)}",
  "my_points[online_hours]": "${model.model.online_hours}",
  "my_points[nomor_ktp]": "${model.model.nomor_ktp }",
  "my_points[scan_ktp]": '$scan_ktp',
  "my_points[scan_ktp_lastval]": '{"name":"${model.model.scan_ktp.name}","dir":"${model.model.scan_ktp.dir}","file":"${model.model.scan_ktp.file}","thumb":"${model.model.scan_ktp.thumb}"}',
  "my_points[nomor_siup]": "${model.model.nomor_siup }",
  "my_points[scan_siup]": '$scan_siup',
  "my_points[scan_siup_lastval]": '{"name":"${model.model.scan_siup.name}","dir":"${model.model.scan_siup.dir}","file":"${model.model.scan_siup.file}","thumb":"${model.model.scan_siup.thumb}"}',
  "my_points[npwp]": "${model.model.npwp }",
   "my_points[status_marital_id]": "${model.model.status_marital_id}",
  "my_points[jumlah_tanggungan]": "${model.model.jumlah_tanggungan }",
  "my_points[personal_data]": "${model.model.personal_data }",
  "my_points[photo]": '$photo',
  "my_points[photo_lastval]": '{"name":"${model.model.photo.name}","dir":"${model.model.photo.dir}","file":"${model.model.photo.file}","thumb":"${model.model.photo.thumb}"}',
  "my_points[display_name]": "${model.model.display_name }",
  "my_points[birth_date]": "${DateFormat('dd/MM/yyyy').format(model.model.birth_date)}",
  "my_points[birth_code]": "${model.model.birth_code }",
   "my_points[jenis_kelamin_id]": "${model.model.jenis_kelamin_id}",
  "my_points[address]": "${model.model.address }",
  "my_points[country_id]": "${model.model.country_id }",
  "my_points[provinsi_id]": "${model.model.provinsi_id }",
  "my_points[kabupaten_id]": "${model.model.kabupaten_id }",
  "my_points[kecamatan_id]": "${model.model.kecamatan_id }",
  "my_points[kelurahan_id]": "${model.model.kelurahan_id }",
  "my_points[post_code]": "${model.model.post_code }",
  "my_points[handphone]": "${model.model.handphone }",
  "my_points[self_introduction]": "${model.model.self_introduction }",
  "my_points[website]": "${model.model.website }",
  "my_points[language_id]": "${model.model.language_id }",
  "my_points[full_name]": "${model.model.full_name }",
  "my_points[captcha]": "${model.model.captcha }",
  "my_points[secure_code]": "${model.model.secure_code }",
  "my_points[old_password]": "${model.model.old_password }",
  "my_points[old_password_confirmation]": "${model.model.old_password }",
  "my_points[new_email]": "${model.model.new_email }",
  "my_points[your_email]": "${model.model.your_email }",
  "my_points[invitation_message]": "${model.model.invitation_message }",
  "my_points[financial_data]": "${model.model.financial_data }",
  "my_points[bank_id]": "${model.model.bank_id }",
  "my_points[branch]": "${model.model.branch }",
  "my_points[city]": "${model.model.city }",
  "my_points[account_number]": "${model.model.account_number }",
  "my_points[account_name]": "${model.model.account_name }",
   "my_points[cutoff_period_id]": "${model.model.cutoff_period_id}",
  "my_points[cutoff_amount]": "${model.model.cutoff_amount}",
  "my_points[deposit_amount]": "${model.model.deposit_amount}",
  "my_points[statistics]": "${model.model.statistics }",
  "my_points[money_earned]": "${model.model.money_earned}",
  "my_points[money_spent]": "${model.model.money_spent}",
  "my_points[available_balance]": "${model.model.available_balance}",
  "my_points[withheld_balance]": "${model.model.withheld_balance}",
  "my_points[admin_notes]": "${model.model.admin_notes }",
  "my_points[pesta_point]": "${model.model.pesta_point }",
  "my_points[worker_rating]": "${model.model.worker_rating }",
  "my_points[worker_ranking]": "${model.model.worker_ranking }",
  "my_points[worker_point]": "${model.model.worker_point }",
  "my_points[worker_rating_num]": "${model.model.worker_rating_num}",
  "my_points[worker_rating_sum]": "${model.model.worker_rating_sum }",
  "my_points[worker_rating_div]": "${model.model.worker_rating_div }",
  "my_points[owner_rating]": "${model.model.owner_rating }",
  "my_points[owner_ranking]": "${model.model.owner_ranking }",
  "my_points[owner_point]": "${model.model.owner_point }",
  "my_points[owner_rating_num]": "${model.model.owner_rating_num}",
  "my_points[owner_rating_sum]": "${model.model.owner_rating_sum }",
  "my_points[owner_rating_div]": "${model.model.owner_rating_div }",
  "my_points[seller_rating]": "${model.model.seller_rating }",
  "my_points[seller_ranking]": "${model.model.seller_ranking }",
  "my_points[seller_point]": "${model.model.seller_point }",
  "my_points[seller_rating_num]": "${model.model.seller_rating_num}",
  "my_points[seller_rating_sum]": "${model.model.seller_rating_sum }",
  "my_points[seller_rating_div]": "${model.model.seller_rating_div }",
  "my_points[buyer_rating]": "${model.model.buyer_rating }",
  "my_points[buyer_ranking]": "${model.model.buyer_ranking }",
  "my_points[buyer_point]": "${model.model.buyer_point }",
  "my_points[buyer_rating_num]": "${model.model.buyer_rating_num}",
  "my_points[buyer_rating_sum]": "${model.model.buyer_rating_sum }",
  "my_points[buyer_rating_div]": "${model.model.buyer_rating_div }",
  "my_points[affiliate_rating]": "${model.model.affiliate_rating }",
  "my_points[affiliate_ranking]": "${model.model.affiliate_ranking }",
  "my_points[affiliate_point]": "${model.model.affiliate_point }",
  "my_points[affiliate_rating_num]": "${model.model.affiliate_rating_num}",
  "my_points[affiliate_rating_sum]": "${model.model.affiliate_rating_sum }",
  "my_points[affiliate_rating_div]": "${model.model.affiliate_rating_div }",
  "my_points[projects_won]": "${model.model.projects_won }",
  "my_points[projects_won_cumulative]": "${model.model.projects_won_cumulative}",
  "my_points[projects_owned]": "${model.model.projects_owned }",
  "my_points[projects_owned_cumulative]": "${model.model.projects_owned_cumulative}",
  "my_points[projects_noaction]": "${model.model.projects_noaction }",
  "my_points[projects_canceled]": "${model.model.projects_canceled }",
  "my_points[missed_payment]": "${model.model.missed_payment }",
  "my_points[projects_completed]": "${model.model.projects_completed }",
  "my_points[projects_arbitrated]": "${model.model.projects_arbitrated }",
  "my_points[projects_arbit_won]": "${model.model.projects_arbit_won }",
  "my_points[projects_arbit_lost]": "${model.model.projects_arbit_lost }",
  "my_points[current_projects]": "${model.model.current_projects }",
  "my_points[missed_weekly_report]": "${model.model.missed_weekly_report }",
  "my_points[product_sold]": "${model.model.product_sold }",
  "my_points[product_sold_cumulative]": "${model.model.product_sold_cumulative}",
  "my_points[product_bought]": "${model.model.product_bought }",
  "my_points[product_bought_cumulative]": "${model.model.product_bought_cumulative}",
  "my_points[bid_count]": "${model.model.bid_count }",
  "my_points[post_count]": "${model.model.post_count }",
  "my_points[work_quality]": "${model.model.work_quality }",
  "my_points[work_quality_num]": "${model.model.work_quality_num}",
  "my_points[work_quality_sum]": "${model.model.work_quality_sum }",
  "my_points[work_quality_div]": "${model.model.work_quality_div }",
  "my_points[expertise]": "${model.model.expertise }",
  "my_points[expertise_num]": "${model.model.expertise_num}",
  "my_points[expertise_sum]": "${model.model.expertise_sum }",
  "my_points[expertise_div]": "${model.model.expertise_div }",
  "my_points[worker_communication]": "${model.model.worker_communication }",
  "my_points[worker_communication_num]": "${model.model.worker_communication_num}",
  "my_points[worker_communication_sum]": "${model.model.worker_communication_sum }",
  "my_points[worker_communication_div]": "${model.model.worker_communication_div }",
  "my_points[worker_professionalism]": "${model.model.worker_professionalism }",
  "my_points[worker_professionalism_num]": "${model.model.worker_professionalism_num}",
  "my_points[worker_professionalism_sum]": "${model.model.worker_professionalism_sum }",
  "my_points[worker_professionalism_div]": "${model.model.worker_professionalism_div }",
  "my_points[clarity]": "${model.model.clarity }",
  "my_points[clarity_num]": "${model.model.clarity_num}",
  "my_points[clarity_sum]": "${model.model.clarity_sum }",
  "my_points[clarity_div]": "${model.model.clarity_div }",
  "my_points[friendliness]": "${model.model.friendliness }",
  "my_points[friendliness_num]": "${model.model.friendliness_num}",
  "my_points[friendliness_sum]": "${model.model.friendliness_sum }",
  "my_points[friendliness_div]": "${model.model.friendliness_div }",
  "my_points[owner_communication]": "${model.model.owner_communication }",
  "my_points[owner_communication_num]": "${model.model.owner_communication_num}",
  "my_points[owner_communication_sum]": "${model.model.owner_communication_sum }",
  "my_points[owner_communication_div]": "${model.model.owner_communication_div }",
  "my_points[owner_professionalism]": "${model.model.owner_professionalism }",
  "my_points[owner_professionalism_num]": "${model.model.owner_professionalism_num}",
  "my_points[owner_professionalism_sum]": "${model.model.owner_professionalism_sum }",
  "my_points[owner_professionalism_div]": "${model.model.owner_professionalism_div }",
  "my_points[product_quality]": "${model.model.product_quality }",
  "my_points[product_quality_num]": "${model.model.product_quality_num}",
  "my_points[product_quality_sum]": "${model.model.product_quality_sum }",
  "my_points[product_quality_div]": "${model.model.product_quality_div }",
  "my_points[service_quality]": "${model.model.service_quality }",
  "my_points[service_quality_num]": "${model.model.service_quality_num}",
  "my_points[service_quality_sum]": "${model.model.service_quality_sum }",
  "my_points[service_quality_div]": "${model.model.service_quality_div }",
  "my_points[seller_communication]": "${model.model.seller_communication }",
  "my_points[seller_communication_num]": "${model.model.seller_communication_num}",
  "my_points[seller_communication_sum]": "${model.model.seller_communication_sum }",
  "my_points[seller_communication_div]": "${model.model.seller_communication_div }",
  "my_points[seller_professionalism]": "${model.model.seller_professionalism }",
  "my_points[seller_professionalism_num]": "${model.model.seller_professionalism_num}",
  "my_points[seller_professionalism_sum]": "${model.model.seller_professionalism_sum }",
  "my_points[seller_professionalism_div]": "${model.model.seller_professionalism_div }",
  "my_points[referer_id]": "${model.model.referer_id }",
  "my_points[referer_expires]": "${DateFormat('dd/MM/yyyy HH:mm:ss').format(model.model.referer_expires)}",
  "my_points[referal_this_month]": "${model.model.referal_this_month }",
  "my_points[cookies_this_month]": "${model.model.cookies_this_month }",
  "my_points[premium_affiliate]": "${model.model.premium_affiliate ? 1 : 0}",
  "my_points[refered_users]": "${model.model.refered_users }",
  "my_points[referal_earnings]": "${model.model.referal_earnings}",
  "my_points[affiliate_id]": "${model.model.affiliate_id }",
  "my_points[last_announced_project]": "${model.model.last_announced_project }",
  "my_points[notif_count]": "${model.model.notif_count }",
  "my_points[notify_projects]": "${model.model.notify_projects ? 1 : 0}",
  "my_points[lost_arbitration_recently]": "${model.model.lost_arbitration_recently ? 1 : 0}",
  "my_points[coupon]": "${model.model.coupon }",
	  
  };  
      int  count = 0;
      for(var tag in model.model.skills_id){
        formData.addAll({"my_points[inline_tags][selection][$count]": "$tag"});
        count++;
      }
  ...
  List<SpeedDialChild> listButton(BuildContext context,var formKey, ScrollController controller, MyPointsController my_points,
  var postMyPointsResult, State state, String? sendPath, String? id,  String? title){
    final List<SpeedDialChild> buttonChildren = <SpeedDialChild>[
    ];
	for(var i = 0; i < model.buttons.length; i++)
    {
      if(model.buttons[i].text != "Table View"){
      buttonChildren!.add(ButtonEditMyPointsWidget(model.buttons[i], context,formKey, controller,my_points, postMyPointsResult, state, sendPath, id,  title ));
      }  
    }
       return(
	        buttonChildren 
    ...
    SpeedDial	 Buttons(BuildContext context, bool?visible, var formKey, ScrollController controller, MyPointsController my_points,
  var postMyPointsResult, State state, String? sendPath, String? id,  String? title ){
     return(
	 SpeedDial(
				//marginRight: 18,
				...
				elevation: 8.0,
				shape: CircleBorder(),
				children:listButton(context, formKey,controller,my_points, postMyPointsResult, state, sendPath!, id!,  title! )
	    )
	 );
   } 

SpeedDialChild ButtonEditMyPointsWidget(Button button, BuildContext context,var formKey, ScrollController controller, MyPointsController my_points,
 var postMyPointsResult, State state, String? sendPath, String? id,  String? title){
  if(button.type == 'custom_filter'){
	...
	return(	SpeedDialChild(
		  ...
		  onTap: ()async{
		  {
                        ...
                        my_points = new  MyPointsController(AppProvider.getApplication(context),
                        sendPath,
                        AppAction.post,
                        id,
                        title,
                        formData,
						false);
                        final future = my_points.postMyPoints();
                        future.then((value) {
                        state.setState(() {
                        postMyPointsResult = value;
...
class MyPointsSuperBase {
  ...
  factory MyPointsSuperBase.fromJson(Map<String, dynamic> json) => _$MyPointsSuperBaseFromJson(json);

  Map<String, dynamic> toJson() => _$MyPointsSuperBaseToJson(this);
...
class ViewModelMyPoints {
  ...
  String? sbttl;
   ...
   //PointsPesta points_pesta;
   //PointsWorker points_worker;
   //PointsOwner points_owner;
   ...
   factory ViewModelMyPoints.fromJson(Map<String, dynamic> json) => _$ViewModelMyPointsFromJson(json);

   Map<String, dynamic> toJson() => _$ViewModelMyPointsToJson(this); 
  
}


class MyPointsViewBase{
	var model;
	Map<String, dynamic> json;
	final List<Widget> viewChildren = <Widget>[
	];
	MyPointsViewBase(this.json);
	
	
   List<SpeedDialChild>	 listButton(BuildContext context, bool?visible, var formKey, ScrollController controller, MyPointsController my_points,
	...
	for(var i = 0; i < model.buttons.length; i++)
    {
      ...
      buttonChildren!.add(ButtonViewMyPointsWidget(model.buttons[i],context,  formKey, controller, my_points,
 ...
 SpeedDialChild ButtonViewMyPointsWidget(Button button, BuildContext context,var formKey, ScrollController controller, MyPointsController my_points,
  State state, String? sendPath, String? id,  String? title, bool?account){
  if(button.type == 'custom_filter'){
    return (
	       SpeedDialChild(
	...
	return(	SpeedDialChild(
		  ...
		  onTap: ()async{
		  {
                        ...
                        null,
						false);
                        final future = my_points.downloadFile();
                        future.then((value) {
                        state.setState(() {
                       // postMyPointsResult = value;
						//AppProvider.getRouter(context)!.pop(context);	
    ...
    State state, String? sendPath, String? id,  String? title, bool? account){
	 ...
	 SpeedDial(
				...
				elevation: 8.0,
				shape: CircleBorder(),
				children:listButton(context, visible!, formKey, controller, my_points,
                                    state, sendPath, id!,  title!, account! )
	    )
	 );
   } 	
...
@JsonSerializable()
class MyPointsViewSuperBase {

  String? id;
  Meta? meta;
  List<Button?>? buttons;
  ViewModelMyPoints? model;
  MyPointsViewSuperBase(
      ...
      factory MyPointsViewSuperBase.fromJson(Map<String, dynamic> json) => _$MyPointsViewSuperBaseFromJson(json);
      Map<String, dynamic> toJson() => _$MyPointsViewSuperBaseToJson(this);
...
class MyPointsListingBase{
  var items;
  var tools;
	Map<String, dynamic> json;
	MyPointsListingBase(this.json){
		items = MyPointsListingItems.fromJson(this.json);
		tools = MyPointsListingTools.fromJson(this.json);
	}
	
  Widget viewItem (ItemMyPointsModel item,String? search, bool?account) {
	ShapeBorder? shape;
    double? height = 0;
	...
	totalHeight = totalHeight + 4 ;
	  ...
	  height = totalHeight * 50;
        ...
        child:  ItemMyPointsCard(destination :item, search : search!, shape : shape!, height : height!)
    );
  ...
  Widget viewItemId(ItemMyPointsModel item,String? search, int? index, bool?account, String? id) {
	ShapeBorder? shape;
    double? height = 0;
	double? totalHeight = 0;
	   totalHeight = totalHeight + 2 ;
	...
	totalHeight = totalHeight + 4 ;
	  ...
	  Widget viewItemIndex (ItemMyPointsModel item,String? search, int? index, bool?account) {
	ShapeBorder? shape;
    double? height = 0;
	double? totalHeight = 0;
	   totalHeight = totalHeight + 2 ;
...
Widget viewItem1 (ItemMyPointsModel item,ItemMyPointsModel item1, String? search, BuildContext context,bool?account, String? id , bool?isMax, int? max, int? index) {
	ShapeBorder? shape;
    double? height = 0;
	double? totalHeight = 0;
	    return Visibility (
	...
	Widget viewItemState (ItemMyPointsModel item,String? search, int? index, BuildContext context, bool?account, State st, VoidCallback onrefresh) {
	ShapeBorder? shape;
    double? height = 0;
	double? totalHeight = 0;
	   totalHeight = totalHeight + 2 ;
   ...
   // if(tools.buttons[i].text != "Table View"){
      ...
      buttonChildren!.add(ListButtonMyPointsWidget(tools.buttons[i],context, account));
   // }  
    }
...
class MyPointsListingItems{
  List<ItemMyPointsModel?>? items;
  MyPointsListingItems(
      this.items,
      );

  factory MyPointsListingItems.fromJson(Map<String, dynamic> json) {
  	return MyPointsListingItems(
				(json['items'] as List)
						?.map((e) => e == null
						? null
						: ItemMyPointsModel(e as Map<String, dynamic>))
						?.toList());
	}
}
...
@JsonSerializable()
class MyPointsListingTools{

	String? id;
	Meta? meta;
	List<Button?>? buttons;
	Paging? paging;
	List<ItemMyPoints?>? items;
	...
	factory MyPointsListingTools.fromJson(Map<String, dynamic> json) => _$MyPointsListingToolsFromJson(json);

	Map<String, dynamic> toJson() => _$MyPointsListingToolsToJson(this);
...
class ItemMyPointsCard extends StatelessWidget {
  const ItemMyPointsCard({ Key? key, @required this.destination, this.search, this.shape, this.height})
      : assert(destination != null),
        super(key: key);

  // This height will allow for all the Card's content to fit comfortably within the card.
  final double? height ;
  final ItemMyPointsModel? destination;
  final String? search;
            ...
            Container(
             // height: height,
              child: Card(
                ...
                shape: shape,
                child: ItemMyPointsContent(destination: destination),
              ),
            ),
          ],
        ),
...
class ItemMyPointsContent extends StatelessWidget {
  const ItemMyPointsContent({ Key? key, @required this.destination })
      : assert(destination != null),
        super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    final List<Widget>buttonChildren = <Widget>[
	  ...
	  if (destination!.item.buttons != null) {
		...
		{
		  buttonChildren!.add(itemMyPointsButton(destination,i , context));
		}
    }
...
Widget itemMyPointsButton(ItemMyPointsModel? destination, int? index, BuildContext context){
...
class ItemMyPointsWidget extends StatelessWidget {

	final ItemMyPointsModel?  item;
	final String? search;
	const  ItemMyPointsWidget({Key? key, @required this.item, this.search}) : super(key: key);
...
SpeedDialChild ListButtonMyPointsWidget(Button button, BuildContext context, bool?account){
    var cl;
	var ic;
  	if (button.color == 'green'){
  		cl = Colors.green;
