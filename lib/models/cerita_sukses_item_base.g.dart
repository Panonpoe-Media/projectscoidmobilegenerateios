...
part of 'cerita_sukses_item_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ItemCeritaSukses _$ItemCeritaSuksesFromJson(Map<String, dynamic> json) =>
    ItemCeritaSukses(
...
Map<String, dynamic> _$ItemCeritaSuksesToJson(ItemCeritaSukses instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
