...
class ItemMyFinanceBase {
	...
	ItemMyFinanceBase(this.json){
		item = ItemMyFinance.fromJson(json);
	}	
...
class ItemMyFinance{
  ...
  factory ItemMyFinance.fromJson(Map<String, dynamic> json) => _$ItemMyFinanceFromJson(json);

  Map<String, dynamic> toJson() => _$ItemMyFinanceToJson(this);
