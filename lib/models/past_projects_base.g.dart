...
part of 'past_projects_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ModelPastProjects _$ModelPastProjectsFromJson(Map<String, dynamic> json) =>
    ModelPastProjects(
      json['id'] as String?,
...
Map<String, dynamic> _$ModelPastProjectsToJson(ModelPastProjects instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
PastProjectsSuperBase _$PastProjectsSuperBaseFromJson(
    ...
    PastProjectsSuperBase(
      ...
      json['model'] == null
          ? null
          : ModelPastProjects.fromJson(json['model'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$PastProjectsSuperBaseToJson(
        PastProjectsSuperBase instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
...
ViewModelPastProjects _$ViewModelPastProjectsFromJson(
        Map<String, dynamic> json) =>
...
Map<String, dynamic> _$ViewModelPastProjectsToJson(
        ViewModelPastProjects instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
PastProjectsViewSuperBase _$PastProjectsViewSuperBaseFromJson(
        Map<String, dynamic> json) =>
    PastProjectsViewSuperBase(
      ...
      json['model'] == null
          ? null
          : ViewModelPastProjects.fromJson(
              json['model'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$PastProjectsViewSuperBaseToJson(
        PastProjectsViewSuperBase instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
      'buttons': instance.buttons,
...
PastProjectsListingTools _$PastProjectsListingToolsFromJson(
        Map<String, dynamic> json) =>
    PastProjectsListingTools(
      ...
      (json['items'] as List<dynamic>?)
          ?.map((e) => e == null
              ? null
              : ItemPastProjects.fromJson(e as Map<String, dynamic>))
          .toList(),
    );

Map<String, dynamic> _$PastProjectsListingToolsToJson(
        PastProjectsListingTools instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
      'buttons': instance.buttons,
