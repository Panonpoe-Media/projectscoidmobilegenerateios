...
class ItemTipsBase {
	...
	ItemTipsBase(this.json){
		item = ItemTips.fromJson(json);
	}	
...
class ItemTips{
  ...
  factory ItemTips.fromJson(Map<String, dynamic> json) => _$ItemTipsFromJson(json);

  Map<String, dynamic> toJson() => _$ItemTipsToJson(this);
