...
ViewModelMyProjectsRev _$ViewModelMyProjectsRevFromJson(
    ...
    ViewModelMyProjectsRev(
      ...
      json['shortlisted_bids'] == null
          ? null
          : ShortlistedBidsListingTools.fromJson(
              json['shortlisted_bids'] as Map<String, dynamic>),
...
Map<String, dynamic> _$ViewModelMyProjectsRevToJson(
        ViewModelMyProjectsRev instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
      ...
      'shortlisted_bids': instance.shortlisted_bids,
...
Map<String, dynamic> _$MyProjectsViewSuperBaseRevToJson(
        MyProjectsViewSuperBaseRev instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
