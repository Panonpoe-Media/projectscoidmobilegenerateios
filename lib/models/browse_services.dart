...
class ViewModelBrowseServicesRev {
  ...
  factory ViewModelBrowseServicesRev.fromJson(Map<String, dynamic> json) => _$ViewModelBrowseServicesRevFromJson(json);
...
class BrowseServicesViewSuperBaseRev {
  ...
  factory BrowseServicesViewSuperBaseRev.fromJson(Map<String, dynamic> json) => _$BrowseServicesViewSuperBaseRevFromJson(json);
}
/*
...
class BrowseServicesViewModel  extends BrowseServicesViewBase{
 ...
 // BrowseServicesViewModel(Map<String, dynamic> this.json):super(json);
  BrowseServicesViewModel(this.json):super(json){model = BrowseServicesViewSuperBaseRev.fromJson(json);}
  //ChatBloc? cb;

  List<dynamic> multiSelectedOption = [];
  final _selectedOptionsController = BehaviorSubject();
  Stream  get selectedOptionsToggleStream =>
      _selectedOptionsController.stream;
                    ...
                    Container(
                      ...
                      InkWell(
                        onTap: () {
                          ...
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => ShowItemScreenshots1(image : this.model!.model!.logo_url)),
                          );
                         ...
                         Container(
                           ...
                           child: Row(
                             ...
                             children: [
                               ...
                               GestureDetector(
                                 onTap: (){
                                   Share.share('${model!.meta.title} https://projects.co.id/public/browse_services/view/${this.model!.model!.service_id}/service', subject: '${model!.meta.title}');
                                 },
                                 child: CircleAvatar(
                                   backgroundColor: Colors.black12,
                                   radius: 20,
  ...
  Widget viewRating1(){
    return(
      ...
      children: [
        ...
        Text('(${this.model!.model!.rating.toString()}/10)', style: TextStyle(fontSize: 12)),
 ...
 Widget viewSales(){
    return(
      Padding(
        ...
        child:this.model!.model!.sales_count == 0 ? Text('Belum ada rating') : Text('${this.model!.model!.sales_count.toString()} kali pekerjaan selesai', style: TextStyle(fontSize: 15)),
  ...
  List<Widget> getOptions(State state){
    ...
    for(int?i=0; i!< this.model!.model!.options.length; i++){
      ...
      if(this.model!.model!.options[i]!.description != ''){
        ...
        var val = this.model!.model!.options[i]!.price.toString().replaceAll('.0','');
                  ...
                  builder: (BuildContext context, AsyncSnapshot snapshot) {
                      ...
                      return(
                          GestureDetector(
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Row(
                                  children: <Widget>[
                                    Icon(
                                      getIconData(snapshot.data, this.model!.model.options[i].toJson() ),
                                      //Icons.check_box_outline_blank_sharp,
                                      color : Colors.amber,
                                    ),
                                    Text('  ${this.model!.model!.options[i]!.description} \n  Rp. ${formatter.apply(val)},-', maxLines: 2,),
                                  ],
                                ),
                            ...
                            onTap: ()async{
                              multiSelectOption(this.model!.model!.options[i]!.toJson(), state);
                        ...
                        child: Container(
                          ...
                          child:   Column(
                            ...
                            children: <Widget>[
                              ...
                              Padding(
                                padding:
                                EdgeInsets.only(left: 20.0, right: 2.0, top: 0.0),
                                child:
                                Row(
                                    mainAxisAlignment: MainAxisAlignment.start,
                                    children: <Widget>[
                                      Text(this.model!.model!.seller_seller_rating_num.toStringAsFixed(1),style: TextStyle(fontSize: 15, fontWeight: FontWeight.w500)),
                              ...
                              Padding(
                                  padding:
                                  EdgeInsets.only(left: 15.0, right: 8.0, top: 1.0),
                        ...
                        child: Container(
                          ...
                          child:   Column(
                            ...
                            children: <Widget>[
                              ...
                              Padding(
                                padding:
                                EdgeInsets.only(left: 5.0, right: 8.0, top: 1.0),
                                child: this.model!.model!.price < 100000 ?    Html(data: readText('Low price' , 46),                                                        style: {
                                                                  "html": Style(
                                                                      fontSize: FontSize.small,
                                                                      fontWeight: FontWeight.w300
                                                                  ),
                                                                })     :  this.model!.model!.price < 500000 ? Html(data: readText(' Medium price' , 46),                                                        style: {
                                                                  "html": Style(
                                                                      fontSize: FontSize.small,
                                                                      fontWeight: FontWeight.w300
                                                                  ),
                                                                }):
                                Html(data: readText('High price' , 46),                                                        style: {
                                                                  "html": Style(
                                                                      fontSize: FontSize.small,
                                                                      fontWeight: FontWeight.w300
                                                                  ),
                        ...
                        child: Container(
                          ...
                          child:   Column(
                            ...
                            children: <Widget>[
                              ...
                              Padding(
                                padding:
                                EdgeInsets.only(left: 10.0, right: 2.0, top: 0.0),
                                child:
                                Row(
                                    mainAxisAlignment: MainAxisAlignment.start,
                                    children: <Widget>[
                                      this.model!.model!.service_reviews.items.length == 0 ?Text('0.0',style: TextStyle(fontSize: 15, fontWeight: FontWeight.w500)) :  Text(avgRating(this.model!.model!.service_reviews.items)!.toStringAsFixed(1),style: TextStyle(fontSize: 15, fontWeight: FontWeight.w500)),
                              ...
                              Padding(
                                  padding:
                                  EdgeInsets.only(left: 10.0, right: 8.0, top: 0.0),
                                  child: this.model!.model!.service_reviews.items.length == 0 ? Html(data: 'No review ' ,                                                        style: {
                                                                  "html": Style(
                                                                      fontSize: FontSize.small,
                                                                      fontWeight: FontWeight.w300
                                                                  ),
                                                                }):
                                  Html(data: this.model!.model!.service_reviews.paging.total_rows.toString()  +' reviews ' ,                                                        style: {
                                                                  "html": Style(
                                                                      fontSize: FontSize.small,
                                                                      fontWeight: FontWeight.w300
                                                                  ),
  ...
  Widget viewButton (BuildContext context, bool? account, State state, String? idHash, ChatBloc? cb){
    final size =MediaQuery.of(context).size;
    final width =size.width;
    var maskOptions = MaskOptions()
      ..reverse = true;
    ...
    return
     Column(
       ...
       crossAxisAlignment: CrossAxisAlignment.start,
       children: <Widget>[
         this.model!.model!.options == null ? Container():  this.model!.model!.options.length == 0? Container(): this.model!.model!.options[0].description != '' ?
          Padding(
            padding: EdgeInsets.only(left: 20, top: 20),
            child:           Text('Fitur tambahan:', style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold),)
         ...
         this.model!.model!.options == null ? Container() :  this.model!.model!.options.length == 0? Container():
         Column(
           children:<Widget>[
             ...getOptions(state),
           ]
             ...
             children: [
               Column(
                 children: [
                   SizedBox(height: 55,),
                   Center(
                       child:  Text('Anda belum dikenakan biaya', style: TextStyle(fontStyle: FontStyle.italic))
                   ),
                 ],
               ),
                         ...
                         //  child: Text('Buy ' +   'Rp 100.000.000,-'),
                           ...
                           Row(
                             children: [
                               ...
                               SizedBox(width: 5,),
                               Text('Buy ' +   'Rp ${formatter.apply(this.model!.model!.price.toString().replaceAll('.0',''))},-'),
                             ],
                            ),
                           ...
                           onPressed: () {
                             if(account!){
                               AppProvider.getRouter(context)!.navigateTo(
                                   context,
                                   urlToRoute('/user/browse_services/place_order/${this.model!.model!.service_id}/${this.model!.meta.title.replaceAll('/', '*')}'));
                             }else{
                               AppProvider.getRouter(context)!.navigateTo(
                                   context,
                                   '/login/1');
    ...
    return Column(
      ...
      children: [
        Padding(
            ...
            child:           Text('Seller:', style: TextStyle(fontSize: 17, fontWeight: FontWeight.w600),)
          ...
          children:<Widget>[
            GestureDetector(
              ...
              Padding(
                ...
                child:
                ShowAvatar(avatar: this.model!.model!.seller_photo_url,)
    /*
                ClipRRect(
                      ...
                      Padding(
                        ...
                        child: Column(
                            ...
                            children: <Widget>[
                              ...
                              Text('last seen ' +timeago.format(this.model!.model!.seller_last_seen), style: TextStyle(fontSize: 15)),
        ...
        Container(width : 0.0, height : 0.0)
          ...
          itemBuilder: (BuildContext context, int?index) {
            return index! >= this.model!.model!.screenshots.items.length
                ? Container(width : 0.0, height : 0.0)
                :ScreenshotsItem1(model: this.model!.model!.screenshots.items[index], info : this.model!.model!.screenshots );
          },
          ...
          child: InkWell(
              onTap: () {
                if(this.model!.model!.service_comments.items.length == 0){
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => ServiceCommentsList(id : this.model!.model!.service_id, title: this.model!.meta.title,
                        url: Env.value!.baseUrl! + '/public/browse_services/service_comments_list/'+this.model!.model!.service_id+'/'+this.model!.meta.title + '?')),
                  );
                }
                  ...
                  children: <Widget>[
                              ...
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                  children: <Widget>[
                                    ...
                                    this.model!.model!.service_comments.items.length == 0 ? Container() : Icon(Icons.arrow_forward, size: 18.0)
                                  ]
                              ),
                              ...
                              //Center(
                               // child:
                                Text('Belum ada comment', style: TextStyle(fontStyle: FontStyle.italic))
                            //  )
                              : Container(),
                              this.model!.model!.service_comments.items.length == 0 ? viewButtonReplay (context,account, userid):
                              Center(
                                child:
                                Card(
                                    elevation : 3.0,
                                   ...
                                   // color: Colors.white,
                                    ...
                                    Column(
                                        ...
                                        children: [
                                                  ...
                                                  Positioned.fill(
                                                    ...
                                                    GestureDetector(
                                                      ...
                                                      CircleAvatar(
                                                        ...
                                                        // maxRadius: 70,
                                                        // backgroundImage: AssetImage(widget._jsonMessage['avatar']),
                                                        backgroundImage: NetworkImage(this.model!.model!.service_comments.items[0].user_photo_url),
                                                      ),
                                                    ),
                                                  ),
                                            ...
                                            Column(
                                                ...
                                                children: <Widget>[
                                                    ...
                                                    children: <Widget>[
                                                      Expanded(
                                                        ...
                                                        GestureDetector(
                                                          ...
                                                          Padding(
                                                            padding: EdgeInsets.only(top: 17, right: 5),
                                                            child:Text(this.model!.model!.service_comments.items[0].user_user_name, overflow: TextOverflow.ellipsis,
                                                              textAlign: TextAlign.left,
                                                              style: descriptionStyle!.copyWith(fontSize: 17,  letterSpacing: 1, fontWeight: FontWeight.w700),
                                                            ),
                                                          ),
                                                  ...
                                                  Padding(
                                                    ...
                                                    child:
                                                    Text(
                                                      dateformat.format(this.model!.model!.service_comments.items[0].post_date) + ' ' + 'WIB',
                                                      style: descriptionStyle!.copyWith(fontSize: 12 ),
                                                    ),
                                                    /*
                                                    SmoothStarRating(
                                          ...
                                          SizedBox(height: 8,),
                                          Padding(padding: EdgeInsets.symmetric(horizontal: 25),
                                            child: HtmlWidget( this.model!.model!.service_comments.items[0].message.replaceAll('<div>', '').replaceAll('<\/div>','').replaceAll('<br>', ' ').replaceAll('<p>', '').replaceAll('<\/p>', '<br>'),
                                              //tableCellPadding : EdgeInsets.only(left : 0.0,top: 0.0,bottom: 0.0, right: 5),
                                              textStyle: TextStyle(
                                                fontSize: 15,
                                                letterSpacing: 1,
          ...
          Column(
              children: <Widget>[
                Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: <Widget>[
                      Text('About this seller', style: TextStyle(
          ...
          Column(
              children: <Widget>[
                Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: <Widget>[
                      Text('This seller rating and ranking', softWrap: true, maxLines: 2, overflow: TextOverflow.ellipsis,),
                          ...
                          child:   Column(
                            ...
                            children: <Widget>[
                              ...
                              Padding(
                                  ...
                                  child:  Html(data: this.model!.model!.seller_user_name,
                                              style: {
                                                                  "html": Style(
                                                                      fontSize: FontSize.small,
                                                                      fontWeight: FontWeight.w400
                          ...
                          child:   Column(
                            ...
                            children: <Widget>[
                              ...
                              Padding(
                                  padding:
                                  EdgeInsets.only(left: 55.0, right: 8.0),
                                  child: this.model!.model!.seller_kabupaten_str == ''? Html(data: 'Unavailable',                                                        style: {
                                                                  "html": Style(
                                                                      fontSize: FontSize.small,
                                                                      fontWeight: FontWeight.w400
                                                                  ),
                                                                }) : Html(data: this.model!.model!.seller_kabupaten_str,                                                        style: {
                                                                  "html": Style(
                                                                      fontSize: FontSize.small,
                                                                      fontWeight: FontWeight.w400
                                                                  ),
                          ...
                          child:   Column(
                            ...
                            children: <Widget>[
                              ...
                              Padding(
                                  ...
                                  child:
                                  RatingBarIndicator(
                                    rating: model!.model!.seller_seller_rating.toDouble()/2-0.01,
                                    itemBuilder: (context, index) => Icon(
                                      Icons.star,
                                      color: CurrentTheme.PrimaryLightColor,
                                    ),
                          ...
                          child:   Column(
                            ...
                            children: <Widget>[
                              ...
                              Padding(
                                  padding:
                                  EdgeInsets.only(left: 55.0, right: 8.0),
                                  child: model!.model!.seller_seller_rating_num_str == ''? Html(data: 'Unavailable',                                                        style: {
                                                                  "html": Style(
                                                                      fontSize: FontSize.small,
                                                                      fontWeight: FontWeight.w400
                                                                  ),
                                                                }) : Html(data: model!.model!.seller_seller_rating_num_str,                                                        style: {
                                                                  "html": Style(
                                                                      fontSize: FontSize.small,
                                                                      fontWeight: FontWeight.w400
                                                                  ),
                          ...
                          child:   Column(
                            ...
                            children: <Widget>[
                              ...
                              Padding(
                                  padding:
                                  EdgeInsets.only(left: 55.0, right: 8.0),
                                  child: model!.model!.seller_seller_ranking_str == '' ? Html(data: 'Unavailable',
                                      style: {
                                                                  "html": Style(
                                                                      fontSize: FontSize.small,
                                                                      fontWeight: FontWeight.w400
                                                                  ),
                                                                }) : Html(data: model!.model!.seller_seller_ranking_str,
                                      style: {
                                                                  "html": Style(
                                                                      fontSize: FontSize.small,
                                                                      fontWeight: FontWeight.w400
        ...
        child: InkWell(
            ...
            Column(
                children: <Widget>[
                  ...
                  HtmlWidget( readText(this.model!.model!.description.replaceAll('<div>', '').replaceAll('<\/div>','').replaceAll('<br>', ' ').replaceAll('<p>', '').replaceAll('<\/p>', '<br>'), 150)),
                ]
            )
  ...
  Widget viewButtonReplay (BuildContext context,bool? account, String? userid){
    ...
    return  ButtonBarTheme(
      ...
      child: ButtonBar(
          ...
          children: <Widget>[
            RaisedButton(
                child: userid == this.model!.model!.seller_id? Text('Jawab Pertanyaan ') : Text('Tanya Seller '),
    ...
    if(model!.model!.tags_url != null){
      return( 	ChannelRouteTagsWidget(
        ...
        getValue: (String? val) {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => PublicBrowseServicesListing(id: val!.split('?')[1], cb: cb)),
          );
          ...
          children: <Widget>[
            InkWell(
              onTap: () {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => ShowItemScreenshots1(image : this.model!.image_url)),
                );
              },
              child: Container(
                height: 120.0,
                    ...
                    padding: const EdgeInsets.fromLTRB(20.0, 14.0, 20.0, 2.0),
                      child : HtmlWidget(this.info!.description!.replaceAll('<div>', '').replaceAll('<\/div>','').replaceAll('<br>', ' ').replaceAll('<p>', '').replaceAll('<\/p>', '<br>'),
                        ...
                        onTapImage:(src) =>  Navigator.push(context,
                          MaterialPageRoute(builder: (context) => ShowItemScreenshots1(image:'${src.sources.first.url}')),
                        ),
                      )
                  ),
                ]
...
class BrowseServicesListingModel extends BrowseServicesListingBase{
  ...
  Widget viewItemIndex (ItemBrowseServicesModel item,String? search, int?index, bool? account) {
    ...
    return Visibility (
        ...
        child:  ItemBrowseServicesCard1(destination :item, search : search, shape : shape, height : height, index : index, account : account)
    );
  }
  ...
  Widget viewItem (ItemBrowseServicesModel item,String? search, bool? account) {
    ...
    return Visibility (
        visible: (search == '' || allModelWords(jsonEncode(item.item.toJson()))!.contains(search!)),
        child:  ItemBrowseServicesCard3(destination :item, search : search, shape : shape, height : height, account : account, idHash : '')
    );
  }


  //@override
  Widget viewItemId1(ItemBrowseServicesModel item,String? search, int?index, bool? account, String? id, ChatBloc? cb ) {
    ShapeBorder? shape;
    double? height = 210;
    return Visibility (
        visible: (search == '' || allModelWords(jsonEncode(item.item.toJson()))!.contains(search!)),
  ...
  SpeedDialChild floatChild (BuildContext  context){
    return SpeedDialChild(
      ...
      onTap: ()=>{  Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => SearchBrowseServicesListing1(id : '', title : '')),
      )
      },
    );
  }
...
class  SearchBrowseServicesListing1 extends StatefulWidget {
  ...
  bool? account;
  ChatBloc? cb;
  SearchBrowseServicesListing1({Key? key, this.id, this.title, this.account, this.cb}) : super(key: key);
  @override
  SearchBrowseServicesListing1State createState() =>  SearchBrowseServicesListing1State();
}

class  SearchBrowseServicesListing1State extends State< SearchBrowseServicesListing1>  with RestorationMixin{
  String? title = 'Browse Services';
  bool? _dialVisible = true;
  bool? search = false;
  String? getPath = Env.value!.baseUrl! + '/public/browse_services/listing?page=%d';
  ...
  Widget build(BuildContext context) {
    search = true;
    if( widget.id == ''){
      getPath = Env.value!.baseUrl! + '/public/browse_services/listing?page=%d&' + 'search=' + searchText!;
    }else{
      getPath = Env.value!.baseUrl! + '/public/browse_services/listing/' + widget.id! + '?page=%d';
    }
    ...
    browse_services =  BrowseServicesController(AppProvider.getApplication(context),getPath, AppAction.listing,'','','', search );
            ...
            if (state.browse_services!.tools.buttons.length == 0){
              ...
              return
                Scaffold(
                    ...
                    floatingActionButton: state.browse_services!.Buttons(context, _dialVisible, account)
                  ...
                  RefreshIndicator(
                    child :  ListView.builder(
                      itemBuilder: (BuildContext context, int?index) {
                        ...
                        state.browse_services!.tools.paging.total_pages == state.browse_services!.tools.paging.current_page?
                        Container(height: 0.0, width: 0.0,):
                        SearchBrowseServicesBottomLoader1()
                        // viewItemIndex(ItemBlogModel item,String? search, int?index, bool? account)
                            : state.browse_services!.viewItemId1 (state.browse_services!.items!.items[index] , searchText, index,  account, userid, widget.cb );
...
class ItemBrowseServicesCard1 extends StatelessWidget {
  const ItemBrowseServicesCard1({ Key? key, @required this.destination, this.search, this.shape, this.height, this.index, this.account})
...
class ItemBrowseServicesCard2 extends StatelessWidget {
  const ItemBrowseServicesCard2({ Key? key, @required this.destination, this.search, this.shape, this.height, this.account})
      : assert(destination != null),
        super(key: key);
  // This height will allow for all the Card's content to fit comfortably within the card.
  final double? height ;
    ...
    return SafeArea(
      ...
      child:  Column(
          children: <Widget>[
            ...
            SizedBox(
              height: height,
              child: ItemBrowseServicesContent1(destination: destination, account: account),
            ),
            // ),
            Container(
              // padding: const EdgeInsets.all(8.0),
...
class ItemBrowseServicesContent1 extends StatelessWidget {
  const ItemBrowseServicesContent1({ Key? key, @required this.destination, this.account })
      : assert(destination != null),
        super(key: key);
      ...
      SizedBox(
        ...
        child: Stack(
          ...
          children: <Widget>[
            ...
            Positioned.fill(
                bottom: 25,
                left: 0.80 * mediaQueryData.size.width - destination!.item!.price_str.length.toDouble() * 1.3,
                top:  0.82 * 230.0,
                right: 30.0 - destination!.item!.price_str.length.toDouble() * 0.8,
                // In order to have the ink splash appear above the image, you
                // must use Ink.image. This allows the image to be painted as part
                // of the Material and display ink effects above it. Using a
                // standard Image will obscure the ink splash.
                ...
                Container(
                  ...
                  child: Text( destination!.item!.price_str ,style: TextStyle(color: CurrentTheme.BackgroundColor),
                          ...
                          children : <Widget>[
                            ...
                            Row(
                                children: <Widget>[
                                  ...
                                  Text(
                                    destination!.item!.seller_product_sold.toString() + ' sales',
                                    style: descriptionStyle!.copyWith(color: Colors.black54, fontSize: 13),
                                  )
...
class ItemBrowseServicesContent2 extends StatelessWidget {
  const ItemBrowseServicesContent2({ Key? key, @required this.destination, this.account })
      : assert(destination != null),
        super(key: key);
    ...
    final List<Widget> children = <Widget>[
              ...
              children:<Widget>[
                GestureDetector(
                  onTap: () {
                    AppProvider.getRouter(context)!.navigateTo(
                        context,
                        urlToRoute(destination!.item!.seller_url));
                  },
                  child:
                  Padding(
                    padding: EdgeInsets.only( top: 5, bottom:5, left:12),
                                ...
                                Row(
                                  children:<Widget>[
                                    Padding(
                                        ...
                                        child:
                                        RatingBarIndicator(
                                          rating: destination!.item!.seller_seller_rating.toDouble()/2-0.01,
                                          itemBuilder: (context, index) => Icon(
                                            Icons.star,
                                            color: CurrentTheme.PrimaryLightColor,
                                          ),
                                ...
                                MaterialPageRoute(
                                  builder: (_) => ChatScreen(
                                    user: {
                                      ...
                                      "userid":"${encode(destination!.item!.seller_id)}",
                    ...
                    GestureDetector(
                      onTap:(){
                        if(account!){
                          AppProvider.getRouter(context)!.navigateTo(
                              context,
                              urlToRoute('/user/browse_services/place_order/${destination!.item!.service_id}/${destination!.item!.title.replaceAll('/', '*')}' ));
                        }else{
                          AppProvider.getRouter(context)!.navigateTo(
                              context,
                              '/login/1');
      ...
      GestureDetector(
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => PublicBrowseServicesView(id:'${urlToRoute(destination!.item!.buttons[1].url ).split('/')[4]}', title: '${urlToRoute(destination!.item!.buttons[1].url ).split('/')[5]}', cb: cb)),
          );
          /*
          AppProvider.getRouter(context)!.navigateTo(
              context,
                    ...
                    Padding(
                      ...
                      GestureDetector(
                        onTap: (){
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => PublicBrowseServicesListing(id: destination!.item!.tags_url[0].split('?')[1], cb: cb)),
                          );
                        ...
                        Badge(
                          ...
                          badgeContent: Text(_capitalize(destination!.item!.tags_str[0])!, style:TextStyle(
                              fontSize: 11,
                              color: Colors.white,
                              fontWeight: FontWeight.w300) ),
                        ),
                    ...
                    Padding(
                      ...
                      GestureDetector(
                        onTap: (){
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => PublicBrowseServicesListing(id: destination!.item!.tags_url[1].split('?')[1], cb: cb)),
                          );
                        ...
                        Badge(
                          ...
                          badgeColor: Colors.black12,
                          borderRadius: BorderRadius.circular(8),
                          badgeContent: Text(_capitalize(destination!.item!.tags_str[1])!, style:TextStyle(
                              fontSize: 11,
                              color: Colors.white,
                              fontWeight: FontWeight.w300) ),
                        ),
                          ...
                          Row(
                            children:<Widget>[
                              Padding(
                                  ...
                                  child:
                                  RatingBarIndicator(
                                    rating: destination!.item!.rating.toDouble()/2-0.01,
                                    itemBuilder: (context, index) => Icon(
                                      Icons.star,
                                      color: CurrentTheme.PrimaryLightColor,
                                    ),
