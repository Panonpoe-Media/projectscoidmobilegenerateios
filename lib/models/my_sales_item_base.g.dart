...
part of 'my_sales_item_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ItemMySales _$ItemMySalesFromJson(Map<String, dynamic> json) => ItemMySales(
...
Map<String, dynamic> _$ItemMySalesToJson(ItemMySales instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
ItemIndexMySales _$ItemIndexMySalesFromJson(Map<String, dynamic> json) =>
    ItemIndexMySales(
      (json['buttons'] as List<dynamic>?)
          ?.map((e) =>
              e == null ? null : ItemButton.fromJson(e as Map<String, dynamic>))
...
Map<String, dynamic> _$ItemIndexMySalesToJson(ItemIndexMySales instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
