...
part 'as_project_worker_add_base.g.dart';
...
class AddModelAsProjectWorker {
  ...
  String? admin_notes;
    ...
    factory AddModelAsProjectWorker.fromJson(Map<String, dynamic> json) => _$AddModelAsProjectWorkerFromJson(json);

  Map<String, dynamic> toJson() => _$AddModelAsProjectWorkerToJson(this);
...
class AsProjectWorkerAddBase{
	var model;
	Map<String, dynamic> json;
	AsProjectWorkerAddBase(this.json){
