...
part of 'portofolio_add_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

AddModelPortofolio _$AddModelPortofolioFromJson(Map<String, dynamic> json) =>
    AddModelPortofolio(
      json['id'] as String?,
      json['portofolio_id'] as int?,
      json['user_id'] as int?,
...
Map<String, dynamic> _$AddModelPortofolioToJson(AddModelPortofolio instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
PortofolioSuperBase _$PortofolioSuperBaseFromJson(Map<String, dynamic> json) =>
    PortofolioSuperBase(
      ...
      json['model'] == null
          ? null
          : AddModelPortofolio.fromJson(json['model'] as Map<String, dynamic>),
    );
