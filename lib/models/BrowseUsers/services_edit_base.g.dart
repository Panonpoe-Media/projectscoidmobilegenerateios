...
part of 'services_edit_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

EditModelServices _$EditModelServicesFromJson(Map<String, dynamic> json) =>
    EditModelServices(
      json['id'] as String?,
...
Map<String, dynamic> _$EditModelServicesToJson(EditModelServices instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
ServicesSuperBase _$ServicesSuperBaseFromJson(Map<String, dynamic> json) =>
    ServicesSuperBase(
      json['id'] as String?,
      ...
      json['model'] == null
          ? null
          : EditModelServices.fromJson(json['model'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$ServicesSuperBaseToJson(ServicesSuperBase instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
