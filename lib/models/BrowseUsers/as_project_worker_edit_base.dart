...
part 'as_project_worker_edit_base.g.dart';
...
Widget RButtonActionAsProjectWorkerWidget(Button button, BuildContext context,var formKey, ScrollController controller,  SubModelController as_project_worker,
 var postAsProjectWorkerResult, State state, String? sendPath, String? id,  String? title,  var formData){
  var cl;
  var ic;
		 ...
		 children: <Widget>[
             ...
             // color : Color(0xFF037f51),
              onPressed: () async  {
                        ...
                        as_project_worker =      SubModelController(AppProvider.getApplication(context),
                        sendPath,
                        formData);
                        final future = as_project_worker.sendData();
                        future.then((value) {
                        state.setState(() {
                        postAsProjectWorkerResult = value;
                        });
                        }).catchError((Error){
...
SpeedDialChild ButtonEditAsProjectWorkerWidget(Button button, BuildContext context,var formKey, ScrollController controller, SubModelController as_project_worker,
 var postAsProjectWorkerResult, State state, String? sendPath, String? id,  String? title, var formData){
  if(button.type == 'custom_filter'){
    return (
	       SpeedDialChild(
...
class EditModelAsProjectWorker {
  int?    age;
  int?    cnt;
  int?    page;
  String? id;
  ...
  String? admin_notes;
    ...
    factory EditModelAsProjectWorker.fromJson(Map<String, dynamic> json) => _$EditModelAsProjectWorkerFromJson(json);

  Map<String, dynamic> toJson() => _$EditModelAsProjectWorkerToJson(this);
...
class AsProjectWorkerSuperBase {

  String? id;
  Meta? meta;
  List<Button?>? buttons;
  EditModelAsProjectWorker? model;
  AsProjectWorkerSuperBase(
	  this.id,
	  this.buttons,
	  this.meta,
	  this.model,
  ...
  factory AsProjectWorkerSuperBase.fromJson(Map<String, dynamic> json) => _$AsProjectWorkerSuperBaseFromJson(json);

  Map<String, dynamic> toJson() => _$AsProjectWorkerSuperBaseToJson(this);
...
class EditAsProjectWorkerBase{
	var model;
	Map<String, dynamic> json;
	EditAsProjectWorkerBase(this.json){
		model = AsProjectWorkerSuperBase.fromJson(this.json);
	}
	
   Map<String, dynamic> convertFormDataEdit(var data){
      var formData = {
      "user_projects_worker[_trigger_]":"",
  "user_projects_worker[owner_id]": "${model.model.owner_id }",
  "user_projects_worker[category_id]": "${model.model.category_id }",
  "user_projects_worker[title]": "${model.model.title }",
  "user_projects_worker[description]": "${model.model.description }",
  "user_projects_worker[short_description]": "${model.model.short_description }",
  "user_projects_worker[attachments]": '[{"name":"${model.model.attachments[0].name}","size":${model.model.attachments[0].size.toString()},"created":${model.model.attachments[0].date.toString()},"modified":${model.model.attachments[0].date.toString()},"temp":"${model.model.attachments[0].temp}","remote":"","dir":"temp"}]',
  "user_projects_worker[finish_days]": "${model.model.finish_days }",
  "user_projects_worker[search_text]": "${model.model.search_text }",
  "user_projects_worker[last_bump]": "${model.model.last_bump}",
  "user_projects_worker[select_deadline]": "${model.model.select_deadline}",
  "user_projects_worker[start_date]": "${model.model.start_date}",
  "user_projects_worker[finish_deadline]": "${model.model.finish_deadline}",
  "user_projects_worker[finish_date]": "${model.model.finish_date}",
  "user_projects_worker[closed_date]": "${model.model.closed_date}",
  "user_projects_worker[bid_count]": "${model.model.bid_count }",
  "user_projects_worker[progress]": "${model.model.progress }",
   "user_projects_worker[project_status_id]": "${model.model.project_status_id}",
   "user_projects_worker[project_ending_id]": "${model.model.project_ending_id}",
   "user_projects_worker[project_type_id]": "${model.model.project_type_id}",
   "user_projects_worker[project_class_id]": "${model.model.project_class_id}",
  "user_projects_worker[published_budget]": "${model.model.published_budget}",
  "user_projects_worker[fee_percent]": "${model.model.fee_percent }",
  "user_projects_worker[service_id]": "${model.model.service_id }",
  "user_projects_worker[private_worker_id]": "${model.model.private_worker_id }",
  "user_projects_worker[invited_users]": "${model.model.invited_users }",
  "user_projects_worker[accepted_bid_id]": "${model.model.accepted_bid_id }",
  "user_projects_worker[accepted_worker_id]": "${model.model.accepted_worker_id }",
  "user_projects_worker[accepted_budget]": "${model.model.accepted_budget}",
  "user_projects_worker[accepted_work_id]": "${model.model.accepted_work_id }",
  "user_projects_worker[accepted_date]": "${model.model.accepted_date}",
  "user_projects_worker[available_budget]": "${model.model.available_budget}",
  "user_projects_worker[need_weekly_report]": "${model.model.need_weekly_report}",
  "user_projects_worker[weekly_report_needed]": "${model.model.weekly_report_needed}",
  "user_projects_worker[weekly_report_posted]": "${model.model.weekly_report_posted}",
  "user_projects_worker[deadline_passed_sent]": "${model.model.deadline_passed_sent}",
  "user_projects_worker[deadline_approaching_sent]": "${model.model.deadline_approaching_sent}",
  "user_projects_worker[rating_for_worker]": "${model.model.rating_for_worker }",
  "user_projects_worker[work_quality]": "${model.model.work_quality }",
  "user_projects_worker[expertise]": "${model.model.expertise }",
  "user_projects_worker[worker_communication]": "${model.model.worker_communication }",
  "user_projects_worker[worker_professionalism]": "${model.model.worker_professionalism }",
  "user_projects_worker[worker_rating]": "${model.model.worker_rating }",
  "user_projects_worker[worker_rating_num]": "${model.model.worker_rating_num}",
  "user_projects_worker[worker_feedback]": "${model.model.worker_feedback }",
  "user_projects_worker[rating_for_owner]": "${model.model.rating_for_owner }",
  "user_projects_worker[clarity]": "${model.model.clarity }",
  "user_projects_worker[friendliness]": "${model.model.friendliness }",
  "user_projects_worker[owner_communication]": "${model.model.owner_communication }",
  "user_projects_worker[owner_professionalism]": "${model.model.owner_professionalism }",
  "user_projects_worker[owner_rating]": "${model.model.owner_rating }",
  "user_projects_worker[owner_rating_num]": "${model.model.owner_rating_num}",
  "user_projects_worker[owner_feedback]": "${model.model.owner_feedback }",
  "user_projects_worker[owner_signature_ip]": "${model.model.owner_signature_ip }",
  "user_projects_worker[owner_signature_date]": "${model.model.owner_signature_date}",
  "user_projects_worker[worker_signature_ip]": "${model.model.worker_signature_ip }",
  "user_projects_worker[worker_signature_date]": "${model.model.worker_signature_date}",
  "user_projects_worker[owner_escrow_id]": "${model.model.owner_escrow_id }",
  "user_projects_worker[worker_credit_id]": "${model.model.worker_credit_id }",
  "user_projects_worker[arbitration_id]": "${model.model.arbitration_id }",
  "user_projects_worker[owner_credit_id]": "${model.model.owner_credit_id }",
  "user_projects_worker[registered_by_id]": "${model.model.registered_by_id }",
  "user_projects_worker[registered_date]": "${model.model.registered_date}",
  "user_projects_worker[registered_from_ip]": "${model.model.registered_from_ip }",
  "user_projects_worker[canceled_by_id]": "${model.model.canceled_by_id }",
  "user_projects_worker[canceled_date]": "${model.model.canceled_date}",
  "user_projects_worker[canceled_from_ip]": "${model.model.canceled_from_ip }",
  "user_projects_worker[published_by_id]": "${model.model.published_by_id }",
  "user_projects_worker[published_date]": "${model.model.published_date}",
  "user_projects_worker[published_from_ip]": "${model.model.published_from_ip }",
  "user_projects_worker[rejected_by_id]": "${model.model.rejected_by_id }",
  "user_projects_worker[rejected_date]": "${model.model.rejected_date}",
  "user_projects_worker[rejected_from_ip]": "${model.model.rejected_from_ip }",
  "user_projects_worker[admin_note]": "${model.model.admin_note }",
  "user_projects_worker[announced]": "${model.model.announced}",
  "user_projects_worker[your_wishes]": "${model.model.your_wishes }",
  "user_projects_worker[extend_deadline_days]": "${model.model.extend_deadline_days }",
  "user_projects_worker[testimony]": "${model.model.testimony }",
  "user_projects_worker[pick_user_name]": "${model.model.pick_user_name }",
  "user_projects_worker[enter_email_address]": "${model.model.enter_email_address }",
  "user_projects_worker[handphone]": "${model.model.handphone }",
  "user_projects_worker[broadcast_message]": "${model.model.broadcast_message }",
  "user_projects_worker[attach_file]": '[{"name":"${model.model.attach_file[0].name}","size":${model.model.attach_file[0].size.toString()},"created":${model.model.attach_file[0].date.toString()},"modified":${model.model.attach_file[0].date.toString()},"temp":"${model.model.attach_file[0].temp}","remote":"","dir":"temp"}]',
  "user_projects_worker[automatic_send_to_new_bidder]": "${model.model.automatic_send_to_new_bidder}",
  "user_projects_worker[is_system_message]": "${model.model.is_system_message}",
  "user_projects_worker[admin_notes]": "${model.model.admin_notes }",
	  
  };  
      int count = 0;
      for(var tag in model.model.channels_id){
        formData.addAll({"user_projects_worker[inline_tags][selection][$count]": "$tag"});
        count++;
      }
  ...
  List<Widget> RlistButton(BuildContext context,var formKey, ScrollController controller, SubModelController as_project_worker,
  var postAsProjectWorkerResult, State state, String? sendPath, String? id,  String? title){
  var formData = convertFormDataEdit(model);  
	...
	for(var i = 0; i < model.buttons.length; i++)
    {
      ...
      buttonChildren.add(RButtonActionAsProjectWorkerWidget(model.buttons[i], context,formKey, controller,as_project_worker, postAsProjectWorkerResult, state, sendPath, id,  title, formData));
      }
    }
       return(
	        buttonChildren 
  ...
  List<SpeedDialChild> listButton(BuildContext context,var formKey, ScrollController controller, SubModelController as_project_worker,
  var postAsProjectWorkerResult, State state, String? sendPath, String? id,  String? title){
	var formData = convertFormDataEdit(model);   
	...
	for(var i = 0; i < model.buttons.length; i++)
    {
      buttonChildren.add(ButtonEditAsProjectWorkerWidget(model.buttons[i], context,formKey, controller,as_project_worker, postAsProjectWorkerResult, state, sendPath, id,  title, formData ));
    }
       return(
	        buttonChildren 
	   );
       ...
       Widget	 RButtons(BuildContext context, bool? visible, var formKey, ScrollController controller, SubModelController as_project_worker,
  var postAsProjectWorkerResult, State state, String? sendPath, String? id,  String? title ){
    //  final size =MediaQuery.of(context).size;
    double? width = 400;
    ...
    return(
        ButtonBarTheme(
            ...
            child: ButtonBar(
                ...
                buttonMinWidth: 0.9 * width,
                children:
           RlistButton(context, formKey,controller,as_project_worker, postAsProjectWorkerResult, state, sendPath, id,  title )
    ...
    SpeedDial	 Buttons(BuildContext context, bool? visible, var formKey, ScrollController controller, SubModelController as_project_worker,
  var postAsProjectWorkerResult, State state, String? sendPath, String? id,  String? title ){
     return(
	 SpeedDial(
				...
				elevation: 8.0,
				shape: CircleBorder(),
				children:listButton(context, formKey,controller,as_project_worker, postAsProjectWorkerResult, state, sendPath, id,  title )
	    )
	 );
   } 	
