...
part 'user_arbitrations_add_base.g.dart';
...
class AddModelUserArbitrations {
   int?   age;
   int?   cnt;
   int?   page;
  String? id;
  ...
  String? owner_receives_str;
    ...
    factory AddModelUserArbitrations.fromJson(Map<String, dynamic> json) => _$AddModelUserArbitrationsFromJson(json);

  Map<String, dynamic> toJson() => _$AddModelUserArbitrationsToJson(this);
...
class UserArbitrationsSuperBase {
  ...
  Meta? meta;
  List<Button?>? buttons;
  AddModelUserArbitrations? model;
...
class UserArbitrationsAddBase{
	var model;
	Map<String, dynamic> json;
	UserArbitrationsAddBase(this.json){
