...
part of 'as_project_worker_add_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

AddModelAsProjectWorker _$AddModelAsProjectWorkerFromJson(
...
Map<String, dynamic> _$AddModelAsProjectWorkerToJson(
        AddModelAsProjectWorker instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
AsProjectWorkerSuperBase _$AsProjectWorkerSuperBaseFromJson(
    ...
    AsProjectWorkerSuperBase(
      ...
      json['model'] == null
          ? null
          : AddModelAsProjectWorker.fromJson(
