...
part 'products_view_base.g.dart';
...
class ViewModelProducts {
  ...
  String? rating_div_str;
   ...
   factory ViewModelProducts.fromJson(Map<String, dynamic> json) => _$ViewModelProductsFromJson(json);

   Map<String, dynamic> toJson() => _$ViewModelProductsToJson(this); 
  
}

@JsonSerializable()
class ProductsViewSuperBase {

  String? id;
  Meta? meta;
  List<Button?>? buttons;
  ViewModelProducts? model;
  ProductsViewSuperBase(
      this.id,
      this.buttons,
      this.meta,
      this.model,
  ...
  factory ProductsViewSuperBase.fromJson(Map<String, dynamic> json) => _$ProductsViewSuperBaseFromJson(json);
  Map<String, dynamic> toJson() => _$ProductsViewSuperBaseToJson(this);
   
}

class ProductsViewBase{
	var model;
	Map<String, dynamic> json;
	ProductsViewBase(this.json){
		model = ProductsViewSuperBase.fromJson(this.json);
	}
   ...
   List<SpeedDialChild>	 listButton(BuildContext context){
    ...
    {
      buttonChildren.add(ListButtonProductsWidget(model.buttons[i],context));
    }
