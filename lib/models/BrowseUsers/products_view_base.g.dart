...
part of 'products_view_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ViewModelProducts _$ViewModelProductsFromJson(Map<String, dynamic> json) =>
    ViewModelProducts(
      json['id'] as String?,
...
Map<String, dynamic> _$ViewModelProductsToJson(ViewModelProducts instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
ProductsViewSuperBase _$ProductsViewSuperBaseFromJson(
    ...
    ProductsViewSuperBase(
      ...
      json['model'] == null
          ? null
          : ViewModelProducts.fromJson(json['model'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$ProductsViewSuperBaseToJson(
        ProductsViewSuperBase instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
