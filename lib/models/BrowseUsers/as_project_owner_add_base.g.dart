...
part of 'as_project_owner_add_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

AddModelAsProjectOwner _$AddModelAsProjectOwnerFromJson(
...
Map<String, dynamic> _$AddModelAsProjectOwnerToJson(
        AddModelAsProjectOwner instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
AsProjectOwnerSuperBase _$AsProjectOwnerSuperBaseFromJson(
    ...
    AsProjectOwnerSuperBase(
      ...
      json['model'] == null
          ? null
          : AddModelAsProjectOwner.fromJson(
