...
part 'as_project_worker_view_base.g.dart';
...
@JsonSerializable()
class ViewModelAsProjectWorker {
  int?    age;
  int?    cnt;
  int?    page;
  String? id;
  ...
  String? admin_notes;
   ...
   factory ViewModelAsProjectWorker.fromJson(Map<String, dynamic> json) => _$ViewModelAsProjectWorkerFromJson(json);

   Map<String, dynamic> toJson() => _$ViewModelAsProjectWorkerToJson(this); 
  
}

@JsonSerializable()
class AsProjectWorkerViewSuperBase {

  String? id;
  Meta? meta;
  List<Button?>? buttons;
  ViewModelAsProjectWorker? model;
  AsProjectWorkerViewSuperBase(
      this.id,
      this.buttons,
      this.meta,
      this.model,
  ...
  factory AsProjectWorkerViewSuperBase.fromJson(Map<String, dynamic> json) => _$AsProjectWorkerViewSuperBaseFromJson(json);
  Map<String, dynamic> toJson() => _$AsProjectWorkerViewSuperBaseToJson(this);
   
}

class AsProjectWorkerViewBase{
	var model;
	Map<String, dynamic> json;
	AsProjectWorkerViewBase(this.json){
		model = AsProjectWorkerViewSuperBase.fromJson(this.json);
	}
   ...
   List<SpeedDialChild>	 listButton(BuildContext context){
    ...
    {
      buttonChildren.add(ListButtonAsProjectWorkerWidget(model.buttons[i],context));
    }
