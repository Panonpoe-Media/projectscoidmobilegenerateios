...
part 'as_project_owner_add_base.g.dart';
...
class AddModelAsProjectOwner {
  ...
  String? admin_notes;
    ...
    factory AddModelAsProjectOwner.fromJson(Map<String, dynamic> json) => _$AddModelAsProjectOwnerFromJson(json);

  Map<String, dynamic> toJson() => _$AddModelAsProjectOwnerToJson(this);
...
class AsProjectOwnerAddBase{
	var model;
	Map<String, dynamic> json;
	AsProjectOwnerAddBase(this.json){
