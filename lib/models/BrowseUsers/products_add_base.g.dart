...
part of 'products_add_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

AddModelProducts _$AddModelProductsFromJson(Map<String, dynamic> json) =>
    AddModelProducts(
      json['id'] as String?,
...
Map<String, dynamic> _$AddModelProductsToJson(AddModelProducts instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
ProductsSuperBase _$ProductsSuperBaseFromJson(Map<String, dynamic> json) =>
    ProductsSuperBase(
      ...
      json['model'] == null
          ? null
          : AddModelProducts.fromJson(json['model'] as Map<String, dynamic>),
    );
