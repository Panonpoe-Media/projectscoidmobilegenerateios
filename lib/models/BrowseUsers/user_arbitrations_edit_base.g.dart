...
part of 'user_arbitrations_edit_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

EditModelUserArbitrations _$EditModelUserArbitrationsFromJson(
...
Map<String, dynamic> _$EditModelUserArbitrationsToJson(
        EditModelUserArbitrations instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
UserArbitrationsSuperBase _$UserArbitrationsSuperBaseFromJson(
    ...
    UserArbitrationsSuperBase(
      ...
      json['model'] == null
          ? null
          : EditModelUserArbitrations.fromJson(
