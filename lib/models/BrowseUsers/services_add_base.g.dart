...
part of 'services_add_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

AddModelServices _$AddModelServicesFromJson(Map<String, dynamic> json) =>
    AddModelServices(
      json['id'] as String?,
...
Map<String, dynamic> _$AddModelServicesToJson(AddModelServices instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
ServicesSuperBase _$ServicesSuperBaseFromJson(Map<String, dynamic> json) =>
    ServicesSuperBase(
      ...
      json['model'] == null
          ? null
          : AddModelServices.fromJson(json['model'] as Map<String, dynamic>),
    );
