...
part 'as_project_owner_view_base.g.dart';
...
class ViewModelAsProjectOwner {
  ...
  String? admin_notes;
   ...
   factory ViewModelAsProjectOwner.fromJson(Map<String, dynamic> json) => _$ViewModelAsProjectOwnerFromJson(json);

   Map<String, dynamic> toJson() => _$ViewModelAsProjectOwnerToJson(this); 
  
}

@JsonSerializable()
class AsProjectOwnerViewSuperBase {

  String? id;
  Meta? meta;
  List<Button?>? buttons;
  ViewModelAsProjectOwner? model;
  ...
  factory AsProjectOwnerViewSuperBase.fromJson(Map<String, dynamic> json) => _$AsProjectOwnerViewSuperBaseFromJson(json);
  Map<String, dynamic> toJson() => _$AsProjectOwnerViewSuperBaseToJson(this);
   
}

class AsProjectOwnerViewBase{
	var model;
	Map<String, dynamic> json;
	AsProjectOwnerViewBase(this.json){
		model = AsProjectOwnerViewSuperBase.fromJson(this.json);
	}
   ...
   List<SpeedDialChild>	 listButton(BuildContext context){
    ...
    {
      buttonChildren.add(ListButtonAsProjectOwnerWidget(model.buttons[i],context));
    }
