...
class ViewModelBrowseProductsRev{
  ...
  factory ViewModelBrowseProductsRev.fromJson(Map<String, dynamic> json) => _$ViewModelBrowseProductsRevFromJson(json);
...
class BrowseProductsViewSuperBaseRev {
  ...
  factory BrowseProductsViewSuperBaseRev.fromJson(Map<String, dynamic> json) => _$BrowseProductsViewSuperBaseRevFromJson(json);
...
//  BrowseProductsViewModel(Map<String, dynamic> this.json):super(json);
  BrowseProductsViewModel(Map<String, dynamic> this.json):super(json){model = BrowseProductsViewSuperBaseRev.fromJson(this.json);}
  //ChatBloc _chatBloc;
                            ...
                            children : <Widget>[
                              ...
                              GestureDetector(
                                ...
                                child: Html(
                                    ...
                                    data :filterShortcodes(readText(this.model!.model!.seller_str , 54)),
                                    style: {
                                      "html": Style(
                        ...
                        child: Container(
                          ...
                          child:   Column(
                            ...
                            children: <Widget>[
                              ...
                              Padding(
                                padding:
                                EdgeInsets.only(left: 20.0, right: 2.0, top: 4.0),
                                child:
                                Row(
                                  mainAxisAlignment: MainAxisAlignment.start,
                                  children: <Widget>[
                              ...
                              Padding(
                                  padding:
                                  EdgeInsets.only(left: 20.0, right: 8.0, top: 5.0),
                        ...
                        child: Container(
                          ...
                          child:   Column(
                            ...
                            children: <Widget>[
                              ...
                              Padding(
                                padding:
                                EdgeInsets.only(left: 10.0, right: 2.0, top: 4.0),
                                child:
                                Row(
                                    mainAxisAlignment: MainAxisAlignment.start,
                                    children: <Widget>[
                                      this.model!.model!.product_reviews.items.length == 0 ?Text('0.0',style: TextStyle(fontSize: 15, fontWeight: FontWeight.w500)) :  Text(avgRating(this.model!.model!.product_reviews.items)!.toStringAsFixed(1),style: TextStyle(fontSize: 15, fontWeight: FontWeight.w500)),
                              ...
                              Padding(
                                  padding:
                                  EdgeInsets.only(left: 10.0, right: 8.0, top: 5.0),
                                  child: this.model!.model!.product_reviews.items.length == 0 ? Html(data: 'No review ' ,
                                                                                              style: {
                                                                  "html": Style(
                                                                      fontSize: FontSize.small,
                                                                      fontWeight: FontWeight.w300
                                  ...
                                  Html(data: this.model!.model!.product_reviews.paging.total_rows.toString()  +' reviews ' ,
                                                               style: {
                                                                  "html": Style(
                                                                      fontSize: FontSize.small,
                                                                      fontWeight: FontWeight.w300
      ...
      return(
          Column(
            children: [
              Padding(
                padding: EdgeInsets.only(left: 20, bottom: 10),
                child:Text('Trial version: available [${model!.model!.trial_version_name}]'),
              ),
  ...
  Widget viewButton (BuildContext context, bool? account,   String? idHash, ChatBloc? cb){
    final size =MediaQuery.of(context)!.size;
    final width =size.width;
        ...
        Container(width : 0.0, height : 0.0)
          ...
          itemBuilder: (BuildContext context, int?index) {
            return index! >= this.model!.model!.screenshots.items.length
                ? Container(width : 0.0, height : 0.0)
                :ScreenshotsItem(model: this.model!.model!.screenshots.items[index], info : this.model!.model!.screenshots );
          },
  ...
  Widget viewReview(BuildContext context){
    ...
    return this.model!.model!.product_reviews.items.length == 0 ? Container(height:0.0, width: 0.0,):
    Padding(
        padding: const EdgeInsets.fromLTRB(
            20.0, 8.0, 8.0, 20.0),
        child: InkWell(
            onTap: () {
              ...
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => ProductReviewsList(id : this.model!.model!.product_id, title: this.model!.meta.title!,
                    url: Env.value!.baseUrl! + '/public/browse_products/product_reviews_list/'+this.model!.model!.product_id+'/'+this.model!.meta.title + '?')),
              );
            },
            child:
            Column(
                children: <Widget>[
                  Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: <Widget>[
                        Text('Buyer reviews',style: TextStyle(fontSize: 17, fontWeight: FontWeight.w600 ),),
                        Icon(Icons.arrow_forward, size: 18.0)
                      ]
                  ),
                  Center(
                                  ...
                                  Positioned.fill(
                                    ...
                                    GestureDetector(
                                      ...
                                      CircleAvatar(
                                        ...
                                        backgroundImage: new NetworkImage(this.model!.model!.product_reviews.items[0].buyer_photo_url),
                                      ),
                                      ...
                                      Expanded(
                                        ...
                                        GestureDetector(
                                          ...
                                          Padding(
                                            ...
                                            child:Text(this.model!.model!.product_reviews.items[0].buyer_str, overflow: TextOverflow.ellipsis,
                  ...
                  */
                                  ...
                                  Padding(
                                    ...
                                    child:
                                      ...
                                      Text(
                                      dateformat.format(this.model!.model!.product_reviews.items[0].date) + ' ' + 'WIB',
               ...
               */
                          ...
                          Center(
                            child:
                            RatingBarIndicator(
                              rating: this.model!.model!.product_reviews.items[0].rating.toDouble()/2-0.01,
                          ...
                          Center(
                            child: Text(this.model!.model!.product_reviews.items[0].rating.toString() + '/10', style: TextStyle(fontSize: 12)),
                          ),
                          SizedBox(height: 8,),
                          Padding(padding: EdgeInsets.symmetric(horizontal: 25),
                            child: HtmlWidget( this.model!.model!.product_reviews.items[0].testimony.replaceAll('<div>', '').replaceAll('<\/div>','').replaceAll('<br>', ' ').replaceAll('<p>', '').replaceAll('<\/p>', '<br>'),
                              //tableCellPadding : EdgeInsets.only(left : 0.0,top: 0.0,bottom: 0.0, right: 5),
                              textStyle: TextStyle(
                                fontSize: 15,
                                letterSpacing: 1,
          ...
          child: InkWell(
              onTap: () {
                if(this.model!.model!.product_comments.items.length == 0){
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => ProductCommentsList(id : this.model!.model!.product_id, title: this.model!.meta.title!,
                        url: Env.value!.baseUrl! + '/public/browse_products/product_comments_list/'+this.model!.model!.product_id+'/'+this.model!.meta.title + '?')),
                  );
                }
              ...
              Column(
                  children: <Widget>[
                              ...
                              this.model!.model!.product_comments.items.length == 0 ? viewButtonReplay (context,account, userid):
                              Center(
                                child:
                                Card(
                                    elevation : 3.0,
                                    ...
                                    Column(
                                        ...
                                        children: [
                                                  ...
                                                  Positioned.fill(
                                                    ...
                                                    GestureDetector(
                                                      ...
                                                      CircleAvatar(
                                                        ...
                                                        // maxRadius: 70,
                                                        // backgroundImage: AssetImage(widget._jsonMessage['avatar']),
                                                        backgroundImage: new NetworkImage(this.model!.model!.product_comments.items[0].user_photo_url),
                                                      ),
                                                    ),
                                                  ),
                                            ...
                                            Column(
                                                ...
                                                children: <Widget>[
                                                    ...
                                                    children: <Widget>[
                                                      Expanded(
                                                        ...
                                                        GestureDetector(
                                                          ...
                                                          Padding(
                                                            padding: EdgeInsets.only(top: 17, right: 5),
                                                            child:Text(this.model!.model!.product_comments.items[0].user_user_name, overflow: TextOverflow.ellipsis,
                                                              textAlign: TextAlign.left,
                                                              style: descriptionStyle!.copyWith(fontSize: 17,  letterSpacing: 1, fontWeight: FontWeight.w700),
                                                            ),
                                                          ),
                                                  ...
                                                  Padding(
                                                    ...
                                                    child:
                                                    Text(
                                                      dateformat.format(this.model!.model!.product_comments.items[0].post_date) + ' ' + 'WIB',
                                                      style: descriptionStyle!.copyWith(fontSize: 12 ),
                                                    ),
                                                    /*
                                                    SmoothStarRating(
                                          ...
                                          SizedBox(height: 8,),
                                          Padding(padding: EdgeInsets.symmetric(horizontal: 25),
                                            child: HtmlWidget( this.model!.model!.product_comments.items[0].message.replaceAll('<div>', '').replaceAll('<\/div>','').replaceAll('<br>', ' ').replaceAll('<p>', '').replaceAll('<\/p>', '<br>'),
                                              //tableCellPadding : EdgeInsets.only(left : 0.0,top: 0.0,bottom: 0.0, right: 5),
                                              textStyle: TextStyle(
                                                fontSize: 15,
                                                letterSpacing: 1,
                ...
                onPressed: () {
                  if(account!){
                    AppProvider.getRouter(context)!.navigateTo(context,
                        '/public/browse_products/product_comments_new_reply/' + this.model!.model!.product_id +'/' + this.model!.meta.title.replaceAll('/', ''));
                  }else{
                    AppProvider.getRouter(context)!.navigateTo(
                        context,
                        '/login/1');
                          ...
                          child:   Column(
                            ...
                            children: <Widget>[
                              ...
                              Padding(
                                  padding:
                                  EdgeInsets.only(left: 55.0, right: 8.0),
                                  child: this.model!.model!.seller_kabupaten_str == ''? Html(data: 'Unavailable',
                                                                                              style: {
                                                                  "html": Style(
                                                                      fontSize: FontSize.small,
                                                                      fontWeight: FontWeight.w400
                                  ...
                                  ) : Html(data: this.model!.model!.seller_kabupaten_str,
                                          style: {
                                                                  "html": Style(
                                                                      fontSize: FontSize.small,
                                                                      fontWeight: FontWeight.w400
                          ...
                          child:   Column(
                            ...
                            children: <Widget>[
                              ...
                              Padding(
                                  padding:
                                  EdgeInsets.only(left: 55.0, right: 8.0),
                                  child: model!.model!.seller_seller_ranking_str == '' ? Html(data: 'Unavailable',                                                        style: {
                                                                  "html": Style(
                                                                      fontSize: FontSize.small,
                                                                      fontWeight: FontWeight.w400
                                                                  ),
                                                                }) : Html(data: model!.model!.seller_seller_ranking_str,                                                        style: {
                                                                  "html": Style(
                                                                      fontSize: FontSize.small,
                                                                      fontWeight: FontWeight.w400
                                                                  ),
            ...
            actions: <Widget>[
              Padding(
                  ...
                  child: GestureDetector(
                    onTap: () {
                      Share.share('${model!.meta.title} https://projects.co.id/public/browse_products/view/${this.model!.model!.product_id}/product', subject: '${model!.meta.title}');
                    },
                    child: Icon(
                      Icons.share,
                      size: 26.0,
                                 ...
                                 builder: (_) =>
                                     ChatScreen(
                                       user: {
                                         ...
                                         "thread": "$thread",
                                         "username": "${this.model!.model
                                             .seller_user_name}",
                                         "userid": "${encode(this.model!.model
                                             .seller_id)}",
                                         "display": "${this.model!.model
                                             .seller_user_name}",
                                         "avatar": "${this.model!.model
                                             .seller_photo_url}",
                                         "lastmessage":"<b>Konteks Percakapan: ${model!.meta.title}</b>",
                                         "lasttime": "1234567890"
                                       },
  ...
  Widget viewButton1 (BuildContext context, bool? account,String idHash, ChatBloc cb){
    final size =MediaQuery.of(context)!.size;
    final width =size.width;
                        ...
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              GestureDetector(
                                onTap: (){
                                  Share.share('${model!.meta.title} https://projects.co.id/public/browse_products/view/${this.model!.model!.service_id}/product', subject: '${model!.meta.title}');
                                },
                                child: CircleAvatar(
                                  backgroundColor: Colors.black12,
                                  radius: 20,
  ...
  Widget viewSales(){
    return(
        Padding(
          padding: EdgeInsets.only(left: 20, bottom: 10),
          child:this.model!.model!.sales_count == 0 ? Text('Belum ada rating') : Text('${this.model!.model!.sales_count.toString()} produk terjual', style: TextStyle(fontSize: 15)),
...
//@override
Widget view1(BuildContext context, ScrollController controller, bool? account,  String? userid, ChatBloc? cb,  String? idHash) {
          ...
          children: <Widget>[
            InkWell(
              onTap: () {
               ...
               Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => ShowItemScreenshots(image : this.model?.image_url)),
                );
...
class BrowseProductsListingModel extends BrowseProductsListingBase{
  ...
  Widget viewItemIndex (ItemBrowseProductsModel item,String? search, int?index, bool? account) {
    ...
    return Visibility (
        ...
        child:  ItemBrowseProductsCard1(destination :item, search : search, shape : shape, height : height, index : index)
    );
  }
  ...
  Widget viewItem (ItemBrowseProductsModel item,String? search, bool? account) {
   ...
   // double? height = 302;
    ...
    return Visibility (
        visible: (search == '' || allModelWords(jsonEncode(item.item.toJson()))!.contains(search!)),
        child:  ItemBrowseProductsCard3(destination :item, search : search, shape : shape, height : height, account:account, idHash : '')
      //  child:  ItemBrowseProductsCard2(destination :item, search : search, shape : shape, height : height)
    );
  }
  @override
  Widget viewItemId1 (ItemBrowseProductsModel item,String? search, int?index,  bool? account,  String? id, ChatBloc? cb) {
    ShapeBorder? shape;
    // double? height = 302;
    double? height = 220;
  ...
  SpeedDialChild floatChild (BuildContext  context){
    return SpeedDialChild(
      ...
      onTap: ()=>{  Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => SearchBrowseProductsListing(id : '', title : '')),
      )
        },
    );
  }
...
class  SearchBrowseProductsListing extends StatefulWidget {
  ...
  bool? account;
  ChatBloc? cb;
  SearchBrowseProductsListing({Key? key, this.id, this.title, this.account, this.cb}) : super(key: key);
  @override
  SearchBrowseProductsListingState createState() =>  SearchBrowseProductsListingState();
}

class  SearchBrowseProductsListingState extends State< SearchBrowseProductsListing> with RestorationMixin{
  ...
  Widget build(BuildContext context) {
    search = true;
    if(widget.id ==''){
      getPath = Env.value!.baseUrl! + '/public/browse_products/listing?page=%d&' + 'search=' + searchText!;
    }else{
      getPath = Env.value!.baseUrl! + '/public/browse_products/listing/' + widget.id! +'?page=%d';
    }
...
class ItemBrowseProductsCard1 extends StatelessWidget {
  const ItemBrowseProductsCard1({ Key? key, @required this.destination, this.search, this.shape, this.height, this.index})
          ...
          child: Column(
            children: <Widget>[
              ...
              SizedBox(
                ...
                child: index == 0 ? ItemBrowseProductsContent2(destination: destination) :ItemBrowseProductsContent1(destination: destination),
              ),
...
class ItemBrowseProductsCard2 extends StatelessWidget {
  const ItemBrowseProductsCard2({ Key? key, @required this.destination, this.search, this.shape, this.height})
      : assert(destination != null),
        super(key: key);
  final double? height ;
  final ItemBrowseProductsModel? destination;
      ...
      Container(
        ...
        GestureDetector(
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => PublicBrowseProductsView(id:'${urlToRoute(destination!.item.buttons[2].url ).split('/')[4]}', title: '${urlToRoute(destination!.item.buttons[2].url).split('/')[5]}', cb: cb)),
              );
              /*
              AppProvider.getRouter(context)!.navigateTo(
                  context,
