...
class ItemMyPurchasesBase {
	...
	ItemMyPurchasesBase(this.json){
		item = ItemMyPurchases.fromJson(json);
	}	
...
class ItemMyPurchases{
  ...
  factory ItemMyPurchases.fromJson(Map<String, dynamic> json) => _$ItemMyPurchasesFromJson(json);

  Map<String, dynamic> toJson() => _$ItemMyPurchasesToJson(this);
...
class ItemIndexMyPurchasesBase {
	var item;
	Map<String, dynamic> json;
	ItemIndexMyPurchasesBase(this.json){
		item = ItemIndexMyPurchases.fromJson(json);
	}	
  ...
  return( 
    Text('${index.toString()}')
        ...
        return( 
          ...
          child: Text(item.seller_str),
        ));} 
  Widget viewHeaderSeller () {
      return(
        Text('Seller')
       );
      }
...
class ItemIndexMyPurchases{
  ...
  factory ItemIndexMyPurchases.fromJson(Map<String, dynamic> json) => _$ItemIndexMyPurchasesFromJson(json);

  Map<String, dynamic> toJson() => _$ItemIndexMyPurchasesToJson(this);
