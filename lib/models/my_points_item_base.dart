...
class ItemMyPointsBase {
	...
	ItemMyPointsBase(this.json){
		item = ItemMyPoints.fromJson(json);
	}	
...
class ItemMyPoints{
  ...
  factory ItemMyPoints.fromJson(Map<String, dynamic> json) => _$ItemMyPointsFromJson(json);

  Map<String, dynamic> toJson() => _$ItemMyPointsToJson(this);
