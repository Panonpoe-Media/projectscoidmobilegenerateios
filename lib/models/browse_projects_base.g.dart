...
part of 'browse_projects_base.dart';
...
ModelActionPlaceNewBidBrowseProjects
    _$ModelActionPlaceNewBidBrowseProjectsFromJson(Map<String, dynamic> json) =>
        ModelActionPlaceNewBidBrowseProjects(
          json['id'] as String?,
...
Map<String, dynamic> _$ModelActionPlaceNewBidBrowseProjectsToJson(
        ModelActionPlaceNewBidBrowseProjects instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
PlaceNewBidBrowseProjectsSuperBase _$PlaceNewBidBrowseProjectsSuperBaseFromJson(
    ...
    PlaceNewBidBrowseProjectsSuperBase(
      ...
      json['model'] == null
          ? null
          : ModelActionPlaceNewBidBrowseProjects.fromJson(
              json['model'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$PlaceNewBidBrowseProjectsSuperBaseToJson(
        PlaceNewBidBrowseProjectsSuperBase instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
...
ModelActionAskOwnerBrowseProjects _$ModelActionAskOwnerBrowseProjectsFromJson(
        Map<String, dynamic> json) =>
...
Map<String, dynamic> _$ModelActionAskOwnerBrowseProjectsToJson(
        ModelActionAskOwnerBrowseProjects instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
AskOwnerBrowseProjectsSuperBase _$AskOwnerBrowseProjectsSuperBaseFromJson(
        Map<String, dynamic> json) =>
    AskOwnerBrowseProjectsSuperBase(
      ...
      json['model'] == null
          ? null
          : ModelActionAskOwnerBrowseProjects.fromJson(
              json['model'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$AskOwnerBrowseProjectsSuperBaseToJson(
        AskOwnerBrowseProjectsSuperBase instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
      'buttons': instance.buttons,
...
ModelActionGuestCreateProjectBrowseProjects
    _$ModelActionGuestCreateProjectBrowseProjectsFromJson(
            Map<String, dynamic> json) =>
        ModelActionGuestCreateProjectBrowseProjects(
          json['id'] as String?,
          json['project_id'] as String?,
          json['pick_user_name'] as String?,
          json['enter_email_address'] as String?,
          ...
          (json['channels_url'] as List<dynamic>?)
              ?.map((e) => e as String?)
              .toList(),
          (json['channels_list'] as List<dynamic>?)
              ?.map((e) => e as int?)
              .toList(),
...
Map<String, dynamic> _$ModelActionGuestCreateProjectBrowseProjectsToJson(
        ModelActionGuestCreateProjectBrowseProjects instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
GuestCreateProjectBrowseProjectsSuperBase
    _$GuestCreateProjectBrowseProjectsSuperBaseFromJson(
            Map<String, dynamic> json) =>
        GuestCreateProjectBrowseProjectsSuperBase(
          json['id'] as String?,
          (json['buttons'] as List<dynamic>?)
          ...
          json['model'] == null
              ? null
              : ModelActionGuestCreateProjectBrowseProjects.fromJson(
                  json['model'] as Map<String, dynamic>),
        );

Map<String, dynamic> _$GuestCreateProjectBrowseProjectsSuperBaseToJson(
        GuestCreateProjectBrowseProjectsSuperBase instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
      'buttons': instance.buttons,
...
ModelBrowseProjects _$ModelBrowseProjectsFromJson(Map<String, dynamic> json) =>
    ModelBrowseProjects(
      json['id'] as String?,
      json['project_id'] as String?,
...
Map<String, dynamic> _$ModelBrowseProjectsToJson(
        ModelBrowseProjects instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
BrowseProjectsSuperBase _$BrowseProjectsSuperBaseFromJson(
        Map<String, dynamic> json) =>
    BrowseProjectsSuperBase(
      ...
      json['model'] == null
          ? null
          : ModelBrowseProjects.fromJson(json['model'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$BrowseProjectsSuperBaseToJson(
        BrowseProjectsSuperBase instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
      'buttons': instance.buttons,
...
ViewModelBrowseProjects _$ViewModelBrowseProjectsFromJson(
        Map<String, dynamic> json) =>
    ViewModelBrowseProjects(
      ...
      json['owner_projects_arbitrated'] as int?,
      json['owner_projects_arbitrated_str'] as String?,
      json['owner_projects_won_in_arbitration'] as int?,
      json['owner_projects_won_in_arbitration_str'] as String?,
      json['owner_projects_lost_in_arbitration'] as int?,
      json['owner_projects_lost_in_arbitration_str'] as String?,
      (json['worker_rating_num'] as num?)?.toDouble(),
      json['worker_rating_num_str'] as String?,
      ...
      json['accepted_worker_projects_won'] as int?,
      json['accepted_worker_projects_won_str'] as String?,
      json['accepted_worker_projects_completed'] as int?,
      json['accepted_worker_projects_completed_str'] as String?,
      ...
      ..owner_last_seen = json['owner_last_seen'] as String?
      ..accepted_worker_worker_rating =
          json['accepted_worker_worker_rating'] as int?;

Map<String, dynamic> _$ViewModelBrowseProjectsToJson(
        ViewModelBrowseProjects instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
      ...
      'owner_last_seen': instance.owner_last_seen,
      'owner_projects_owned': instance.owner_projects_owned,
      'owner_projects_owned_str': instance.owner_projects_owned_str,
      'owner_projects_arbitrated': instance.owner_projects_arbitrated,
      'owner_projects_arbitrated_str': instance.owner_projects_arbitrated_str,
      'owner_projects_won_in_arbitration':
          instance.owner_projects_won_in_arbitration,
      'owner_projects_won_in_arbitration_str':
          instance.owner_projects_won_in_arbitration_str,
      'owner_projects_lost_in_arbitration':
          instance.owner_projects_lost_in_arbitration,
      'owner_projects_lost_in_arbitration_str':
          instance.owner_projects_lost_in_arbitration_str,
      'worker_rating_num': instance.worker_rating_num,
      'worker_rating_num_str': instance.worker_rating_num_str,
      'worker_feedback': instance.worker_feedback,
      ...
      'accepted_worker_projects_won': instance.accepted_worker_projects_won,
      'accepted_worker_projects_won_str':
          instance.accepted_worker_projects_won_str,
      'accepted_worker_projects_completed':
          instance.accepted_worker_projects_completed,
      'accepted_worker_projects_completed_str':
          instance.accepted_worker_projects_completed_str,
      'owner_feedback': instance.owner_feedback,
    };

BrowseProjectsViewSuperBase _$BrowseProjectsViewSuperBaseFromJson(
        Map<String, dynamic> json) =>
    BrowseProjectsViewSuperBase(
      ...
      json['model'] == null
          ? null
          : ViewModelBrowseProjects.fromJson(
              json['model'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$BrowseProjectsViewSuperBaseToJson(
        BrowseProjectsViewSuperBase instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
      'buttons': instance.buttons,
...
BrowseProjectsListingTools _$BrowseProjectsListingToolsFromJson(
        Map<String, dynamic> json) =>
    BrowseProjectsListingTools(
      ...
      (json['items'] as List<dynamic>?)
          ?.map((e) => e == null
              ? null
              : ItemBrowseProjects.fromJson(e as Map<String, dynamic>))
          .toList(),
    );

Map<String, dynamic> _$BrowseProjectsListingToolsToJson(
        BrowseProjectsListingTools instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
      'buttons': instance.buttons,
