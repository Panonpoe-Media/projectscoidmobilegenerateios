...
part of 'points_buyer_add_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

AddModelPointsBuyer _$AddModelPointsBuyerFromJson(Map<String, dynamic> json) =>
    AddModelPointsBuyer(
      json['id'] as String?,
...
Map<String, dynamic> _$AddModelPointsBuyerToJson(
        AddModelPointsBuyer instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
PointsBuyerSuperBase _$PointsBuyerSuperBaseFromJson(
    ...
    PointsBuyerSuperBase(
      ...
      json['model'] == null
          ? null
          : AddModelPointsBuyer.fromJson(json['model'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$PointsBuyerSuperBaseToJson(
        PointsBuyerSuperBase instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
