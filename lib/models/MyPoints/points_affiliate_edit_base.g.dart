...
part of 'points_affiliate_edit_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

EditModelPointsAffiliate _$EditModelPointsAffiliateFromJson(
...
Map<String, dynamic> _$EditModelPointsAffiliateToJson(
        EditModelPointsAffiliate instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
PointsAffiliateSuperBase _$PointsAffiliateSuperBaseFromJson(
        Map<String, dynamic> json) =>
    PointsAffiliateSuperBase(
      ...
      json['model'] == null
          ? null
          : EditModelPointsAffiliate.fromJson(
              json['model'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$PointsAffiliateSuperBaseToJson(
        PointsAffiliateSuperBase instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
