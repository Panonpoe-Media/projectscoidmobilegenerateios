...
part of 'points_buyer_view_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ViewModelPointsBuyer _$ViewModelPointsBuyerFromJson(
...
Map<String, dynamic> _$ViewModelPointsBuyerToJson(
        ViewModelPointsBuyer instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
PointsBuyerViewSuperBase _$PointsBuyerViewSuperBaseFromJson(
        Map<String, dynamic> json) =>
    PointsBuyerViewSuperBase(
      ...
      json['model'] == null
          ? null
          : ViewModelPointsBuyer.fromJson(
              json['model'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$PointsBuyerViewSuperBaseToJson(
        PointsBuyerViewSuperBase instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
