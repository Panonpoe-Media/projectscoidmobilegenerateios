...
import '../photo.dart';
import '../paging.dart';
part 'points_owner_list_item_base.g.dart';

class ItemPointsOwnerBase {
	var item;
	Map<String, dynamic> json;
	ItemPointsOwnerBase(this.json){
		item = ItemPointsOwner.fromJson(json);
	}	
...
class ItemPointsOwner{
  ...
  factory ItemPointsOwner.fromJson(Map<String, dynamic> json) => _$ItemPointsOwnerFromJson(json);

  Map<String, dynamic> toJson() => _$ItemPointsOwnerToJson(this);
