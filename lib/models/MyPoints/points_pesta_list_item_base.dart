...
import '../photo.dart';
import '../paging.dart';
part 'points_pesta_list_item_base.g.dart';

class ItemPointsPestaBase {
	var item;
	Map<String, dynamic> json;
	ItemPointsPestaBase(this.json){
		item = ItemPointsPesta.fromJson(json);
	}	
...
class ItemPointsPesta{
  ...
  factory ItemPointsPesta.fromJson(Map<String, dynamic> json) => _$ItemPointsPestaFromJson(json);

  Map<String, dynamic> toJson() => _$ItemPointsPestaToJson(this);
