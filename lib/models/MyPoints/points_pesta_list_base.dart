...
import 'points_pesta_list_item_base.dart';
import '../photo.dart';
import '../paging.dart';
part 'points_pesta_list_base.g.dart';


class PointsPestaListingBase{
  var items;
  var tools;
	Map<String, dynamic> json;
	PointsPestaListingBase(this.json){
		items = PointsPestaListingItems.fromJson(this.json);
		tools = PointsPestaListingTools.fromJson(this.json);
	}
	
  Widget viewItem (ItemPointsPestaModel item,String? search, bool? account, String? id) {
	ShapeBorder? shape;
    double height = 0;
	double totalHeight = 0;
	  ...
	  height = totalHeight * 50;
        ...
        child:  ItemPointsPestaCard(destination :item, search : search, shape : shape, height: height)
    );
  ...
  Widget viewItem1 (ItemPointsPestaModel item,ItemPointsPestaModel item1, String search, BuildContext context,bool account, String id , bool isMax, int max, int index) {
   ...
   List<SpeedDialChild>	 listButton(BuildContext context, String id){
    ...
    {
      buttonChildren.add(ListButtonPointsPestaWidget(tools.buttons[i],context));
    }
...
class PointsPestaListingItems{
  List<ItemPointsPestaModel?>? items;
  PointsPestaListingItems(
      this.items,
      );

  factory PointsPestaListingItems.fromJson(Map<String, dynamic> json) {
  	return PointsPestaListingItems(
				(json['items'] as List)
						?.map((e) => e == null
						? null
						: ItemPointsPestaModel(e as Map<String, dynamic>))
						?.toList());
	}
}
...
@JsonSerializable()
class PointsPestaListingTools{

	String? id;
	Meta? meta;
	List<Button?>? buttons;
	Paging? paging;
	List<ItemPointsPesta?>? items;
	...
	factory PointsPestaListingTools.fromJson(Map<String, dynamic> json) => _$PointsPestaListingToolsFromJson(json);

	Map<String, dynamic> toJson() => _$PointsPestaListingToolsToJson(this);
...
class ItemPointsPestaCard extends StatelessWidget {
  const ItemPointsPestaCard({ Key? key, @required this.destination, this.search, this.shape, this.height})
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: Card(
                ...
                shape: shape,
                child: ItemPointsPestaContent(destination: destination),
              ),
            ),
          ],
        ),
...
class ItemPointsPestaContent extends StatelessWidget {
  const ItemPointsPestaContent({ Key? key, @required this.destination })
      : assert(destination != null),
        super(key: key);
...
Widget itemPointsPestaButton(ItemPointsPestaModel destination, int? index, BuildContext context){
...
class ItemPointsPestaWidget extends StatelessWidget {

	final ItemPointsPestaModel? item;
	final String? search;
	const  ItemPointsPestaWidget({Key? key, @required this.item, this.search}) : super(key: key);
