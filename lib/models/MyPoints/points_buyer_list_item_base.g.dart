...
part of 'points_buyer_list_item_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ItemPointsBuyer _$ItemPointsBuyerFromJson(Map<String, dynamic> json) =>
    ItemPointsBuyer(
...
Map<String, dynamic> _$ItemPointsBuyerToJson(ItemPointsBuyer instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
