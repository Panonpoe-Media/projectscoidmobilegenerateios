...
part of 'points_owner_list_item_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ItemPointsOwner _$ItemPointsOwnerFromJson(Map<String, dynamic> json) =>
    ItemPointsOwner(
...
Map<String, dynamic> _$ItemPointsOwnerToJson(ItemPointsOwner instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
