...
part of 'points_owner_view_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ViewModelPointsOwner _$ViewModelPointsOwnerFromJson(
...
Map<String, dynamic> _$ViewModelPointsOwnerToJson(
        ViewModelPointsOwner instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
PointsOwnerViewSuperBase _$PointsOwnerViewSuperBaseFromJson(
        Map<String, dynamic> json) =>
    PointsOwnerViewSuperBase(
      ...
      json['model'] == null
          ? null
          : ViewModelPointsOwner.fromJson(
              json['model'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$PointsOwnerViewSuperBaseToJson(
        PointsOwnerViewSuperBase instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
