...
part of 'points_affiliate_view_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ViewModelPointsAffiliate _$ViewModelPointsAffiliateFromJson(
...
Map<String, dynamic> _$ViewModelPointsAffiliateToJson(
        ViewModelPointsAffiliate instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
PointsAffiliateViewSuperBase _$PointsAffiliateViewSuperBaseFromJson(
        Map<String, dynamic> json) =>
    PointsAffiliateViewSuperBase(
      ...
      json['model'] == null
          ? null
          : ViewModelPointsAffiliate.fromJson(
              json['model'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$PointsAffiliateViewSuperBaseToJson(
        PointsAffiliateViewSuperBase instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
