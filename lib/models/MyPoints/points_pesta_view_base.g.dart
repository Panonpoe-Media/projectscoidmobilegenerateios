...
part of 'points_pesta_view_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ViewModelPointsPesta _$ViewModelPointsPestaFromJson(
...
Map<String, dynamic> _$ViewModelPointsPestaToJson(
        ViewModelPointsPesta instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
PointsPestaViewSuperBase _$PointsPestaViewSuperBaseFromJson(
        Map<String, dynamic> json) =>
    PointsPestaViewSuperBase(
      ...
      json['model'] == null
          ? null
          : ViewModelPointsPesta.fromJson(
              json['model'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$PointsPestaViewSuperBaseToJson(
        PointsPestaViewSuperBase instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
