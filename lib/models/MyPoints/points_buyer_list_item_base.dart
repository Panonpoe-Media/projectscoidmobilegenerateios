...
import '../photo.dart';
import '../paging.dart';
part 'points_buyer_list_item_base.g.dart';

class ItemPointsBuyerBase {
	var item;
	Map<String, dynamic> json;
	ItemPointsBuyerBase(this.json){
		item = ItemPointsBuyer.fromJson(json);
	}	
...
class ItemPointsBuyer{
  ...
  factory ItemPointsBuyer.fromJson(Map<String, dynamic> json) => _$ItemPointsBuyerFromJson(json);

  Map<String, dynamic> toJson() => _$ItemPointsBuyerToJson(this);
