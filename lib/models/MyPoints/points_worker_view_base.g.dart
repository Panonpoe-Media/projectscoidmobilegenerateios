...
part of 'points_worker_view_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ViewModelPointsWorker _$ViewModelPointsWorkerFromJson(
...
Map<String, dynamic> _$ViewModelPointsWorkerToJson(
        ViewModelPointsWorker instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
PointsWorkerViewSuperBase _$PointsWorkerViewSuperBaseFromJson(
        Map<String, dynamic> json) =>
    PointsWorkerViewSuperBase(
      ...
      json['model'] == null
          ? null
          : ViewModelPointsWorker.fromJson(
              json['model'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$PointsWorkerViewSuperBaseToJson(
        PointsWorkerViewSuperBase instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
