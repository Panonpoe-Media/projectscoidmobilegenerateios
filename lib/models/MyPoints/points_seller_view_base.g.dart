...
part of 'points_seller_view_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ViewModelPointsSeller _$ViewModelPointsSellerFromJson(
...
Map<String, dynamic> _$ViewModelPointsSellerToJson(
        ViewModelPointsSeller instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
PointsSellerViewSuperBase _$PointsSellerViewSuperBaseFromJson(
        Map<String, dynamic> json) =>
    PointsSellerViewSuperBase(
      ...
      json['model'] == null
          ? null
          : ViewModelPointsSeller.fromJson(
              json['model'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$PointsSellerViewSuperBaseToJson(
        PointsSellerViewSuperBase instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
