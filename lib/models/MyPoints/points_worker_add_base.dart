...
part 'points_worker_add_base.g.dart';
...
class AddModelPointsWorker {
  ...
  String? balance_str;
    ...
    factory AddModelPointsWorker.fromJson(Map<String, dynamic> json) => _$AddModelPointsWorkerFromJson(json);

  Map<String, dynamic> toJson() => _$AddModelPointsWorkerToJson(this);
...
class PointsWorkerAddBase{
	var model;
	Map<String, dynamic> json;
	PointsWorkerAddBase(this.json){
