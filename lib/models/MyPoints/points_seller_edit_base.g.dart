...
part of 'points_seller_edit_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

EditModelPointsSeller _$EditModelPointsSellerFromJson(
...
Map<String, dynamic> _$EditModelPointsSellerToJson(
        EditModelPointsSeller instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
PointsSellerSuperBase _$PointsSellerSuperBaseFromJson(
        Map<String, dynamic> json) =>
    PointsSellerSuperBase(
      ...
      json['model'] == null
          ? null
          : EditModelPointsSeller.fromJson(
              json['model'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$PointsSellerSuperBaseToJson(
        PointsSellerSuperBase instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
