...
import '../photo.dart';
import '../paging.dart';
part 'points_seller_list_item_base.g.dart';

class ItemPointsSellerBase {
	var item;
	Map<String, dynamic> json;
	ItemPointsSellerBase(this.json){
		item = ItemPointsSeller.fromJson(json);
	}	
...
class ItemPointsSeller{
  ...
  factory ItemPointsSeller.fromJson(Map<String, dynamic> json) => _$ItemPointsSellerFromJson(json);

  Map<String, dynamic> toJson() => _$ItemPointsSellerToJson(this);
