...
part of 'points_worker_add_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

AddModelPointsWorker _$AddModelPointsWorkerFromJson(
        Map<String, dynamic> json) =>
    AddModelPointsWorker(
      json['id'] as String?,
...
Map<String, dynamic> _$AddModelPointsWorkerToJson(
        AddModelPointsWorker instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
PointsWorkerSuperBase _$PointsWorkerSuperBaseFromJson(
        Map<String, dynamic> json) =>
    PointsWorkerSuperBase(
      ...
      json['model'] == null
          ? null
          : AddModelPointsWorker.fromJson(
              json['model'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$PointsWorkerSuperBaseToJson(
        PointsWorkerSuperBase instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
