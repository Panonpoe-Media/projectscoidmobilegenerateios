...
part of 'points_worker_edit_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

EditModelPointsWorker _$EditModelPointsWorkerFromJson(
...
Map<String, dynamic> _$EditModelPointsWorkerToJson(
        EditModelPointsWorker instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
PointsWorkerSuperBase _$PointsWorkerSuperBaseFromJson(
    ...
    PointsWorkerSuperBase(
      ...
      json['model'] == null
          ? null
          : EditModelPointsWorker.fromJson(
