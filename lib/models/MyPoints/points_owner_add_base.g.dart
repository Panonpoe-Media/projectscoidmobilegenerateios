...
part of 'points_owner_add_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

AddModelPointsOwner _$AddModelPointsOwnerFromJson(Map<String, dynamic> json) =>
    AddModelPointsOwner(
      json['id'] as String?,
...
Map<String, dynamic> _$AddModelPointsOwnerToJson(
        AddModelPointsOwner instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
PointsOwnerSuperBase _$PointsOwnerSuperBaseFromJson(
    ...
    PointsOwnerSuperBase(
      ...
      json['model'] == null
          ? null
          : AddModelPointsOwner.fromJson(json['model'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$PointsOwnerSuperBaseToJson(
        PointsOwnerSuperBase instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
