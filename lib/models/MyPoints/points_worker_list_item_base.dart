...
import '../photo.dart';
import '../paging.dart';
part 'points_worker_list_item_base.g.dart';

class ItemPointsWorkerBase {
	var item;
	Map<String, dynamic> json;
	ItemPointsWorkerBase(this.json){
		item = ItemPointsWorker.fromJson(json);
	}	
...
class ItemPointsWorker{
  ...
  factory ItemPointsWorker.fromJson(Map<String, dynamic> json) => _$ItemPointsWorkerFromJson(json);

  Map<String, dynamic> toJson() => _$ItemPointsWorkerToJson(this);
