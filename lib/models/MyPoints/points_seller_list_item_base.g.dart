...
part of 'points_seller_list_item_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ItemPointsSeller _$ItemPointsSellerFromJson(Map<String, dynamic> json) =>
    ItemPointsSeller(
...
Map<String, dynamic> _$ItemPointsSellerToJson(ItemPointsSeller instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
