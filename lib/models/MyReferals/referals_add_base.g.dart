...
part of 'referals_add_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

AddModelReferals _$AddModelReferalsFromJson(Map<String, dynamic> json) =>
    AddModelReferals(
      json['id'] as String?,
      json['user_id'] as int?,
...
Map<String, dynamic> _$AddModelReferalsToJson(AddModelReferals instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
ReferalsSuperBase _$ReferalsSuperBaseFromJson(Map<String, dynamic> json) =>
    ReferalsSuperBase(
      ...
      json['model'] == null
          ? null
          : AddModelReferals.fromJson(json['model'] as Map<String, dynamic>),
    );
