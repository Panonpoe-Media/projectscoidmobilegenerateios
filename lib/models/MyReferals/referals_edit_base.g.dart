...
part of 'referals_edit_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

EditModelReferals _$EditModelReferalsFromJson(Map<String, dynamic> json) =>
    EditModelReferals(
      json['id'] as String?,
...
Map<String, dynamic> _$EditModelReferalsToJson(EditModelReferals instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
ReferalsSuperBase _$ReferalsSuperBaseFromJson(Map<String, dynamic> json) =>
    ReferalsSuperBase(
      json['id'] as String?,
      ...
      json['model'] == null
          ? null
          : EditModelReferals.fromJson(json['model'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$ReferalsSuperBaseToJson(ReferalsSuperBase instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
