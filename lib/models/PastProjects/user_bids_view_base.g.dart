...
part of 'user_bids_view_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ViewModelUserBids _$ViewModelUserBidsFromJson(Map<String, dynamic> json) =>
    ViewModelUserBids(
      json['id'] as String?,
...
Map<String, dynamic> _$ViewModelUserBidsToJson(ViewModelUserBids instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
UserBidsViewSuperBase _$UserBidsViewSuperBaseFromJson(
    ...
    UserBidsViewSuperBase(
      ...
      json['model'] == null
          ? null
          : ViewModelUserBids.fromJson(json['model'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$UserBidsViewSuperBaseToJson(
        UserBidsViewSuperBase instance) =>
    <String, dynamic>{
      'id': instance.id,
      'meta': instance.meta,
