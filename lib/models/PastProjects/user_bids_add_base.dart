...
part 'user_bids_add_base.g.dart';
...
class AddModelUserBids {
  ...
  String? published_budget;
    ...
    factory AddModelUserBids.fromJson(Map<String, dynamic> json) => _$AddModelUserBidsFromJson(json);

  Map<String, dynamic> toJson() => _$AddModelUserBidsToJson(this);
...
class UserBidsAddBase{
	var model;
	Map<String, dynamic> json;
	UserBidsAddBase(this.json){
