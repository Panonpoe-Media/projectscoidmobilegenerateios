...
part of 'user_bids_add_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

AddModelUserBids _$AddModelUserBidsFromJson(Map<String, dynamic> json) =>
    AddModelUserBids(
      json['id'] as String?,
      json['bid_id'] as int?,
...
Map<String, dynamic> _$AddModelUserBidsToJson(AddModelUserBids instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
UserBidsSuperBase _$UserBidsSuperBaseFromJson(Map<String, dynamic> json) =>
    UserBidsSuperBase(
      ...
      json['model'] == null
          ? null
          : AddModelUserBids.fromJson(json['model'] as Map<String, dynamic>),
    );
