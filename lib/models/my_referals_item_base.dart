...
class ItemMyReferalsBase {
	...
	ItemMyReferalsBase(this.json){
		item = ItemMyReferals.fromJson(json);
	}	
...
class ItemMyReferals{
  ...
  factory ItemMyReferals.fromJson(Map<String, dynamic> json) => _$ItemMyReferalsFromJson(json);

  Map<String, dynamic> toJson() => _$ItemMyReferalsToJson(this);
