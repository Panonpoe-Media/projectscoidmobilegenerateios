...
part of 'product_reviews_edit_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

EditModelProductReviews _$EditModelProductReviewsFromJson(
...
Map<String, dynamic> _$EditModelProductReviewsToJson(
        EditModelProductReviews instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
ProductReviewsSuperBase _$ProductReviewsSuperBaseFromJson(
    ...
    ProductReviewsSuperBase(
      ...
      json['model'] == null
          ? null
          : EditModelProductReviews.fromJson(
