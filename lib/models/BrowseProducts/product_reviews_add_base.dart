...
part 'product_reviews_add_base.g.dart';
...
class AddModelProductReviews {
  ...
  String? testimony;
    ...
    factory AddModelProductReviews.fromJson(Map<String, dynamic> json) => _$AddModelProductReviewsFromJson(json);

  Map<String, dynamic> toJson() => _$AddModelProductReviewsToJson(this);
...
class ProductReviewsAddBase{
	var model;
	Map<String, dynamic> json;
	ProductReviewsAddBase(this.json){
