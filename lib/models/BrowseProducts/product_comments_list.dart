...
class ProductCommentsListingModel extends ProductCommentsListingBase{
  Map<String, dynamic> json;
  String productID = '';
  bool isLogin = false;
  ProductCommentsListingModel(Map<String, dynamic> this.json):super(json);
  ...
  Widget viewItem1 (ItemProductCommentsModel item,ItemProductCommentsModel item1, String? search, BuildContext? context,bool? account, String? id , bool? isMax, int? max, int? index) {
    ...
    return Visibility (
        ...
        child: index == 0 ? ItemProductCommentsCard2(
                  destination: item, search: search, shape: shape, height: height)
                      : ItemProductCommentsCard1(
                  destination: item, search: search, shape: shape, height: height)
    );
      ...
      buttonChildren.add(SpeedDialChild(
          ...
          onTap: ()
            ...
            AppProvider.getRouter(context)!.navigateTo(context,
                '/public/browse_products/product_comments_new_reply/' + productID +'/' + tools.meta.title)
              :
            ...
            children: <SpeedDialChild>[
              SpeedDialChild(
                  ...
                  onTap: ()
                          ...
                          AppProvider.getRouter(context)!.navigateTo(context,
                              '/public/browse_products/product_comments_new_reply/' + productID +'/' + '123')
                        :
                            AppProvider.getRouter(context)!.navigateTo(
                                context,
                                '/login/1');
...
class ItemProductCommentsCard2 extends StatelessWidget {
  const ItemProductCommentsCard2({ Key? key, @required this.destination, this.search, this.shape, this.height, this.index, this.account})
          ...
          children: [
            ...
            Center(
              child: Card(
                ...
                child:
                ItemProductCommentsContent1(destination: destination, account: account),
              ),
...
class ItemProductCommentsCard1 extends StatelessWidget {
  const ItemProductCommentsCard1({ Key? key, @required this.destination, this.search, this.shape, this.height, this.index, this.account})
      : assert(destination != null),
        super(key: key);
...
class ItemProductCommentsContent1 extends StatelessWidget {
  ItemProductCommentsContent1({ Key? key, this.destination, this.account }):super(key: key);
  // {//_randomizeAvatar();
  //}
...
/*
class ItemProductCommentsCard1 extends StatelessWidget {
  const ItemProductCommentsCard1({ Key? key, @required this.destination, this.search, this.shape, this.height})
      : assert(destination != null),
        super(key: key);
        ...
        child: Column(
          children: <Widget>[
            ...
            SizedBox(
              ...
              child: ItemProductCommentsContent1(destination: destination),
            ),
            Row(
              mainAxisAlignment: MainAxisAlignment.start,
              crossAxisAlignment: CrossAxisAlignment.start,
...
/*
class ItemProductCommentsContent1 extends StatelessWidget {
  const ItemProductCommentsContent1({ Key? key, @required this.destination })
      : assert(destination != null),
        super(key: key);
