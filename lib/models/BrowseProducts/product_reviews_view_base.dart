...
part 'product_reviews_view_base.g.dart';
...
class ViewModelProductReviews {
  ...
  String? testimony;
   ...
   factory ViewModelProductReviews.fromJson(Map<String, dynamic> json) => _$ViewModelProductReviewsFromJson(json);

   Map<String, dynamic> toJson() => _$ViewModelProductReviewsToJson(this); 
  
}

@JsonSerializable()
class ProductReviewsViewSuperBase {

  String? id;
  Meta? meta;
  List<Button?>? buttons;
  ViewModelProductReviews? model;
  ProductReviewsViewSuperBase(
      this.id,
      this.buttons,
      this.meta,
      this.model,
  ...
  factory ProductReviewsViewSuperBase.fromJson(Map<String, dynamic> json) => _$ProductReviewsViewSuperBaseFromJson(json);
  Map<String, dynamic> toJson() => _$ProductReviewsViewSuperBaseToJson(this);
   
}

class ProductReviewsViewBase{
	var model;
	Map<String, dynamic> json;
	ProductReviewsViewBase(this.json){
		model = ProductReviewsViewSuperBase.fromJson(this.json);
	}
   ...
   List<SpeedDialChild>	 listButton(BuildContext context){
    ...
    {
      buttonChildren.add(ListButtonProductReviewsWidget(model.buttons[i],context));
    }
