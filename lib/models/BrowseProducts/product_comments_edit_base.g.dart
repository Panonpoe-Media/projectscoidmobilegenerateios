...
part of 'product_comments_edit_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

EditModelProductComments _$EditModelProductCommentsFromJson(
...
Map<String, dynamic> _$EditModelProductCommentsToJson(
        EditModelProductComments instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
...
ProductCommentsSuperBase _$ProductCommentsSuperBaseFromJson(
    ...
    ProductCommentsSuperBase(
      ...
      json['model'] == null
          ? null
          : EditModelProductComments.fromJson(
