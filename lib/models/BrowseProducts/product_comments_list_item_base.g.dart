...
part of 'product_comments_list_item_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ItemProductComments _$ItemProductCommentsFromJson(Map<String, dynamic> json) =>
    ItemProductComments(
...
Map<String, dynamic> _$ItemProductCommentsToJson(
        ItemProductComments instance) =>
    <String, dynamic>{
      'age': instance.age,
      'cnt': instance.cnt,
      'page': instance.page,
