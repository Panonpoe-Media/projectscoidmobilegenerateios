...
class EditScreenshotsBase{
   ...
   Map<String, dynamic> convertFormDataEdit(var data){
      var formData = {
      "product_screenshots[_trigger_]":"",
  "product_screenshots[product_id]": "${model.model.product_id }",
   "product_screenshots[description]": "${model.model.description }",
  "product_screenshots[image]": '{"status":"1","name":"${model.model.image.name}","temp":"${model.model.image.dir}"}',
