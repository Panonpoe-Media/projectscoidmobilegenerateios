...
part 'product_comments_view_base.g.dart';
...
@JsonSerializable()
class ViewModelProductComments {
  int?    age;
  int?    cnt;
  int?    page;
  String? id;
  ...
  String? captcha;
   ...
   factory ViewModelProductComments.fromJson(Map<String, dynamic> json) => _$ViewModelProductCommentsFromJson(json);

   Map<String, dynamic> toJson() => _$ViewModelProductCommentsToJson(this); 
  
}

@JsonSerializable()
class ProductCommentsViewSuperBase {

  String? id;
  Meta? meta;
  List<Button?>? buttons;
  ViewModelProductComments? model;
  ...
  factory ProductCommentsViewSuperBase.fromJson(Map<String, dynamic> json) => _$ProductCommentsViewSuperBaseFromJson(json);
  Map<String, dynamic> toJson() => _$ProductCommentsViewSuperBaseToJson(this);
   
}

class ProductCommentsViewBase{
	var model;
	Map<String, dynamic> json;
	ProductCommentsViewBase(this.json){
		model = ProductCommentsViewSuperBase.fromJson(this.json);
	}
   ...
   List<SpeedDialChild>	 listButton(BuildContext context){
    ...
    {
      buttonChildren.add(ListButtonProductCommentsWidget(model.buttons[i],context));
    }
