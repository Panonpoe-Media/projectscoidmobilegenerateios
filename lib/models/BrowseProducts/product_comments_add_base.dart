...
part 'product_comments_add_base.g.dart';
...
class AddModelProductComments {
  ...
  String? captcha;
    ...
    factory AddModelProductComments.fromJson(Map<String, dynamic> json) => _$AddModelProductCommentsFromJson(json);

  Map<String, dynamic> toJson() => _$AddModelProductCommentsToJson(this);
...
class ProductCommentsAddBase{
	var model;
	Map<String, dynamic> json;
	ProductCommentsAddBase(this.json){
