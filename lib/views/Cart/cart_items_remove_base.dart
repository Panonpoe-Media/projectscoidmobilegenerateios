...
class CartItemsRemoveBase extends StatefulWidget {
  final String? id ;
  final String? title;
  String? url;
  CartItemsRemoveBase({Key? key, this.id, this.title, this.url}) : super(key: key);
  @override
  CartItemsRemoveBaseState createState() => CartItemsRemoveBaseState();
}

class CartItemsRemoveBaseState extends State<CartItemsRemoveBase>  with RestorationMixin{
  String getPath = '';
  String sendPath = '';
...
final RestorableInt _counter = RestorableInt(0);
  ...
  @override
  String get restorationId => 'CartItemsRemove';
    ...
    if (this.model == null) {
       ...
       future.then((value) {
        setState(() {
		  ...
		  try{
		   this.model = RemoveCartItemsModel(value);
		  }catch(e){
		   errmsg = value;
		   isError = true;
		  }
