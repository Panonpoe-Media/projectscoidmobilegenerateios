...
class UserCartAdd extends StatefulWidget {
  static const String PATH = '/user/cart/add/:id/:title';
  UserCartAdd({Key? key}) : super(key: key);
  @override
  UserCartAddState createState() => UserCartAddState();
}

class UserCartAddState extends State<UserCartAdd>{
  String getPath = Env.value!.baseUrl! + '/user/cart/add';
    ...
    cart = new  CartController(AppProvider.getApplication(context),
      ...
      return Scaffold(
          ...
          body:isLoading?
            ...
            floatingActionButton: isLoading? [] : this.model.Buttons(context, _dialVisible, formKey, controller,cart, postCartResult, this, sendPath, '', '')
