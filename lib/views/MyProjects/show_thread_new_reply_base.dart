...
class ShowThreadNewReplyBase extends StatefulWidget {
  final String? id ;
  final String? title;
  String? url;
  ShowThreadNewReplyBase({Key? key, this.id, this.title, this.url}) : super(key: key);
  @override
  ShowThreadNewReplyBaseState createState() => ShowThreadNewReplyBaseState();
}

class ShowThreadNewReplyBaseState extends State<ShowThreadNewReplyBase>  with RestorationMixin{
  String getPath = '';
  String sendPath = '';
...
final RestorableInt _counter = RestorableInt(0);
  ...
  @override
  String get restorationId => 'ShowThreadNewReply';
    ...
    if (this.model == null) {
       ...
       future.then((value) {
        setState(() {
		  ...
		  try{
		   this.model = NewReplyShowThreadModel(value);
		  }catch(e){
		   errmsg = value;
		   isError = true;
		  }
