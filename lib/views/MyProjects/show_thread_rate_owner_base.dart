...
class ShowThreadRateOwnerBase extends StatefulWidget {
  final String? id ;
  final String? title;
  String? url;
  ShowThreadRateOwnerBase({Key? key, this.id, this.title, this.url}) : super(key: key);
  @override
  ShowThreadRateOwnerBaseState createState() => ShowThreadRateOwnerBaseState();
}

class ShowThreadRateOwnerBaseState extends State<ShowThreadRateOwnerBase>  with RestorationMixin{
  String getPath = '';
  String sendPath = '';
...
final RestorableInt _counter = RestorableInt(0);
  ...
  @override
  String get restorationId => 'ShowThreadRateOwner';
    ...
    if (this.model == null) {
       ...
       future.then((value) {
        setState(() {
		  ...
		  try{
		   this.model = RateOwnerShowThreadModel(value);
		  }catch(e){
		   errmsg = value;
		   isError = true;
		  }
