...
class ShowThreadReportProgressBase extends StatefulWidget {
  final String? id ;
  final String? title;
  String? url;
  ShowThreadReportProgressBase({Key? key, this.id, this.title, this.url}) : super(key: key);
  @override
  ShowThreadReportProgressBaseState createState() => ShowThreadReportProgressBaseState();
}

class ShowThreadReportProgressBaseState extends State<ShowThreadReportProgressBase>  with RestorationMixin{
  String getPath = '';
  String sendPath = '';
...
final RestorableInt _counter = RestorableInt(0);
  ...
  @override
  String get restorationId => 'ShowThreadReportProgress';
    ...
    if (this.model == null) {
       ...
       future.then((value) {
        setState(() {
		  ...
		  try{
		   this.model = ReportProgressShowThreadModel(value);
		  }catch(e){
		   errmsg = value;
		   isError = true;
		  }
