...
class ShowThreadBroadcastMessageBase extends StatefulWidget {
  final String? id ;
  final String? title;
  String? url;
  ShowThreadBroadcastMessageBase({Key? key, this.id, this.title, this.url}) : super(key: key);
  @override
  ShowThreadBroadcastMessageBaseState createState() => ShowThreadBroadcastMessageBaseState();
}

class ShowThreadBroadcastMessageBaseState extends State<ShowThreadBroadcastMessageBase>  with RestorationMixin{
  String getPath = '';
  String sendPath = '';
...
final RestorableInt _counter = RestorableInt(0);
  ...
  @override
  String get restorationId => 'ShowThreadBroadcastMessage';
    ...
    if (this.model == null) {
       ...
       future.then((value) {
        setState(() {
		  ...
		  try{
		   this.model = BroadcastMessageShowThreadModel(value);
		  }catch(e){
		   errmsg = value;
		   isError = true;
		  }
