...
class ShowConversationReplyBase extends StatefulWidget {
  final String? id ;
  final String? title;
  String? url;
  ShowConversationReplyBase({Key? key, this.id, this.title, this.url}) : super(key: key);
  @override
  ShowConversationReplyBaseState createState() => ShowConversationReplyBaseState();
}

class ShowConversationReplyBaseState extends State<ShowConversationReplyBase>  with RestorationMixin{
  String getPath = '';
  String sendPath = '';
...
final RestorableInt _counter = RestorableInt(0);
  ...
  @override
  String get restorationId => 'ShowConversationReply';
    ...
    if (this.model == null) {
       ...
       future.then((value) {
        setState(() {
		  ...
		  try{
		   this.model = ReplyShowConversationModel(value);
		  }catch(e){
		   errmsg = value;
		   isError = true;
		  }
