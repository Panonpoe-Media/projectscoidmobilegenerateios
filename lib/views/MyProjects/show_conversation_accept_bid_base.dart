...
class ShowConversationAcceptBidBase extends StatefulWidget {
  final String? id ;
  final String? title;
  String? url;
  ShowConversationAcceptBidBase({Key? key, this.id, this.title, this.url}) : super(key: key);
  @override
  ShowConversationAcceptBidBaseState createState() => ShowConversationAcceptBidBaseState();
}

class ShowConversationAcceptBidBaseState extends State<ShowConversationAcceptBidBase>  with RestorationMixin{
  String getPath = '';
  String sendPath = '';
...
final RestorableInt _counter = RestorableInt(0);
  ...
  @override
  String get restorationId => 'ShowConversationAcceptBid';
    ...
    if (this.model == null) {
       ...
       future.then((value) {
        setState(() {
		  ...
		  try{
		   this.model = AcceptBidShowConversationModel(value);
		  }catch(e){
		   errmsg = value;
		   isError = true;
		  }
