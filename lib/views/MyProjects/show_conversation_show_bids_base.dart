...
class ShowConversationShowBidsBase extends StatefulWidget {
  final String? id ;
  final String? title;
  String? url;
  ShowConversationShowBidsBase({Key? key, this.id, this.title, this.url}) : super(key: key);
  @override
  ShowConversationShowBidsBaseState createState() => ShowConversationShowBidsBaseState();
}

class ShowConversationShowBidsBaseState extends State<ShowConversationShowBidsBase>  with RestorationMixin{
  String getPath = '';
  String sendPath = '';
  ...
  var isLoading = true;
    var isError = false;
  var errmsg= 'Unauthorized  :'+'Show Bids';
...
final RestorableInt _counter = RestorableInt(0);
  ...
  @override
  String get restorationId => 'ShowConversationShowBids';
    ...
    if (this.model == null) {
       ...
       future.then((value) {
        setState(() {
		  ...
		  try{
		   this.model = ShowBidsShowConversationModel(value);
		  }catch(e){
		   errmsg = value;
		   isError = true;
		  }
