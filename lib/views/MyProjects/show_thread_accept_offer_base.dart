...
class ShowThreadAcceptOfferBase extends StatefulWidget {
  final String? id ;
  final String? title;
  String? url;
  ShowThreadAcceptOfferBase({Key? key, this.id, this.title, this.url}) : super(key: key);
  @override
  ShowThreadAcceptOfferBaseState createState() => ShowThreadAcceptOfferBaseState();
}

class ShowThreadAcceptOfferBaseState extends State<ShowThreadAcceptOfferBase>  with RestorationMixin{
  String getPath = '';
  String sendPath = '';
...
final RestorableInt _counter = RestorableInt(0);
  ...
  @override
  String get restorationId => 'ShowThreadAcceptOffer';
    ...
    if (this.model == null) {
       ...
       future.then((value) {
        setState(() {
		  ...
		  try{
		   this.model = AcceptOfferShowThreadModel(value);
		  }catch(e){
		   errmsg = value;
		   isError = true;
		  }
