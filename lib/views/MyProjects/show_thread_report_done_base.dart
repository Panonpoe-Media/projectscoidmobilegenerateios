...
class ShowThreadReportDoneBase extends StatefulWidget {
  final String? id ;
  final String? title;
  String? url;
  ShowThreadReportDoneBase({Key? key, this.id, this.title, this.url}) : super(key: key);
  @override
  ShowThreadReportDoneBaseState createState() => ShowThreadReportDoneBaseState();
}

class ShowThreadReportDoneBaseState extends State<ShowThreadReportDoneBase>  with RestorationMixin{
  String getPath = '';
  String sendPath = '';
...
final RestorableInt _counter = RestorableInt(0);
  ...
  @override
  String get restorationId => 'ShowThreadReportDone';
    ...
    if (this.model == null) {
       ...
       future.then((value) {
        setState(() {
		  ...
		  try{
		   this.model = ReportDoneShowThreadModel(value);
		  }catch(e){
		   errmsg = value;
		   isError = true;
		  }
