...
class ShowThreadRateWorkerBase extends StatefulWidget {
  final String? id ;
  final String? title;
  String? url;
  ShowThreadRateWorkerBase({Key? key, this.id, this.title, this.url}) : super(key: key);
  @override
  ShowThreadRateWorkerBaseState createState() => ShowThreadRateWorkerBaseState();
}

class ShowThreadRateWorkerBaseState extends State<ShowThreadRateWorkerBase>  with RestorationMixin{
  String getPath = '';
  String sendPath = '';
...
final RestorableInt _counter = RestorableInt(0);
  ...
  @override
  String get restorationId => 'ShowThreadRateWorker';
    ...
    if (this.model == null) {
       ...
       future.then((value) {
        setState(() {
		  ...
		  try{
		   this.model = RateWorkerShowThreadModel(value);
		  }catch(e){
		   errmsg = value;
		   isError = true;
		  }
