...
class ShowConversationNewReplyBase extends StatefulWidget {
  final String? id ;
  final String? title;
  String? url;
  ShowConversationNewReplyBase({Key? key, this.id, this.title, this.url}) : super(key: key);
  @override
  ShowConversationNewReplyBaseState createState() => ShowConversationNewReplyBaseState();
}

class ShowConversationNewReplyBaseState extends State<ShowConversationNewReplyBase>  with RestorationMixin{
  String getPath = '';
  String sendPath = '';
...
final RestorableInt _counter = RestorableInt(0);
  ...
  @override
  String get restorationId => 'ShowConversationNewReply';
    ...
    if (this.model == null) {
       ...
       future.then((value) {
        setState(() {
		  ...
		  try{
		   this.model = NewReplyShowConversationModel(value);
		  }catch(e){
		   errmsg = value;
		   isError = true;
		  }
