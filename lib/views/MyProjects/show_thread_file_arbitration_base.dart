...
class ShowThreadFileArbitrationBase extends StatefulWidget {
  final String? id ;
  final String? title;
  String? url;
  ShowThreadFileArbitrationBase({Key? key, this.id, this.title, this.url}) : super(key: key);
  @override
  ShowThreadFileArbitrationBaseState createState() => ShowThreadFileArbitrationBaseState();
}

class ShowThreadFileArbitrationBaseState extends State<ShowThreadFileArbitrationBase>  with RestorationMixin{
  String getPath = '';
  String sendPath = '';
...
final RestorableInt _counter = RestorableInt(0);
  ...
  @override
  String get restorationId => 'ShowThreadFileArbitration';
    ...
    if (this.model == null) {
       ...
       future.then((value) {
        setState(() {
		  ...
		  try{
		   this.model = FileArbitrationShowThreadModel(value);
		  }catch(e){
		   errmsg = value;
		   isError = true;
		  }
