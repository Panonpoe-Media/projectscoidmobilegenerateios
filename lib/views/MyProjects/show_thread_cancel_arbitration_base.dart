...
class ShowThreadCancelArbitrationBase extends StatefulWidget {
  final String? id ;
  final String? title;
  String? url;
  ShowThreadCancelArbitrationBase({Key? key, this.id, this.title, this.url}) : super(key: key);
  @override
  ShowThreadCancelArbitrationBaseState createState() => ShowThreadCancelArbitrationBaseState();
}

class ShowThreadCancelArbitrationBaseState extends State<ShowThreadCancelArbitrationBase>  with RestorationMixin{
  String getPath = '';
  String sendPath = '';
...
final RestorableInt _counter = RestorableInt(0);
  ...
  @override
  String get restorationId => 'ShowThreadCancelArbitration';
    ...
    if (this.model == null) {
       ...
       future.then((value) {
        setState(() {
		  ...
		  try{
		   this.model = CancelArbitrationShowThreadModel(value);
		  }catch(e){
		   errmsg = value;
		   isError = true;
		  }
