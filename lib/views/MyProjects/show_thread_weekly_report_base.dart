...
class ShowThreadWeeklyReportBase extends StatefulWidget {
  final String? id ;
  final String? title;
  String? url;
  ShowThreadWeeklyReportBase({Key? key, this.id, this.title, this.url}) : super(key: key);
  @override
  ShowThreadWeeklyReportBaseState createState() => ShowThreadWeeklyReportBaseState();
}

class ShowThreadWeeklyReportBaseState extends State<ShowThreadWeeklyReportBase>  with RestorationMixin{
  String getPath = '';
  String sendPath = '';
...
final RestorableInt _counter = RestorableInt(0);
  ...
  @override
  String get restorationId => 'ShowThreadWeeklyReport';
    ...
    if (this.model == null) {
       ...
       future.then((value) {
        setState(() {
		  ...
		  try{
		   this.model = WeeklyReportShowThreadModel(value);
		  }catch(e){
		   errmsg = value;
		   isError = true;
		  }
