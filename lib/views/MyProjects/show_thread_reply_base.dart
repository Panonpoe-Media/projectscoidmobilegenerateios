...
class ShowThreadReplyBase extends StatefulWidget {
  final String? id ;
  final String? title;
  String? url;
  ShowThreadReplyBase({Key? key, this.id, this.title, this.url}) : super(key: key);
  @override
  ShowThreadReplyBaseState createState() => ShowThreadReplyBaseState();
}

class ShowThreadReplyBaseState extends State<ShowThreadReplyBase>  with RestorationMixin{
  String getPath = '';
  String sendPath = '';
...
final RestorableInt _counter = RestorableInt(0);
  ...
  @override
  String get restorationId => 'ShowThreadReply';
    ...
    if (this.model == null) {
       ...
       future.then((value) {
        setState(() {
		  ...
		  try{
		   this.model = ReplyShowThreadModel(value);
		  }catch(e){
		   errmsg = value;
		   isError = true;
		  }
