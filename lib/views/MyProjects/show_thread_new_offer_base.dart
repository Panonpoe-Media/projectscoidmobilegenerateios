...
class ShowThreadNewOfferBase extends StatefulWidget {
  final String? id ;
  final String? title;
  String? url;
  ShowThreadNewOfferBase({Key? key, this.id, this.title, this.url}) : super(key: key);
  @override
  ShowThreadNewOfferBaseState createState() => ShowThreadNewOfferBaseState();
}

class ShowThreadNewOfferBaseState extends State<ShowThreadNewOfferBase>  with RestorationMixin{
  String getPath = '';
  String sendPath = '';
...
final RestorableInt _counter = RestorableInt(0);
  ...
  @override
  String get restorationId => 'ShowThreadNewOffer';
    ...
    if (this.model == null) {
       ...
       future.then((value) {
        setState(() {
		  ...
		  try{
		   this.model = NewOfferShowThreadModel(value);
		  }catch(e){
		   errmsg = value;
		   isError = true;
		  }
