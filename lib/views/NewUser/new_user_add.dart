...
class PublicNewUserAdd extends StatefulWidget {
  static const String PATH = '/public/new_user/add/:id/:title';
  PublicNewUserAdd({Key? key}) : super(key: key);
  @override
  PublicNewUserAddState createState() => PublicNewUserAddState();
}

class PublicNewUserAddState extends State<PublicNewUserAdd>{
  String getPath = Env.value!.baseUrl! + '/public/new_user/add';
    ...
    new_user = new  NewUserController(AppProvider.getApplication(context),
      ...
      return Scaffold(
          ...
          body:isLoading?
            ...
            floatingActionButton: isLoading? [] : this.model.Buttons(context, _dialVisible, formKey, controller,new_user, postNewUserResult, this, sendPath, '', '')
