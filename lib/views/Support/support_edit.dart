...
//123
class PublicSupportEdit extends StatefulWidget {
  static const String PATH = '/public/support/edit/:id/:title';
  final String? id ;
  final String? title;
  PublicSupportEdit({Key? key, this.id, this.title}) : super(key: key);
  @override
  PublicSupportEditState createState() => PublicSupportEditState();
}

class PublicSupportEditState extends State<PublicSupportEdit>  with RestorationMixin{
  String getPath = Env.value!.baseUrl! + '/public/support/edit/%s/%s';
 // String sendPath = Env.value!.baseUrl! + '/public/support/add';
  String sendPath = Env.value!.baseUrl! + '/public/support/edit/%s/%s';
...
final RestorableInt _counter = RestorableInt(0);
  ...
  initState(){
    super.initState();
	sendPath = Env.value!.baseUrl! + '/public/support/edit/' +widget.id! +'/' + widget.title!;
     ...
     fetchData(support);
      ...
      return Scaffold(
          ...
          body:isLoading?
            ...
            floatingActionButton:  isLoading? null : this.model.Buttons(context, _dialVisible, formKey, controller,support, postSupportResult, this, sendPath, widget.id, widget.title)
