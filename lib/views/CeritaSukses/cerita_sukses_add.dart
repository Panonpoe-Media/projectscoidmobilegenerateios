...
class PublicCeritaSuksesAdd extends StatefulWidget {
  static const String PATH = '/public/cerita_sukses/add/:id/:title';
  PublicCeritaSuksesAdd({Key? key}) : super(key: key);
  @override
  PublicCeritaSuksesAddState createState() => PublicCeritaSuksesAddState();
}

class PublicCeritaSuksesAddState extends State<PublicCeritaSuksesAdd>{
  String getPath = Env.value!.baseUrl! + '/public/cerita_sukses/add';
    ...
    cerita_sukses = new  CeritaSuksesController(AppProvider.getApplication(context),
      ...
      return Scaffold(
          ...
          body:isLoading?
            ...
            floatingActionButton: isLoading? [] : this.model.Buttons(context, _dialVisible, formKey, controller,cerita_sukses, postCeritaSuksesResult, this, sendPath, '', '')
