...
class UserMyServicesAdd extends StatefulWidget {
  static const String PATH = '/user/my_services/add/:id/:title';
  UserMyServicesAdd({Key? key}) : super(key: key);
  @override
  UserMyServicesAddState createState() => UserMyServicesAddState();
}

class UserMyServicesAddState extends State<UserMyServicesAdd>{
  String getPath = Env.value!.baseUrl! + '/user/my_services/add';
    ...
    my_services = new  MyServicesController(AppProvider.getApplication(context),
      ...
      return Scaffold(
          ...
          body:isLoading?
            ...
            floatingActionButton: isLoading? [] : this.model.Buttons(context, _dialVisible, formKey, controller,my_services, postMyServicesResult, this, sendPath, '', '')
