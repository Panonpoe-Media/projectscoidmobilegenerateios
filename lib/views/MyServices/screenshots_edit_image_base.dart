...
class ScreenshotsEditImageBase extends StatefulWidget {
  final String? id ;
  final String? title;
  String? url;
  ScreenshotsEditImageBase({Key? key, this.id, this.title, this.url}) : super(key: key);
  @override
  ScreenshotsEditImageBaseState createState() => ScreenshotsEditImageBaseState();
}

class ScreenshotsEditImageBaseState extends State<ScreenshotsEditImageBase>  with RestorationMixin{
  String getPath = '';
  String sendPath = '';
  ...
  var isLoading = true;
    var isError = false;
  var errmsg= 'Unauthorized  :'+'Edit Image';
...
final RestorableInt _counter = RestorableInt(0);
  ...
  @override
  String get restorationId => 'ScreenshotsEditImage';
    ...
    if (this.model == null) {
       ...
       future.then((value) {
        setState(() {
		  ...
		  try{
		   this.model = EditImageScreenshotsModel(value);
		  }catch(e){
		   errmsg = value;
		   isError = true;
		  }
