...
//import 'package:projectscoid/models/MyServices/screenshots_add_image.dart';
/** AUTOGENERATE OFF **/
    ...
    if (this.model == null) {
       ...
       future.then((value) {
        setState(() {
		  ...
		  try{
		   this.model = AddImageScreenshotsModel1(value);
		  }catch(e){
		   errmsg = value;
		   isError = true;
		  }
    ...
    screenshots = new SubModelController(AppProvider.getApplication(context),
	 ...
	 fetchData(screenshots,  context );
      ...
      return Scaffold(
		  ...
		  //  floatingActionButton: isLoading? null :  this.model.Buttons(context, _dialVisible, formKey, controller,screenshots, postScreenshotsResult, this, sendPath, widget.id, widget.title)
      );
