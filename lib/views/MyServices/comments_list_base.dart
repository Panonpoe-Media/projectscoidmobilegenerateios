...
class CommentsListing extends Bloc<CommentsEvent, CommentsState> {
  ...
  final String url;
  final bool isSearch;
  CommentsListing(this.application, this.url, this.isSearch, CommentsState initialState):super(initialState);
  @override
  void dispose() {
   // super.dispose();
  }
 ...
 Stream<Transition<CommentsEvent, CommentsState>> transformEvents(
  ...
  Future<CommentsListingModel?> listingComments(int page) async {
	...
	return await apiRepProvider!.getCommentsListAPI1(url, page);
	/*
  ...
  Future<CommentsListingModel?> listingRefreshComments() async {
   ...
   CommentsListingModel? comments = null;
    APIRepository? apiRepProvider = application.projectsAPIRepository;
    await application.projectsDBRepository!.deleteAllCommentsList2();
  ...
  Future<CommentsListingModel?> listingSearchComments(int page) async {
    APIRepository? apiRepProvider = application.projectsAPIRepository;
	return await apiRepProvider!.getCommentsListSearchAPI1(url, page);
  ...
  Future<CommentsListingModel?> listingSearchRefreshComments() async {
   CommentsListingModel? comments = null;
     APIRepository? apiRepProvider = application.projectsAPIRepository;
    await application.projectsDBRepository!.deleteAllCommentsList2();
    comments  = await apiRepProvider!.getCommentsListSearchAPI1(url, 1);
    return comments;
  /*
    APIRepository? apiRepProvider = application.projectsAPIRepository;
	int page = 0;
