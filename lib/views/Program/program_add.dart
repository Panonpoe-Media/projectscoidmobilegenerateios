...
class PublicProgramAdd extends StatefulWidget {
  static const String PATH = '/public/program/add/:id/:title';
  PublicProgramAdd({Key? key}) : super(key: key);
  @override
  PublicProgramAddState createState() => PublicProgramAddState();
}

class PublicProgramAddState extends State<PublicProgramAdd>{
  String getPath = Env.value!.baseUrl! + '/public/program/add';
    ...
    program = new  ProgramController(AppProvider.getApplication(context),
      ...
      return Scaffold(
          ...
          body:isLoading?
            ...
            floatingActionButton: isLoading? [] : this.model.Buttons(context, _dialVisible, formKey, controller,program, postProgramResult, this, sendPath, '', '')
