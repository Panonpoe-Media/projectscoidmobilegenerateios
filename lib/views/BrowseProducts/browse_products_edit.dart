...
//123
class PublicBrowseProductsEdit extends StatefulWidget {
  static const String PATH = '/public/browse_products/edit/:id/:title';
  final String? id ;
  final String? title;
  PublicBrowseProductsEdit({Key? key, this.id, this.title}) : super(key: key);
  @override
  PublicBrowseProductsEditState createState() => PublicBrowseProductsEditState();
}

class PublicBrowseProductsEditState extends State<PublicBrowseProductsEdit>  with RestorationMixin{
  String getPath = Env.value!.baseUrl! + '/public/browse_products/edit/%s/%s';
 // String sendPath = Env.value!.baseUrl! + '/public/browse_products/add';
  String sendPath = Env.value!.baseUrl! + '/public/browse_products/edit/%s/%s';
...
final RestorableInt _counter = RestorableInt(0);
  ...
  @override
  String get restorationId => 'BrowseProducts';
  ...
  initState(){
    super.initState();
	sendPath = Env.value!.baseUrl! + '/public/browse_products/edit/' +widget.id! +'/' + widget.title!;
     ...
     fetchData(browse_products);
      ...
      return Scaffold(
          ...
          body:isLoading?
            ...
            floatingActionButton:  isLoading? null : this.model.Buttons(context, _dialVisible, formKey, controller,browse_products, postBrowseProductsResult, this, sendPath, widget.id, widget.title)
