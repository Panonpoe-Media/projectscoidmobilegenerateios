...
//123
class PublicPastProjectsEdit extends StatefulWidget {
  static const String PATH = '/public/past_projects/edit/:id/:title';
  final String? id ;
  final String? title;
  PublicPastProjectsEdit({Key? key, this.id, this.title}) : super(key: key);
  @override
  PublicPastProjectsEditState createState() => PublicPastProjectsEditState();
}

class PublicPastProjectsEditState extends State<PublicPastProjectsEdit>  with RestorationMixin{
  String getPath = Env.value!.baseUrl! + '/public/past_projects/edit/%s/%s';
 // String sendPath = Env.value!.baseUrl! + '/public/past_projects/add';
  String sendPath = Env.value!.baseUrl! + '/public/past_projects/edit/%s/%s';
...
final RestorableInt _counter = RestorableInt(0);
  ...
  initState(){
    super.initState();
	sendPath = Env.value!.baseUrl! + '/public/past_projects/edit/' +widget.id! +'/' + widget.title!;
     ...
     fetchData(past_projects);
      ...
      return Scaffold(
          ...
          body:isLoading?
            ...
            floatingActionButton:  isLoading? null : this.model.Buttons(context, _dialVisible, formKey, controller,past_projects, postPastProjectsResult, this, sendPath, widget.id, widget.title)
