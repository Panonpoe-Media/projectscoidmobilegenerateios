...
class PublicBrowseProjectsAdd extends StatefulWidget {
  static const String PATH = '/public/browse_projects/add/:id/:title';
  PublicBrowseProjectsAdd({Key? key}) : super(key: key);
  @override
  PublicBrowseProjectsAddState createState() => PublicBrowseProjectsAddState();
}

class PublicBrowseProjectsAddState extends State<PublicBrowseProjectsAdd>{
  String getPath = Env.value!.baseUrl! + '/public/browse_projects/add';
    ...
    browse_projects = new  BrowseProjectsController(AppProvider.getApplication(context),
      ...
      return Scaffold(
          ...
          body:isLoading?
            ...
            floatingActionButton: isLoading? [] : this.model.Buttons(context, _dialVisible, formKey, controller,browse_projects, postBrowseProjectsResult, this, sendPath, '', '')
