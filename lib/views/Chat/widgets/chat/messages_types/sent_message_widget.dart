...
class SentMessageWidget extends StatefulWidget {
  ...
  String? avatar;
  bool? equal;
  SentMessageWidget({Key? key, this.message, this.search, this.duration, this.position, this.audioPlayer,// this.playerState,
 ...
 */
  ...
  Future<void> _init() async {
    ...
    widget.audioPlayer?.playbackEventStream.listen((event) {
      if(event.duration != null){
        if(transformMilliSeconds(event.updatePosition.inMilliseconds)== transformMilliSeconds(event.duration?.inMilliseconds??0)){
  ...
  Future play(String?kUrl,  String?basename, bool sts) async {
    ...
    final file = File('${dir?.path}/Record/send/$basename');
  ...
  Future _loadFile(Uri kUrl, String?basename) async {
    ...
    final String?dirPath = '${dir?.path}/Record/send';
                    ...
                    const Align(
                      ...
                      child: SizedBox(
                          ...
                          Padding(
                            ...
                            child:const Icon(Icons.mic, color: Colors.blue, size: 25,),
                          )
  ...
  Widget build(BuildContext context) {
   ...
   // print('ini aku textModel.type  ${textModel.message}');
    ...
    if(isImage(textModel.message)&&(textModel.message!.contains('<img'))){
      ...
      var dt = document.getElementsByTagName('div');
      if(dt.isNotEmpty){
        print('child2 == ${document.nodes.last.text}');

        fileMessage = document.nodes.last.text;
      }
    ...
    // print('oceeehhh  $textModel.message');
  ...
  // return(Text(parser.emojify(textModel.message)  ));
    ...
    return (
        ...
        Column(
            ...
            children: <Widget>[
              Bubble(
                margin: const BubbleEdges.only(top: 10,left: 50, right: 16),
                color: darkMode!? Colors.black45:const Color.fromARGB(255,225, 255, 199),
                nip:      widget.equal! ?  BubbleNip.no:BubbleNip.rightTop,
                child:
                // Padding(
                // padding: const EdgeInsets.only(bottom: 20),
                // child:
                isImage(textModel.message)?
                ...
                GestureDetector(
                    onTap: (){
                      ...
                      Navigator.push(context,
                          MaterialPageRoute(builder: (context) => ShowImage(image:'${source?.replaceAll('upload.projects', 'cdn.projects').replaceAll('-thumb.', '.')}')));
                    },
                    child:
                     Image(
                          image:
                ...
                :Html(data: '<img src=${textModel.message} >',
                  ...
                  onImageTap:(src, _, __, ___){
                    String?source = src;
                    Navigator.push(context,
                        MaterialPageRoute(builder: (context) => ShowImage(image:source?.replaceAll('upload.projects', 'cdn.projects'))));
                  },
                ...
                GestureDetector(
                  ...
                  onTap: (){
                    Navigator.push(context,
                        MaterialPageRoute(builder: (context) => ShowFile(file: fileName,fz:fileSize == null? fileInfo == ''? '': fileInfo  :filesize(fileSize), basename: basename,)));

                  },
                )
                    : fileName!.contains('ECT.mp3') ?
                Container(width:width*3/4,child: _buildPlayer(fileName, basename, Duration(milliseconds: int.tryParse(fileMessage!)??0))):
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
...
Row(
     ...
     Expanded(
                      ...
                      Text(
                        ...
                        BlockQuote(
                         ...
                         HtmlWidget(
                           ...
                           //bodyPadding: const EdgeInsets.only(left:8, right: 8, bottom: 5),
                           textStyle:darkMode!?  const TextStyle(fontSize:14, color:Colors.white):
                ...
                HtmlWidget(
                  parser.emojify(addTag(widget.search!, textModel.message)!),
                  //  HtmlWidget(parser.emojify(textModel.message)  ,
                  //bodyPadding: const EdgeInsets.only(left:8, right: 8, bottom: 5),
              ...
              child:     Row(
                              ...
                              children:<Widget>[
                                  Text(
                                  readTimestamp( widget.message['time'])! ,
                                  style:  TextStyle(
        ...
        Column(
            ...
            children: <Widget>[
              Bubble(
                ...
                : Text(parser.emojify(addTag(widget.search!, textModel.message)!), style: TextStyle(fontSize:14, color: darkMode!? Colors.white:Colors.black)),
                  ...
                  child:     Row(
                      ...
                      children:<Widget>[
                        ...
                        Container(
                            ...
                            decoration:
                           const  BoxDecoration(
                              image: DecorationImage( image: ExactAssetImage('assets/img/doubletickgrey.png'),
                                fit: BoxFit.contain,),
                            )
                        )
                      ]
                  ...
                  child:     Row(
                      ...
                      children:<Widget>[
                        ...
                        Container(
                            ...
                            decoration:
                           const  BoxDecoration(
                              image: DecorationImage( image: ExactAssetImage('assets/img/doubletickgreen.png'),
                                fit: BoxFit.cover,),
                            )
                        )
                      ]
     ...
     Expanded(
                ...
                FileViewAttFix(
                  ...
                  caption: 'Sample',
                    ...
                    :
                /*
                      Html(data: parser.emojify(textModel.message),
                        style: {
                          "html": Style(
                        ...
                        onImageTap:(src){
                          Navigator.push(context,
                              MaterialPageRoute(builder: (context) => ShowImage(image:'$src')));
                        },
         ...
         */
                //Text('helooo'),
                HtmlWidget(
                  addTag(widget.search!, textModel.message)!,
                  //  HtmlWidget(parser.emojify(textModel.message)  ,
                  //bodyPadding: const EdgeInsets.only(left:8, right: 8, bottom: 5),
                  textStyle: TextStyle(fontSize:14, color: darkMode!? Colors.white:Colors.black),
                  onTapUrl: (url) async{
                ...
                Column(
                  ...
                  children: [
                    ...
                    GestureDetector(
                        ...
                        //Image.network(parseThumb(textModel.message) ),
                       // NetworkToFileImage(
                       // url: parseThumb(textModel.message),
                       // file: myFile),
                    ),
...
Row(
        ...
        Column(
            ...
            children: <Widget>[
              Bubble(
                ...
                textModel.message!.contains('href="https://upload.projects.co.id/upload')?
                GestureDetector(
                    child:
                    Container(
                          width: width * 3/4,
 ...
 Expanded(
                            ...
                            SizedBox(height: 5),
                            fileSize == null? Container() : Text('(${filesize(fileSize)}, ${dateformat.format(date!)} WIB)', style: const TextStyle(fontSize: 12)),
                          ],
                        ),
                      ),
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Text('$basename', style: const TextStyle(color: Colors.red, fontSize: 14),),
                            SizedBox(height: 5),
                          fileSize == null? Container() : Text('(${filesize(fileSize)}, ${dateformat.format(date!)} WIB)', style: const TextStyle(fontSize: 12)),
                        ],
                      ),
                  ...
                  onTap: (){
                    Navigator.push(context,
                        MaterialPageRoute(builder: (context) => ShowFile(file:fileName,fz:fileSize == null? '' :filesize(fileSize), basename: basename,)));
                ...
                :GestureDetector(
                  ...
                  onTap: (){
                    Navigator.push(context,
                        MaterialPageRoute(builder: (context) => ShowFile(file:textModel.message,fz:'', basename: basename,)));
                  ...
                  child:     Row(
                      ...
                      children:<Widget>[
                        ...
                        Container(
                            ...
                            decoration:
                           const  BoxDecoration(
                              image: DecorationImage( image: ExactAssetImage('assets/img/tickgrey.png'),
                                fit: BoxFit.contain,),
                            )
                        )
                      ]
        ...
        Container(
           ...
           // width: cWidth,
            child: Bubble(
              ...
              nip: widget.equal! ?  BubbleNip.no:BubbleNip.rightTop,
              child: HtmlWidget(textModel.message),
            )
        ),
      ],
    );
  ...
  ImageProvider get _userImageAvatar =>
      const AssetImage('assets/images/default-user.jpg',
          package: 'risecx_chat_client');
}
...
class ShowFile extends StatefulWidget {
  ...
  const ShowFile({Key? key,this.file, this.fz, this.basename}) : super(key: key);

  @override
  ShowFileState createState() => ShowFileState();
}
