...
class PublicExistingUserAdd extends StatefulWidget {
  static const String PATH = '/public/existing_user/add/:id/:title';
  PublicExistingUserAdd({Key? key}) : super(key: key);
  @override
  PublicExistingUserAddState createState() => PublicExistingUserAddState();
}

class PublicExistingUserAddState extends State<PublicExistingUserAdd>{
  String getPath = Env.value!.baseUrl! + '/public/existing_user/add';
    ...
    existing_user = new  ExistingUserController(AppProvider.getApplication(context),
      ...
      return Scaffold(
          ...
          body:isLoading?
            ...
            floatingActionButton: isLoading? [] : this.model.Buttons(context, _dialVisible, formKey, controller,existing_user, postExistingUserResult, this, sendPath, '', '')
