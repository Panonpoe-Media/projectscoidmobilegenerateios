...
class UserMyProfileAdd extends StatefulWidget {
  static const String PATH = '/user/my_profile/add/:id/:title';
  UserMyProfileAdd({Key? key}) : super(key: key);
  @override
  UserMyProfileAddState createState() => UserMyProfileAddState();
}

class UserMyProfileAddState extends State<UserMyProfileAdd>{
  String getPath = Env.value!.baseUrl! + '/user/my_profile/add';
    ...
    my_profile = new  MyProfileController(AppProvider.getApplication(context),
      ...
      return Scaffold(
          ...
          body:isLoading?
            ...
            floatingActionButton: isLoading? [] : this.model.Buttons(context, _dialVisible, formKey, controller,my_profile, postMyProfileResult, this, sendPath, '', '')
