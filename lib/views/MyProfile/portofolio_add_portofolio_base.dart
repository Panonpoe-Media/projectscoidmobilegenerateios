...
class PortofolioAddPortofolioBase extends StatefulWidget {
  final String? id ;
  final String? title;
  String? url;
  PortofolioAddPortofolioBase({Key? key, this.id, this.title, this.url}) : super(key: key);
  @override
  PortofolioAddPortofolioBaseState createState() => PortofolioAddPortofolioBaseState();
}

class PortofolioAddPortofolioBaseState extends State<PortofolioAddPortofolioBase>  with RestorationMixin{
  String getPath = '';
  String sendPath = '';
...
final RestorableInt _counter = RestorableInt(0);
  ...
  @override
  String get restorationId => 'PortofolioAddPortofolio';
    ...
    if (this.model == null) {
       ...
       future.then((value) {
        setState(() {
		  ...
		  try{
		   this.model = AddPortofolioPortofolioModel(value);
		  }catch(e){
		   errmsg = value;
		   isError = true;
		  }
