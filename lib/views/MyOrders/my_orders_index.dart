...
class  UserMyOrdersIndex extends StatefulWidget {
  static const String PATH = '/user/my_orders/index/:id';
    final String? id ;
   UserMyOrdersIndex({Key? key, this.id}) : super(key: key);
  @override
   UserMyOrdersIndexState createState() =>  UserMyOrdersIndexState();
}

class  UserMyOrdersIndexState extends State< UserMyOrdersIndex> with RestorationMixin{
  String title = 'My Orders'; 
  bool _dialVisible = true;
  bool search = false;
  String getPath = Env.value!.baseUrl! + '/user/my_orders/index?page=%d';
...
final RestorableDouble cs = RestorableDouble(0);
  ...
  Widget build(BuildContext context) {
      ...
      getPath = Env.value!.baseUrl! + '/user/my_orders/index?page=%d' + ids;
    }
  ...
  //  my_orders =  MyOrdersController(AppProvider.getApplication(context),getPath, AppAction.indexing, '','','', search );
  //  my_orders!.getTableMyOrders(page);
    return WillPopScope(
         onWillPop:()async{
...
Future _getTable(BuildContext context)async{
  my_orders =  MyOrdersController(AppProvider.getApplication(context),getPath, AppAction.indexing, '','','', search );
   return await my_orders!.getTableMyOrders(page);
}
...
class  UserMyOrdersBottomIndexLoader extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Container(
