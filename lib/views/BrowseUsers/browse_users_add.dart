...
class PublicBrowseUsersAdd extends StatefulWidget {
  static const String PATH = '/public/browse_users/add/:id/:title';
  PublicBrowseUsersAdd({Key? key}) : super(key: key);
  @override
  PublicBrowseUsersAddState createState() => PublicBrowseUsersAddState();
}

class PublicBrowseUsersAddState extends State<PublicBrowseUsersAdd>{
  String getPath = Env.value!.baseUrl! + '/public/browse_users/add';
    ...
    browse_users = new  BrowseUsersController(AppProvider.getApplication(context),
      ...
      return Scaffold(
          ...
          body:isLoading?
            ...
            floatingActionButton: isLoading? [] : this.model.Buttons(context, _dialVisible, formKey, controller,browse_users, postBrowseUsersResult, this, sendPath, '', '')
