...
class UserCheckoutAdd extends StatefulWidget {
  static const String PATH = '/user/checkout/add/:id/:title';
  UserCheckoutAdd({Key? key}) : super(key: key);
  @override
  UserCheckoutAddState createState() => UserCheckoutAddState();
}

class UserCheckoutAddState extends State<UserCheckoutAdd>{
  String getPath = Env.value!.baseUrl! + '/user/checkout/add';
    ...
    checkout = new  CheckoutController(AppProvider.getApplication(context),
      ...
      return Scaffold(
          ...
          body:isLoading?
            ...
            floatingActionButton: isLoading? [] : this.model.Buttons(context, _dialVisible, formKey, controller,checkout, postCheckoutResult, this, sendPath, '', '')
