...
class UserMyPointsAdd extends StatefulWidget {
  static const String PATH = '/user/my_points/add/:id/:title';
  UserMyPointsAdd({Key? key}) : super(key: key);
  @override
  UserMyPointsAddState createState() => UserMyPointsAddState();
}

class UserMyPointsAddState extends State<UserMyPointsAdd>{
  String getPath = Env.value!.baseUrl! + '/user/my_points/add';
    ...
    my_points = new  MyPointsController(AppProvider.getApplication(context),
      ...
      return Scaffold(
          ...
          body:isLoading?
            ...
            floatingActionButton: isLoading? [] : this.model.Buttons(context, _dialVisible, formKey, controller,my_points, postMyPointsResult, this, sendPath, '', '')
