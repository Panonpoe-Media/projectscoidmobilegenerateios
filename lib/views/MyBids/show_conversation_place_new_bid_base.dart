...
class ShowConversationPlaceNewBidBase extends StatefulWidget {
  final String? id ;
  final String? title;
  String? url;
  ShowConversationPlaceNewBidBase({Key? key, this.id, this.title, this.url}) : super(key: key);
  @override
  ShowConversationPlaceNewBidBaseState createState() => ShowConversationPlaceNewBidBaseState();
}

class ShowConversationPlaceNewBidBaseState extends State<ShowConversationPlaceNewBidBase>  with RestorationMixin{
  String getPath = '';
  String sendPath = '';
...
final RestorableInt _counter = RestorableInt(0);
  ...
  @override
  String get restorationId => 'ShowConversationPlaceNewBid';
    ...
    if (this.model == null) {
       ...
       future.then((value) {
        setState(() {
		  ...
		  try{
		   this.model = PlaceNewBidShowConversationModel(value);
		  }catch(e){
		   errmsg = value;
		   isError = true;
		  }
