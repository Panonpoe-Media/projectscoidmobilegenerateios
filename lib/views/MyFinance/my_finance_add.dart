...
class UserMyFinanceAdd extends StatefulWidget {
  static const String PATH = '/user/my_finance/add/:id/:title';
  UserMyFinanceAdd({Key? key}) : super(key: key);
  @override
  UserMyFinanceAddState createState() => UserMyFinanceAddState();
}

class UserMyFinanceAddState extends State<UserMyFinanceAdd>{
  String getPath = Env.value!.baseUrl! + '/user/my_finance/add';
    ...
    my_finance = new  MyFinanceController(AppProvider.getApplication(context),
      ...
      return Scaffold(
          ...
          body:isLoading?
            ...
            floatingActionButton: isLoading? [] : this.model.Buttons(context, _dialVisible, formKey, controller,my_finance, postMyFinanceResult, this, sendPath, '', '')
