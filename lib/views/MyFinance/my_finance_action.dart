...
class ChangePaymentSettingsMyFinance extends StatefulWidget {
  ...
  final String? id ;
  final String? title;
  static const String PATH = '/user/my_finance/change_payment_settings/:id/:title';
  ChangePaymentSettingsMyFinance({Key? key, this.id, this.title}) : super(key: key);

  @override
  ChangePaymentSettingsMyFinanceState createState() => ChangePaymentSettingsMyFinanceState();
}

class ChangePaymentSettingsMyFinanceState extends State<ChangePaymentSettingsMyFinance> with RestorationMixin{
  String getPath = Env.value!.baseUrl! + '/user/my_finance/change_payment_settings/%s/%s';
 // String sendPath = Env.value!.baseUrl! + '/user/my_finance/add';
  String sendPath = Env.value!.baseUrl! + '/user/my_finance/change_payment_settings/%s/%s';
...
final RestorableInt _counter = RestorableInt(0);
 ...
 fetchData(MyFinanceController? change_payment_settings , BuildContext context)async {
    if (this.model == null) {
       final future = change_payment_settings!.getChangePaymentSettingsMyFinance('');
       future.then((value) {
        setState(() {
          isLoading = false;
        });
							...
							FlatButton(
								...
								if(this.model != null){
								    if([ 'PlaceNewBid'].contains('ChangePaymentSettings')){
										change_payment_settings!.deleteAllChangePaymentSettingsMyFinance(this.model.model.model.project_title);
										}else if(['AskOwner'].contains('ChangePaymentSettings')){
										change_payment_settings!.deleteAllChangePaymentSettingsMyFinance(this.model.model.model.project_id.toString());
										}else if(['HireMe'].contains('ChangePaymentSettings')){
										change_payment_settings!.deleteAllChangePaymentSettingsMyFinance(this.model.model.model.private_worker_id.toString());
										
										}else if(['InviteToBid'].contains('ChangePaymentSettings')){
										change_payment_settings!.deleteAllChangePaymentSettingsMyFinance(this.model.model.model.user_id);
										}else{
										change_payment_settings!.deleteAllChangePaymentSettingsMyFinance('');
										}
								}
							 ...
							 FlatButton(
								...
								if(this.model != null){
											  ...
											  if (formKey.currentState!.validate()) {
												...
												if([ 'PlaceNewBid'].contains('ChangePaymentSettings')){
													change_payment_settings!.saveChangePaymentSettingsMyFinance(this.model,this.model.model.model.project_title);
													}else if(['AskOwner'].contains('ChangePaymentSettings')){
													change_payment_settings!.saveChangePaymentSettingsMyFinance(this.model,this.model.model.model.project_id.toString());
													}else if(['HireMe'].contains('ChangePaymentSettings')){
													change_payment_settings!.saveChangePaymentSettingsMyFinance(this.model,this.model.model.model.private_worker_id.toString());
													
													}else if(['InviteToBid'].contains('ChangePaymentSettings')){
													change_payment_settings!.saveChangePaymentSettingsMyFinance(this.model,this.model.model.model.user_id);
													}else{
													change_payment_settings!.saveChangePaymentSettingsMyFinance(this.model,'');
													}
											  }else{
													if([ 'PlaceNewBid'].contains('ChangePaymentSettings')){
													change_payment_settings!.saveChangePaymentSettingsMyFinance(this.model,this.model.model.model.project_title);
  ...
  Widget build(BuildContext context) {
   ...
   final themeManager =  Provider.of<ThemeManager>(context);
    ...
    change_payment_settings = new MyFinanceController(AppProvider.getApplication(context),
        getPath,
        AppAction.edit,
        widget.id!,
        widget.title!,
                  ...
                  AppBar(
                            ...
                            Row(
                              ...
                              children: <Widget>[
                                ...
                                Text('Change Payment Settings', style: TextStyle(color: Colors.white),),
                              ]
                            ),
                      ...
                      physics: const AlwaysScrollableScrollPhysics(),
                        ...
                        children: isLoading? [] :[
                            ...
                            */  
                            ...
                            isLoading?  null : isError? null: this.model.RButtons(context, _dialVisible, formKey, controller,change_payment_settings, postChangePaymentSettingsResult, this, sendPath, widget.id!, widget.title!),
...
class WithdrawPaymentMyFinance extends StatefulWidget {
  ...
  @override
  WithdrawPaymentMyFinanceState createState() => WithdrawPaymentMyFinanceState();
}

class WithdrawPaymentMyFinanceState extends State<WithdrawPaymentMyFinance> with RestorationMixin{
  String getPath = Env.value!.baseUrl! + '/user/my_finance/withdraw_payment/%s/%s';
 // String sendPath = Env.value!.baseUrl! + '/user/my_finance/add';
  String sendPath = Env.value!.baseUrl! + '/user/my_finance/withdraw_payment/%s/%s';
 ...
 fetchData(MyFinanceController? withdraw_payment , BuildContext context)async {
							...
							FlatButton(
								...
								if(this.model != null){
								    if([ 'PlaceNewBid'].contains('WithdrawPayment')){
										withdraw_payment!.deleteAllWithdrawPaymentMyFinance(this.model.model.model.project_title);
										}else if(['AskOwner'].contains('WithdrawPayment')){
										withdraw_payment!.deleteAllWithdrawPaymentMyFinance(this.model.model.model.project_id.toString());
										}else if(['HireMe'].contains('WithdrawPayment')){
										withdraw_payment!.deleteAllWithdrawPaymentMyFinance(this.model.model.model.private_worker_id.toString());
										
										}else if(['InviteToBid'].contains('WithdrawPayment')){
										withdraw_payment!.deleteAllWithdrawPaymentMyFinance(this.model.model.model.user_id);
										}else{
							 ...
							 FlatButton(
								...
								if(this.model != null){
											  ...
											  if (formKey.currentState!.validate()) {
												...
												if([ 'PlaceNewBid'].contains('WithdrawPayment')){
													withdraw_payment!.saveWithdrawPaymentMyFinance(this.model,this.model.model.model.project_title);
													}else if(['AskOwner'].contains('WithdrawPayment')){
													withdraw_payment!.saveWithdrawPaymentMyFinance(this.model,this.model.model.model.project_id.toString());
													}else if(['HireMe'].contains('WithdrawPayment')){
													withdraw_payment!.saveWithdrawPaymentMyFinance(this.model,this.model.model.model.private_worker_id.toString());
													
													}else if(['InviteToBid'].contains('WithdrawPayment')){
													withdraw_payment!.saveWithdrawPaymentMyFinance(this.model,this.model.model.model.user_id);
													}else{
													withdraw_payment!.saveWithdrawPaymentMyFinance(this.model,'');
													}
											  }else{
													if([ 'PlaceNewBid'].contains('WithdrawPayment')){
													withdraw_payment!.saveWithdrawPaymentMyFinance(this.model,this.model.model.model.project_title);
  ...
  Widget build(BuildContext context) {
   ...
   final themeManager =  Provider.of<ThemeManager>(context);
      themeManager.themeMode == ThemeMode.dark? darkMode = true : darkMode = false;
    bool _dialVisible = true;
    withdraw_payment = new MyFinanceController(AppProvider.getApplication(context),
        getPath,
        AppAction.edit,
        widget.id!,
        widget.title!,
                  ...
                  AppBar(
                            ...
                            Row(
                              ...
                              children: <Widget>[
                                ...
                                Text('Withdraw Payment', style: TextStyle(color: Colors.white),),
                              ]
                            ),
                      ...
                      physics: const AlwaysScrollableScrollPhysics(),
                        ...
                        children: isLoading? [] :[
                            ...
                            */  
                            ...
                            isLoading?  null : isError? null: this.model.RButtons(context, _dialVisible, formKey, controller,withdraw_payment, postWithdrawPaymentResult, this, sendPath, widget.id!, widget.title!),
...
class DepositBalanceMyFinanceState extends State<DepositBalanceMyFinance> with RestorationMixin{
  String getPath = Env.value!.baseUrl! + '/user/my_finance/deposit_balance/%s/%s';
 // String sendPath = Env.value!.baseUrl! + '/user/my_finance/add';
  String sendPath = Env.value!.baseUrl! + '/user/my_finance/deposit_balance/%s/%s';
 ...
 fetchData(MyFinanceController? deposit_balance , BuildContext context)async {
							...
							FlatButton(
								...
								if(this.model != null){
								    if([ 'PlaceNewBid'].contains('DepositBalance')){
										deposit_balance!.deleteAllDepositBalanceMyFinance(this.model.model.model.project_title);
										}else if(['AskOwner'].contains('DepositBalance')){
										deposit_balance!.deleteAllDepositBalanceMyFinance(this.model.model.model.project_id.toString());
										}else if(['HireMe'].contains('DepositBalance')){
										deposit_balance!.deleteAllDepositBalanceMyFinance(this.model.model.model.private_worker_id.toString());
										
										}else if(['InviteToBid'].contains('DepositBalance')){
										deposit_balance!.deleteAllDepositBalanceMyFinance(this.model.model.model.user_id);
										}else{
							 ...
							 FlatButton(
								...
								if(this.model != null){
											  ...
											  if (formKey.currentState!.validate()) {
												...
												if([ 'PlaceNewBid'].contains('DepositBalance')){
													deposit_balance!.saveDepositBalanceMyFinance(this.model,this.model.model.model.project_title);
													}else if(['AskOwner'].contains('DepositBalance')){
													deposit_balance!.saveDepositBalanceMyFinance(this.model,this.model.model.model.project_id.toString());
													}else if(['HireMe'].contains('DepositBalance')){
													deposit_balance!.saveDepositBalanceMyFinance(this.model,this.model.model.model.private_worker_id.toString());
													
													}else if(['InviteToBid'].contains('DepositBalance')){
													deposit_balance!.saveDepositBalanceMyFinance(this.model,this.model.model.model.user_id);
													}else{
  ...
  Widget build(BuildContext context) {
   ...
   final themeManager =  Provider.of<ThemeManager>(context);
      themeManager.themeMode == ThemeMode.dark? darkMode = true : darkMode = false;
    bool _dialVisible = true;
    deposit_balance = new MyFinanceController(AppProvider.getApplication(context),
        getPath,
        AppAction.edit,
        widget.id!,
        widget.title!,
                      ...
                      physics: const AlwaysScrollableScrollPhysics(),
                        ...
                        children: isLoading? [] :[
                            ...
                            */  
                            ...
                            isLoading?  null : isError? null: this.model.RButtons(context, _dialVisible, formKey, controller,deposit_balance, postDepositBalanceResult, this, sendPath, widget.id!, widget.title!),
