...
class UserMySalesAdd extends StatefulWidget {
  static const String PATH = '/user/my_sales/add/:id/:title';
  UserMySalesAdd({Key? key}) : super(key: key);
  @override
  UserMySalesAddState createState() => UserMySalesAddState();
}

class UserMySalesAddState extends State<UserMySalesAdd>{
  String getPath = Env.value!.baseUrl! + '/user/my_sales/add';
    ...
    my_sales = new  MySalesController(AppProvider.getApplication(context),
      ...
      return Scaffold(
          ...
          body:isLoading?
            ...
            floatingActionButton: isLoading? [] : this.model.Buttons(context, _dialVisible, formKey, controller,my_sales, postMySalesResult, this, sendPath, '', '')
