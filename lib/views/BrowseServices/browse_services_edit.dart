...
//123
class PublicBrowseServicesEdit extends StatefulWidget {
  static const String PATH = '/public/browse_services/edit/:id/:title';
  final String? id ;
  final String? title;
  PublicBrowseServicesEdit({Key? key, this.id, this.title}) : super(key: key);
  @override
  PublicBrowseServicesEditState createState() => PublicBrowseServicesEditState();
}

class PublicBrowseServicesEditState extends State<PublicBrowseServicesEdit>  with RestorationMixin{
  String getPath = Env.value!.baseUrl! + '/public/browse_services/edit/%s/%s';
 // String sendPath = Env.value!.baseUrl! + '/public/browse_services/add';
  String sendPath = Env.value!.baseUrl! + '/public/browse_services/edit/%s/%s';
...
final RestorableInt _counter = RestorableInt(0);
  ...
  initState(){
    super.initState();
	sendPath = Env.value!.baseUrl! + '/public/browse_services/edit/' +widget.id! +'/' + widget.title!;
     ...
     fetchData(browse_services);
      ...
      return Scaffold(
          ...
          body:isLoading?
            ...
            floatingActionButton:  isLoading? null : this.model.Buttons(context, _dialVisible, formKey, controller,browse_services, postBrowseServicesResult, this, sendPath, widget.id, widget.title)
