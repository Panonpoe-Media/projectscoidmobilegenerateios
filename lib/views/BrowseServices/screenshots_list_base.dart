...
String filterShortcodes(String input,
  ...
  Widget build(BuildContext context) {
   ...
   final themeManager =  Provider.of<ThemeManager>(context);
     ...
     String service_images_id = 'service_images_id';
	 service_images_id = service_images_id.replaceAll('_id','');
     getPath = widget.url! + service_images_id + 'page=%s';
...
class ScreenshotsListing extends Bloc<ScreenshotsEvent, ScreenshotsState> {
 ...
 Stream<Transition<ScreenshotsEvent, ScreenshotsState>> transformEvents(
  ...
  Future<ScreenshotsListingModel?> listingScreenshots(int page) async {
	...
	return await apiRepProvider!.getScreenshotsListAPI1(url, page);
	/*
  ...
  Future<ScreenshotsListingModel?> listingRefreshScreenshots() async {
   ...
   ScreenshotsListingModel? screenshots = null;
    APIRepository? apiRepProvider = application.projectsAPIRepository;
    await application.projectsDBRepository!.deleteAllScreenshotsList2();
    screenshots  = await apiRepProvider!.getScreenshotsListAPI1(url, 1);
    return screenshots;
	/*
    APIRepository? apiRepProvider = application.projectsAPIRepository;
	int page = 0;
  ...
  Future<ScreenshotsListingModel?> listingSearchScreenshots(int page) async {
    APIRepository? apiRepProvider = application.projectsAPIRepository;
	return await apiRepProvider!.getScreenshotsListSearchAPI1(url, page);
  ...
  Future<ScreenshotsListingModel?> listingSearchRefreshScreenshots() async {
   ScreenshotsListingModel? screenshots = null;
     APIRepository? apiRepProvider = application.projectsAPIRepository;
    await application.projectsDBRepository!.deleteAllScreenshotsList2();
    screenshots  = await apiRepProvider!.getScreenshotsListSearchAPI1(url, 1);
    return screenshots;
  /*
    APIRepository? apiRepProvider = application.projectsAPIRepository;
	int page = 0;
