...
import 'dart:async';
 ...
 /** AUTOGENERATE OFF **/
class  PublicBrowseServicesListing extends StatefulWidget {
  static const String PATH = '/public/browse_services/listing/:id';
    final String? id ;
    ChatBloc? cb;
   PublicBrowseServicesListing({Key? key, this.id, this.cb}) : super(key: key);
  @override
   PublicBrowseServicesListingState createState() =>  PublicBrowseServicesListingState();
}

class  PublicBrowseServicesListingState extends State< PublicBrowseServicesListing> with RestorationMixin{
  ...
  String searchText = '';
   ...
   PublicBrowseServicesListingState() {
...
final RestorableDouble cs = RestorableDouble(0);
  ...
  @override
  String get restorationId => 'BrowseServices';

  @override
  void restoreState(RestorationBucket? oldBucket, bool initialRestore) {
    registerForRestoration(cs, 'BrowseServices');
  }
  ...
  Widget build(BuildContext context) {
      ...
      getPath = Env.value!.baseUrl! + '/public/browse_services/listing?page=%d' + ids;
    }
              ...
              actions: <Widget>[
                IconButton(
                    ...
                    onPressed: () async {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => SearchBrowseServicesListing(id : '', title : '', cb: widget.cb!)),
                      );
					/*
                      if (!selected) {
                        setState(() {
		  ...
		  if (state.browse_services!.tools.buttons.length == 0){ 
            return
              ...
              Scaffold(
                 ...
                 floatingActionButton: state.browse_services!.Buttons(context, _dialVisible, account, open)
					...
					body:
							...
							child:    ListView.builder(
								itemBuilder: (BuildContext context, int index) {
									  ...
									  PublicBrowseServicesBottomLoader()
...
class  SearchBrowseServicesListing extends StatefulWidget {
  static const String PATH = '/public/browse_services/listing/:id';
    final String? id ;
	final String? title;
	ChatBloc? cb;
   SearchBrowseServicesListing({Key? key, this.id, this.title, this.cb}) : super(key: key);
  @override
   SearchBrowseServicesListingState createState() =>  SearchBrowseServicesListingState();
}

class  SearchBrowseServicesListingState extends State< SearchBrowseServicesListing>  with RestorationMixin{
  String title = 'Browse Services'; 
  bool _dialVisible = true;
  bool search = false;
  String getPath = Env.value!.baseUrl! + '/public/browse_services/listing?page=%d';
  ...
  String searchText = '';
   double initscroll = 0.0;
   SearchBrowseServicesListingState() {
   // scrollController!.addListener(_onScroll);
  }
...
////////////////////////////////
class  PublicBrowseServicesBottomLoader extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Container(
