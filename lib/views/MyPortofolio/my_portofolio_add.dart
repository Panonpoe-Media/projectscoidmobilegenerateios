...
class UserMyPortofolioAdd extends StatefulWidget {
  static const String PATH = '/user/my_portofolio/add/:id/:title';
  UserMyPortofolioAdd({Key? key}) : super(key: key);
  @override
  UserMyPortofolioAddState createState() => UserMyPortofolioAddState();
}

class UserMyPortofolioAddState extends State<UserMyPortofolioAdd>{
  String getPath = Env.value!.baseUrl! + '/user/my_portofolio/add';
    ...
    my_portofolio = new  MyPortofolioController(AppProvider.getApplication(context),
      ...
      return Scaffold(
          ...
          body:isLoading?
            ...
            floatingActionButton: isLoading? [] : this.model.Buttons(context, _dialVisible, formKey, controller,my_portofolio, postMyPortofolioResult, this, sendPath, '', '')
